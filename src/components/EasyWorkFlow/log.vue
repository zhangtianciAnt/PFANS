<template>
  <div>
    <el-dialog :visible.sync="viewWorkflow" append-to-body center direction="rtl"
               min-height="100%" size="60%" width="50%" @close="refresh">
      <div v-loading="loading" element-loading-spinner="el-icon-loading">
        ...
        <el-timeline style="padding-top: 30px;max-height: 500px;overflow-y: auto">
          <el-timeline-item
            ...
            :key="index" :timestamp="(item.edata)"
            :type="index.toString() === '0'?'primary':'info'">
