  ...
  <div style="width: 25%;position: absolute;top: 0;bottom: 0;left: 0;right: 0;margin: auto;height: 60%;">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" autoComplete="off"
      ...
      <el-form-item prop="account">
        <el-input v-model="registerForm.account" autoComplete="off" name="account" placeholder="手机号"
                  prefix-icon="el-icon-edit" type="text">
        </el-input>
      </el-form-item>
      <el-form-item prop="password">
        <el-input v-model="registerForm.password" :type="passwordType" autoComplete="off" name="password"
                  placeholder="密码"
      ...
      <el-button :loading="loading" style="width:100%;margin-bottom:20px;font-size:18px" type="primary"
                 @click.native.prevent="handleLogin">立即体验
      </el-button>
    </el-form>


    <el-dialog :append-to-body=true :show-close="false" :visible.sync="showSuccess">
