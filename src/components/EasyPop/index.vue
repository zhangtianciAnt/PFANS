<template>
  <el-drawer :show-close="false" :visible.sync="open" :withHeader="false" append-to-body
             ...
             @close="close">
    <PFANS6002FormView v-if="url === 'PFANS6002FormView'" ref="child"></PFANS6002FormView>
    <PFANS1032FormView v-else-if="url === 'PFANS1032FormView'" ref="child"></PFANS1032FormView>
    <PFANS1031FormView v-else-if="url === 'PFANS1031FormView'" ref="child"></PFANS1031FormView>
    <PFANS1025FormView v-else-if="url === 'PFANS1025FormView'" ref="child"></PFANS1025FormView>
    <PFANS1006FormView v-else-if="url === 'PFANS1006FormView'" ref="child"></PFANS1006FormView>
    <PFANS1047FormView v-else-if="url === 'PFANS1047FormView'" ref="child"></PFANS1047FormView>
    <PFANS1035FormView v-else-if="url === 'PFANS1035FormView'" ref="child"></PFANS1035FormView>
    <PFANS1002FormView v-else-if="url === 'PFANS1002FormView'" ref="child"></PFANS1002FormView>
    <PFANS1004FormView v-else-if="url === 'PFANS1004FormView'" ref="child"></PFANS1004FormView>
    <PFANS1012FormView v-else-if="url === 'PFANS1012FormView'" ref="child"></PFANS1012FormView>
    <PFANS1045FormView v-else-if="url === 'PFANS1045FormView'" ref="child"></PFANS1045FormView>
    <PFANS3005FormView v-else-if="url === 'PFANS3005FormView'" ref="child"></PFANS3005FormView>
    <PFANS1003FormView v-else-if="url === 'PFANS1003FormView'" ref="child"></PFANS1003FormView>
    <PFANS1005FormView v-else-if="url === 'PFANS1005FormView'" ref="child"></PFANS1005FormView>
    <PFANS1010FormView v-else-if="url === 'PFANS1010FormView'" ref="child"></PFANS1010FormView>
    <PFANS2026FormView v-else-if="url === 'PFANS2026FormView'" ref="child"></PFANS2026FormView>
    <PFANS2032FormView v-else-if="url === 'PFANS2032FormView'" ref="child"></PFANS2032FormView>
    <PFANS4001FormView v-else-if="url === 'PFANS4001FormView'" ref="child"></PFANS4001FormView>
  </el-drawer>
</template>
...
import PFANS4001FormView from '@/view/PFANS/PFANS4000/PFANS4001/PFANS4001FormView.vue';
