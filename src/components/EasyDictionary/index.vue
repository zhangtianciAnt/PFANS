    ...
    <el-container class="container">
        ...
        <el-row style="padding:10px">
          <el-col :offset="1" :span="20">
            <div class="dictType" @click="setData('ermDisountType','优惠类型')">
              <i class="el-icon-document"></i>优惠类型
            </div>
          </el-col>
        </el-row>
        <el-row style="padding:10px">
          <el-col :offset="1" :span="20">
            <div class="dictType" @click="setData('ermRFType','费用类型')">
              <i class="el-icon-document"></i>费用类型
            </div>
          </el-col>
        </el-row>
        <el-row style="padding:10px">
          <el-col :offset="1" :span="20">
            <div class="dictType" @click="setData('ermRPType','合同收/付款方式')">
              <i class="el-icon-document"></i>合同收/付款方式
            </div>
          </el-col>
        </el-row>
        <el-row style="padding:10px">
          <el-col :offset="1" :span="20">
            <div class="dictType" @click="setData('ermStatus','会展租赁合同状态')">
              <i class="el-icon-document"></i>会展租赁合同状态
            </div>
          </el-col>
        </el-row>
        <el-row style="padding:10px">
          <el-col :offset="1" :span="20">
            <div class="dictType" @click="setData('ermICType','收入类别')">
              <i class="el-icon-document"></i>收入类别
            </div>
          </el-col>
        </el-row>
        <el-row style="padding:10px">
          <el-col :offset="1" :span="20">
            <div class="dictType" @click="setData('ermEPType','会展项目类别')">
              <i class="el-icon-document"></i>会展项目类别
            </div>
          </el-col>
        </el-row>
      </el-aside>
      ...
      <el-main>
        <div style="padding-top:20px">
          ...
          <el-button slot="extra" plain style="float: right" type="primary" @click="addItem">+新建</el-button>
        </div>
        <el-card style="width: 100%;margin-top:30px;border: 1px solid rgba(0, 0, 0, 0.2);  border-radius: 5px;">
          <el-table :data="tableData" style="width: 100%; text-align:center">
            <el-table-column align="center" label="项目名" prop="name" style="width:15%"></el-table-column>
            <el-table-column align="center" label="项目值" prop="code" style="width:15%"></el-table-column>
            <el-table-column align="center" label="排序" prop="ord" style="width:15%"></el-table-column>
            <el-table-column align="center" label="操作" style="width:15%">
              <template slot-scope="scope">
                <el-button class="el-icon-edit" style="margin-left:10px" type="text"
                           @click="editItem(scope.row)"></el-button>
                <el-button class="el-icon-delete" style="margin-left:10px" type="text"
                           @click="deleteItem(scope.row)"></el-button>
              </template>
            </el-table-column>
            <el-table-column align="center" label="说明" prop="content" style="width:15%"></el-table-column>
          </el-table>
        </el-card>
      </el-main>
