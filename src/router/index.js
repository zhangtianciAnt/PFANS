...
import PFANS2033FormView from '@/view/PFANS/PFANS2000/PFANS2033/PFANS2033FormView.vue'
...
import PFANS8012View from '@/view/PFANS/PFANS8000/PFANS8012/PFANS8012View.vue'
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/PFANS1038OutFormView',
        name: 'PFANS1038OutFormView',
        component: PFANS1038OutFormView,
      },
      {
        path: '/PFANS1039View',
        name: 'PFANS1039View',
      ...
      },
      {
        path: '/PFANS2033View',
        name: 'PFANS2033View',
        component: PFANS2033View,
      },
      {
        path: '/PFANS2033FormView',
        name: 'PFANS2033FormView',
        component: PFANS2033FormView,
      },
      {
        path: '/PFANS2034View',
        name: 'PFANS2034View',
        component: PFANS2034View,
      },
      {
        path: '/PFANS2035View',
        name: 'PFANS2035View',
