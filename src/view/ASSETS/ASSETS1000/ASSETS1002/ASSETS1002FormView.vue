<template>
  <div class="assets1002" style="min-height: 100%">
        ...
        <el-form ref="ruleForm" :model="form" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-row>
            <el-col :span="24">
              ...
              <!--</el-table-column>-->
              <!--</el-table>-->
              <EasyNormalTable ref="roletable" :buttonList="buttonList" :buttonShow="buttonShow" :columns="columns"
                               :data="tableD" :rowid="row_id"
                               :showSelection="showSelection" :title="title1" :titleShow="titleShow"
                               @rowClick="rowClick">
