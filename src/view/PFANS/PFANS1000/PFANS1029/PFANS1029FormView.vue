                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item :label="$t('label.PFANS1029VIEW_CLAIMAMOUNT')">
                          <el-input-number :disabled="true" :precision="2" controls-position="right"
                                           v-model="form.claimamount"></el-input-number>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  ...
                  <el-tab-pane :label="$t('label.PFANS1029FROM_INFO2')" name="fourth">
                      ...
                      <el-col :span="8">
                        <el-form-item
                          ...
                          <el-input :disabled="!disable" style="width:20vw"
                                    v-model="form.prplacepositionjapanese"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item
                          ...
                          <el-input :disabled="!disable" style="width:20vw"
                                    v-model="form.prplacepositionchinese"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item
                          ...
                          <el-input type="textarea" :disabled="!disable" style="width:20vw"
                                    v-model="form.technicalcontentjapanese"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item
                          ...
                          <el-input type="textarea" :disabled="!disable" style="width:20vw"
                                    v-model="form.technicalcontentchinese"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item label="">
                          <el-input type="textarea" :disabled="!disable" style="width:20vw"
                                    v-model="form.redelegatecontent"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item label="">
                          <el-input type="textarea" :disabled="!disable" style="width:20vw"
                                    v-model="form.subcontractcontent"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      <el-col :span="8">
                        <el-form-item
                          ...
                          <el-input type="textarea" :disabled="!disable" style="width:20vw"
                                    v-model="form.othertermsjapanese"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item
                          ...
                          <el-input type="textarea" :disabled="!disable" style="width:20vw"
                                    v-model="form.othertermschinese"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
            ...
            <el-tab-pane :label="$t('label.PFANS1029FROM_LABOR')" name="second" :disabled="tab2Disabled">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1029VIEW_CLAIMAMOUNT')">
                    <el-input-number :disabled="true" :precision="2" controls-position="right"
                                     v-model="form2.claimamount" style="width:20vw"></el-input-number>
                  </el-form-item>
                </el-col>
              </el-row>
