          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.center')">
                <el-input v-model="appcenterid" :disabled="true" style="width:20vw"></el-input>
                <el-input v-show='false' v-model="form.appcenter_id" :disabled="true" maxlength='36'
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.group')">
                ...
                <el-input v-show='false' v-model="form.appgroup_id" :disabled="true" maxlength='36'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.team')">
                <el-input v-model="appteamid" :disabled="true" style="width:20vw"></el-input>
                <el-input v-show='false' v-model="form.appteam_id" :disabled="true" maxlength='36'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
            ...
            <el-col :span="8">
              <el-form-item :error="error_applicant" :label="$t('label.applicant')" prop="user_id">
                <user :disabled="true" :error="error_applicant" :selectType="selectType"
                      ...
                      style="width: 20vw" @getUserids="getApplicantids"></user>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.pfanstype')">
                <el-input v-model="form.type" :disabled="true" maxlength='36' style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.application')">
                <el-date-picker v-model="form.payment" :disabled="true" style="width: 20vw"
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1012VIEW_PERSONALCODE')">
                <el-input v-model="form.financecode" :disabled="true" maxlength="20" style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <!--                add_fjl-->
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item :label="$t('label.PFANS1016FORMVIEW_REASON')">
                <el-input v-model="form.reason" :disabled="!disabled" :rows="2" style="width: 71vw"
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :error="error_user" :label="$t('label.PFANS3005VIEW_USER')" prop="user_name">
                ...
                <el-input v-model="form.user_name" :disabled="!disabled" maxlength='36'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1018VIEW_ROMANNAME')" prop="romanname">
                <el-input v-model="form.romanname" :disabled="!disabled" maxlength='20'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1018FORMVIEW_INSIDENUMBER')" prop="extension">
                <el-input v-model="form.extension" :disabled="!disabled" maxlength='20'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <!--<el-col :span="8">-->
...
import {getCurrentRole, getCurrentRole4, getOrgInfoByUserId, getUserInfo} from '@/utils/customize';
