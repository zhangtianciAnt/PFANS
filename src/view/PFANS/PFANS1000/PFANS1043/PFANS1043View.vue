<template>
  <div>
    <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data" :rowid="rowid"
                     :title="title" @buttonClick="buttonClick" @reget="showData" @rowClick="rowClick"
    >
      <el-date-picker
        slot="customize"
        v-model="year"
