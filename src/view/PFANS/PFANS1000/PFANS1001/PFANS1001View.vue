<template>
  <div style="min-height: 100%">
    <el-card class="box-card" style="height: calc(100vh - 60px - 2rem)">
      <div>
        <div class="m-content" @click="submitForm(11)">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
                          float: left; padding: 10px 0px; height: 50px; line-height: 18px;">{{ $t('menu.PFANS1011') }}
            </div>
          </el-col>
          <el-col :span="6" class="m-div">
            <img :src="png10" class="m-img">
          </el-col>
        </div>
      </div>
      <div>
      ...
      <div>
        <div class="m-content" @click="submitForm(10)">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
