<template>
  <div>
    <!--境外出差申请 境内出差申請-->
    <EasyNormalTable v-show="this.showTable===1" ref="roletable5" v-loading="loading" :buttonList="buttonListAnt" :columns="columns"
                     :data="data"
                     :rowid="row" :selectable="selectInit" :showSelection="isShow"
                     :title="title" @buttonClick="buttonClick" @reget="inint" @rowClick="rowClick">
    </EasyNormalTable>
    <!--    ADD-WS-决裁编号添加 无偿设备 其他业务决裁-->
    <EasyNormalTable v-show="this.showTable===2" ref="roletable3" v-loading="loading" :buttonList="buttonListAnt" :columns="columns2"
                     :data="data" :rowid="row" :selectable="selectInit1" :showSelection="isShow"
                     :title="title"
                     @buttonClick="buttonClick" @reget="inint" @rowClick="rowClick">
    </EasyNormalTable>
    <!--    ADD-WS-决裁编号添加-->
    <!--    ADD-WS-费用编号添加 千元以下费用申请-->
    <EasyNormalTable v-show="this.showTable===3" ref="roletable2" v-loading="loading" :buttonList="buttonListAnt" :columns="columns3"
                     :data="data" :rowid="row" :selectable="selectInit" :showSelection="isShow"
                     :title="title"
                     @buttonClick="buttonClick" @reget="inint" @rowClick="rowClick">
    </EasyNormalTable>
    <!--    ADD-WS-费用编号添加 暂借款申请单-->
    <!--    add_fjl_05/27  添加暂借款申请编号的列表-->
    <EasyNormalTable v-show="this.showTable===4" ref="roletable4" v-loading="loading" :buttonList="buttonListAnt" :columns="columns4"
                     :data="data" :rowid="row" :selectable="selectInit" :showSelection="isShow"
                     :title="title"
                     @buttonClick="buttonClick" @reget="inint" @rowClick="rowClick">
    </EasyNormalTable>
    ...
    <EasyNormalTable v-show="this.showTable===5" ref="roletable1" v-loading="loading" :buttonList="buttonListAnt" :columns="columns5"
                     :data="data" :rowid="row" :selectable="selectInit" :showSelection="isShow"
                     :title="title"
                     @buttonClick="buttonClick" @reget="inint" @rowClick="rowClick">
    </EasyNormalTable>
    <!--  add-ws-5/27-No.170 事前面谈票-->
    <EasyNormalTable v-show="this.showTable===6" v-loading="loading" :buttonList="buttonList" :columns="columns6" :data="data"
                     :rowid="row"
                     :title="title" @buttonClick="buttonClick" @reget="inint" @rowClick="rowClick">
    </EasyNormalTable>
        ...
        <el-row>
          <el-col :span="6" style="margin-left: 0.5vw">
            <el-form-item :label="$t('label.center')">
              <el-input v-model="form.last_center_id" :disabled="true" style="width:11vw"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item :label="$t('label.group')">
              <el-input v-model="form.last_group_id" :disabled="true" style="width:11vw"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item :label="$t('label.team')">
              <el-input v-model="form.last_team_id" :disabled="true" style="width:11vw"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item :label="$t('label.budgetunit')">
              <el-input v-model="form.last_budgetunit" :disabled="true" style="width:11vw"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="5" style="margin-bottom: -1vw;">
            <el-form-item :label="$t('label.budgetunit')" prop="new_budgetunit">
              <el-select v-model="form.new_budgetunit" :placeholder="$t('normal.error_09')" clearable
                         style="width: 11vw">
                <el-option
