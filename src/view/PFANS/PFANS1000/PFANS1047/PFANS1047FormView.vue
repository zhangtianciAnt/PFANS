<template>
  <div>
    <EasyNormalContainer ref="container"
      ...
      <div slot="customize">
        <!--  scc add 样式变更  from  -->
        <el-form ref="reff" :model="form" :rules="rules" label-position="top" label-width="8vm"
                 style="padding: 2vw;height: auto">
          <el-tabs v-model="activeName" type="border-card">
              ...
              <el-row>
                <el-col :span="24">
                  <el-table :data="tableS" border header-cell-class-name="sub_bg_color_blue" stripe style="width: 70vw">
                    ...
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_CLAIMAMOUNT')" align="center" prop="claimamount"/>
                    <el-table-column
                      v-if="showCG" :label="$t('label.PFANS3005VIEW_NUMBERS')" align="center" prop="purnumbers"/>
            ...
            <el-tab-pane :label="$t('label.PFANS1025VIEW_SECONDDETAILS')" name="second">
              ...
              <el-table :data="tableT" :summary-method="getTsummaries"
                ...
                <el-table-column :error="errorgroup" :label="$t('label.PFANS1025VIEW_DEPART')"
                                 align="center" prop="depart">
                  <template slot-scope="scope">
                ...
                <el-table-column v-if="false" :label="$t('label.PFANS5008VIEW_PROGRAM')" align="center" width="600">
                  ...
                  <el-table-column v-if="checkdisable" :label="$t('label.PFANS1025VIEW_MEMBER')" align="center"
                                   prop="member">
                    <template slot-scope="scope">
                      <el-input-number
                  ...
                  <el-table-column v-if="checkdisable" :label="$t('label.PFANS1025VIEW_COMMUNITY')"
                                   align="center">
                    <template slot-scope="scope">
                      <el-input-number
...
import {downLoadUrl, getOrgInfo, getUserInfo, uploadUrl} from '@/utils/customize';
