          ...
          <el-row>
            <el-col :span="15" style="margin-left: 2vw">
              <el-form-item :label="$t('label.center')">
                <el-input v-model="department" :disabled="true" style="width:17vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
import {getDictionaryInfo, getMonthlyrateInfo, getStatus} from '@/utils/customize';
...
export default {
  ...
  methods: {
    ...
    getPjanme() {
      ...
      //add-lyt-21/3/10-NT_PFANS_20210226_BUG_028-start
      this.$store
        .dispatch('PFANS1025Store/getVerdict', {'maketype': '9'})
        .then(response => {
          const datatade = [];
          for (let i = 0; i < response.length; i++) {
