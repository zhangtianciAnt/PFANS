<template>
  <div>
    ...
    >
      <div slot="customize">
        <el-form ref="refform" :model="refform" label-position="top" label-width="8vw"
                 style="padding: 2vw">
          ...
          <el-row>
            ...
            <el-table :data="datatotal" :span-method="this.listSpanMethod" :tree-props="{children: 'children', hasChildren: 'hasChildren'}"
                      border default-expand-all header-cell-class-name="sub_bg_color_blue"
                      height="85vh" highlight-current-row
                      row-key="wai_id" width="100%" @current-change="handleCurrentChange"
            >
