    ...
    <EasyNormalContainer ref="container"
      ...
      <div slot="customize">
          ...
          <el-dialog :title="$t('button.application')" :visible.sync="dialogVisibleC">
            ...
            <el-form-item :label="$t('label.PFANS1024VIEW_CUSTOMERNAME')+'('+$t('label.PFANS1024VIEW_JAPANESE')+')'"
              ...
              <div class="" style="width: 20vw">
                <el-input v-model="form1.custojapanese" :disabled="true" class="content bg">
            ...
            <el-dialog :visible.sync="dialogVisibleE"
                       append-to-body
                       top="8vh">
              <el-table ref="roletableA" v-loading='loading' :data="dataA" :row-key="rowid" max-height="400"
                        @row-click="rowClickE">
                <el-table-column :label="$t('label.PFANS6001VIEW_SUPPLIERNAME')" property="supchinese"
                                 width="120"></el-table-column>
                <el-table-column :label="$t('label.PFANS6003FORMVIEW_VENDORNUM')" property="suppliercode"
                                 width="120"></el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS2003FORMVIEW_CONTACTINFORMATION')" property="protelephone"
                                 width="120"></el-table-column>
                <el-table-column :label="$t('label.PFANS6002VIEW_COMMONTPERSON')" property="commontperson"
                                 width="120"></el-table-column>
                <el-table-column :label="$t('label.PFANS2003FORMVIEW_CONTACTINFORMATION')" property="comtelephone"
                                 width="120"></el-table-column>
              </el-table>
            </el-dialog>
        ...
        <el-form ref="refform" :model="form" :rules="rules" label-position="top" label-width="6vw" style="padding: 2vw">
          ...
          <el-table :data="tablefourth" :header-cell-style="getRowClass4" header-cell-class-name="sub_bg_color_grey height"
                    stripe>
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_TEMA')" align="center" prop="theme" width="200">
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.theme'" :rules='rules.theme' prop="theme">
                  <div class="">
                ...
                <template slot-scope="scope">
                  ...
                  <div class="">
                    <el-input v-model="scope.row.custojapanese"
                              :disabled="!disabled"
                              class="content bg">
                      <el-button slot="append" :disabled="true" icon="el-icon-search" size="small"
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_CONTRACT2')" align="center" width="120">
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_CHINESE')" align="center" prop="conchinese" width="200">
                <template slot-scope="scope">
                  ...
                  <!--                      </project>-->
                  <el-input v-model="scope.row.conchinese" :disabled="!disabled" maxlength="255"></el-input>
                </template>
              </el-table-column>
            </el-table-column>
            <el-table-column :error="errorcontractnumber" :label="$t('label.PFANS1024VIEW_ENTRUSTEDNUMBER')" align="center"
                             prop="entrustednumber" width="200">
              <template slot-scope="scope">
                ...
                <el-dialog :visible.sync="dialogVisibleD"
                           append-to-body
                           top="8vh">
                  <el-table ref="roletableD" v-loading='loading' :data="tableD" :row-key="rowid" max-height="400"
                            @row-click="rowClickD">
                    ...
                    <el-table-column :label="$t('label.PFANS1024VIEW_APPLICATIONDATE')" property="applicationdate"
                                     width="120"></el-table-column>
                    <el-table-column :label="$t('label.approval_status')" property="state"
                                     width="120"></el-table-column>
                  </el-table>
                </el-dialog>
              </template>
          ...
          <el-table :data="tableclaimtype" :header-cell-style="getRowClass4" header-cell-class-name="sub_bg_color_grey height"
            ...
            <el-table-column v-if="showCG" :label="$t('label.PFANS3005VIEW_NUMBERS')" align="center" prop="purnumbers"
                             width="190">
              <template slot-scope="scope">
                <el-input v-model="scope.row.purnumbers" :disabled="true" controls-position="right"
                          style="width: 11rem">
                </el-input>
              </template>
            </el-table-column>
