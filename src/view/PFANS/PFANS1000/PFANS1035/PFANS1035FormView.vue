            ...
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_INFORMATION')" name="first">
              <div>
                ...
                <el-row>
                  ...
                  <el-col v-if="form.city === 'PJ036005'" :span="8">
                    <el-form-item :label="$t('label.PFANS1013VIEW_REGIONNAME')" prop="regionname">
                      <el-input v-model="form.regionname" :disabled="!disable" maxlength="50"
                                style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
            ...
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_OTHERS2')" name="fifth">
              <div>
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item v-if="show4" :label="$t('label.PFANS1002VIEW_FIXEDASSETSNO2')"
                                  prop="fixedassetsno">
                ...
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-form-item v-if="show5" :label="$t('label.PFANS1002VIEW_REGULATIONS')" prop="regulations">
                      <el-input-number
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item v-if="show5" :label="$t('label.PFANS1002VIEW_REASON2')" prop="reason">
