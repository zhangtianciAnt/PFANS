      ...
      <div slot="customize">
        <el-form ref="refform1" :model="form1" :rules="rules1" label-position="top" label-width="8vw">
          <el-dialog :title="$t('button.application')" :visible.sync="dialogFormVisible">
            <el-form-item v-if="display" :error="errorclaimtype" :label="$t('label.PFANS1024VIEW_NUMBER')"
            ...
            <div align="center" class="dialog-footer">
              <el-button v-if="show1" @click="click">
                  <span style="margin-right: 86%;">{{ $t('label.PFANS1026FORMVIEW_CONTRACTNUMBER') }}
                  </span>
              </el-button>
              <el-button v-if="show2" slot="reference" @click="clickDiscard">
        ...
        <el-form ref="refform" :model="form" label-position="top" label-width="8vw"
          ...
          <el-table :data="form.tabledata" :header-cell-style="getRowClass1" header-cell-class-name="sub_bg_color_grey height"
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_APPLICATIONDATE')" align="center" prop="applicationdate"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.applicationdate'">
                  <el-date-picker v-model="scope.row.applicationdate" :disabled="!disabled3" style="width: 7rem"
            ...
            <el-table-column :error="erroruser" :label="$t('label.applicant')" align="center" prop="user_id"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.user_id'">
                  <user :disabled="!disabled" :error="erroruser" :no="scope.row" :selectType="selectType"
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_ENTRYPAYMENT')" align="center" prop="entrypayment"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.entrypayment'">
                  <el-date-picker v-model="scope.row.entrypayment"
                                  :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled" style="width: 11rem"
                                  type="date"></el-date-picker>
                </el-form-item>
              </template>
            </el-table-column>
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_EXTENSIONREASON')" align="center" prop="extensionreason"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.extensionreason'">
                  <el-input v-model="scope.row.extensionreason"
                            :disabled="!disabled" :rows="2" style="width: 11rem"
            ...
            <el-table-column :label="$t('label.PFANS1026VIEW_CONTRACTPERIOD')" align="center" prop="claimdatetime"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.claimdatetime'" :rules='rules.claimdatetime'>
                  <el-date-picker v-model="scope.row.claimdatetime"
                                  :disabled="!disabled"
              ...
              <el-table-column :error="errorcusto" :label="$t('label.PFANS1024VIEW_JAPANESE')" align="center"
                ...
                <template slot-scope="scope">
                  ...
                  <el-form-item :prop="'tabledata.' + scope.$index + '.custojapanese'" :rules='rules.custojapanese'>
                    <div class="">
                      <el-input v-model="scope.row.custojapanese"
                                :disabled="!disabled"
                                class="content bg">
                        <el-button slot="append" :disabled="!disabled" icon="el-icon-search" size="small"
                  ...
                  <el-dialog :visible.sync="dialogVisibleA"
                    ...
                    <el-table
                      ref="roletableA"
                      v-loading='loading' :data="dataA.filter(data => !search || data.custchinese.toLowerCase().includes(search.toLowerCase())
                      || data.thecompany.toLowerCase().includes(search.toLowerCase())
                      )" :row-key="rowid" max-height="400"
                      @row-click="rowClick">
            ...
            <el-table-column :error="errorcode" :label="$t('label.PFANS1024VIEW_BUSINESSCODE')" align="center"
                             prop="businesscode" width="200">
              <template slot-scope="scope">
                <el-form-item :prop="'tabledata.' + scope.$index + '.businesscode'" :rules="rules.businesscode">
                  <el-input v-model="scope.row.businesscode" :disabled="true" style="width: 11rem">
                  </el-input>
                </el-form-item>
              </template>
            </el-table-column>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_JAPANESE')" align="center" prop="placejapanese"
                ...
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.placejapanese'" :rules='rules.placejapanese'>
                    <el-input v-model="scope.row.placejapanese"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="255">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_ENGLISH')" align="center" prop="placeenglish"
                ...
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.placeenglish'" :rules='rules.placeenglish'>
                    <el-input v-model="scope.row.placeenglish"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="255">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_CHINESE')" align="center" prop="placechinese"
                ...
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.placechinese'" :rules='rules.placechinese'>
                    <el-input v-model="scope.row.placechinese"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="255">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_BEFOREJAPANESE')" align="center" prop="responjapanese"
                ...
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.responjapanese'">
                    <el-input v-model="scope.row.responjapanese"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="255">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_BEFOREENGLISH')" align="center" prop="responerglish"
                ...
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.responerglish'" :rules='rules.responerglish'>
                    <el-input v-model="scope.row.responerglish"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="255">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_PHONE')" align="center" prop="responphone" width="200">
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.responphone'" :rules='rules.responphone'>
                    <el-input v-model="scope.row.responphone"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="100">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column :label="$t('label.PFANS1024VIEW_EMAIL')" align="center" prop="responemail" width="200">
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.responemail'">
                    <el-input v-model="scope.row.responemail"
                              :disabled="bookStatuss ? (!bookStatussawardafter ? true:false) : !disabled"
                              maxlength="100">
                    </el-input>
                  </el-form-item>
              ...
              <el-table-column v-if="false">
                <template slot-scope="scope">
                  <el-form-item :prop="'tabledata.' + scope.$index + '.regindiff'">
                    <el-input v-model="scope.row.regindiff" :disabled="!disabled" maxlength="100">
                    </el-input>
                  </el-form-item>
                </template>
              </el-table-column>
          ...
          <el-table :data="form.tableclaimtype" :default-sort="{prop: 'claimtype', order: 'ascending'}" :header-cell-style="getRowClass1"
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_CLAIMTYPE')" align="center" prop="claimtype" width="110">
              <template slot-scope="scope">
                <el-form-item>
                  <el-input v-model="scope.row.claimtype" :disabled="!disabled3" :no="scope.row">
                  </el-input>
                </el-form-item>
              </template>
              <!--222-->
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_CLAIMDATETIME')" align="center" prop="claimdatetimeqh"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.claimdatetimeqh'"
                  ...
                  <el-date-picker v-model="scope.row.claimdatetimeqh"
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_DELIVERYDATE')" align="center" prop="deliverydate"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.deliverydate'" :rules='rules.deliverydate'>
                  <el-date-picker v-model="scope.row.deliverydate" :disabled="scope.row.npbook ? true : !disabled"
                                  style="width: 11rem"
                                  type="date"></el-date-picker>
                </el-form-item>
              </template>
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_COMPLETIONDATE')" align="center" prop="completiondate"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.completiondate'"
                  ...
                  <el-date-picker v-model="scope.row.completiondate" :disabled="scope.row.npbook ? true : !disabled"
                                  style="width: 11rem"
                                  type="date"></el-date-picker>
                </el-form-item>
              </template>
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_DELIVERYFINSHDATE')" align="center"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.deliveryfinshdate'"
                  ...
                  <el-date-picker v-model="scope.row.deliveryfinshdate" :disabled="scope.row.npbook ? true : !disabled"
                                  style="width: 11rem"
                                  type="date"></el-date-picker>
                </el-form-item>
              </template>
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.loadingjudge'" :rules='rules.loadingjudge'>
                  <user :disabled="scope.row.npbook ? true : !disabled" :no="scope.row" :selectType="selectType"
                        ...
                        style="width: 10.15rem" @getUserids="getJudge"></user>
                </el-form-item>
              </template>
            </el-table-column>
            <el-table-column :label="$t('label.PFANS1024VIEW_CLAIMDATE')" align="center" prop="claimdate" width="170">
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.claimdate'" :rules='rules.claimdate'>
                  <el-date-picker v-model="scope.row.claimdate" :disabled="scope.row.npbook ? true : !disabled"
                                  style="width: 9.5rem"
                                  type="date"></el-date-picker>
                </el-form-item>
              </template>
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_SUPPORTDATE')" align="center" prop="supportdate"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.supportdate'" :rules='rules.supportdate'>
                  <el-date-picker v-model="scope.row.supportdate" :disabled="scope.row.npbook ? true : !disabled"
                                  style="width: 9.5rem"
                                  type="date"></el-date-picker>
                </el-form-item>
              </template>
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_CLAIMAMOUNT')" align="center" prop="claimamount"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.claimamount'" :rules='rules.claimamount'>
                  <el-input-number v-model="scope.row.claimamount" :disabled="scope.row.npbook ? true : !disabled" :max="1000000000"
            ...
            <el-table-column :label="$t('label.PFANS1024VIEW_PAPERCONTRACT')" align="center" prop="qingremarksqh"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.qingremarksqh'">
                  <el-input v-model="scope.row.qingremarksqh"
                            :disabled="scope.row.napinbook ? true : !bookStatussawardafter">
                  </el-input>
                </el-form-item>
              </template>
            ...
            <el-table-column :label="$t('label.PFANS1026FORMVIEW_RECOVERYSTATUS')" align="center" prop="recoverystatus"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.recoverystatus'">
                  <el-select
                    v-model="scope.row.recoverystatus"
                    :disabled="(scope.row.claimconditionqh === 'HT011003' && scope.row.deliveryconditionqh === 'HT009003' && scope.row.letrecoverystatus === '0') ? false : true" :placeholder="$t('normal.error_09')"
                    clearable @change="onRecoverystatus(scope.row)">
                    <el-option
            ...
            <el-table-column :label="$t('label.PFANS1026FORMVIEW_RECOVERYDATE')" align="center" prop="recoverydate"
              ...
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.recoverydate'">
                  <el-date-picker
                    v-model="scope.row.recoverydate"
                    :disabled="(scope.row.claimconditionqh === 'HT011003' && scope.row.deliveryconditionqh === 'HT009003' && scope.row.letrecoverystatus === '0') ? false : true" style="width: 9.5rem" type="date"></el-date-picker>
                </el-form-item>
              </template>
            </el-table-column>
            <!--            ADD_FJL-->
            <el-table-column :label="$t('label.PFANS1024VIEW_REMARKS')" align="center" prop="remarksqh" width="200">
              <template slot-scope="scope">
                <el-form-item :prop="'tableclaimtype.' + scope.$index + '.remarksqh'">
                  <el-input v-model="scope.row.remarksqh"
                            :disabled="scope.row.napinbook ? true : !bookStatussawardafter">
                  </el-input>
                </el-form-item>
              </template>
          ...
          <el-table v-if="displaycompound" :data="form.tablecompound" border header-cell-class-name="sub_bg_color_blue"
            ...
            <el-table-column
              ...
              width="200">
              <template slot-scope="scope">
                <el-select v-model="scope.row.claimtype" :disabled="bookStatuss ? true : !disabled"
                           :placeholder="$t('normal.error_09')" clearable
                           @change="changeclaimtype(scope.row)">
                  <el-option
            ...
            <el-table-column
              ...
              width="240">
              <template slot-scope="scope">
                <org :disabled="bookStatuss ? true : !disabled" :no="scope.row" :orglist="scope.row.group_id"
                     orgtype="4" style="width:90%" @getOrgids="getEntrustgroupId"></org>
              </template>
            </el-table-column>
            <el-table-column
...
import {accAdd, getDictionaryInfo, getOrgInfoByUserId, getOrgInformation, getUserInfo} from '@/utils/customize';
      ...
      for (let i = 0; i < this.form.tabledata.length; i++) {
        if (this.form.tabledata[i].state === this.$t('label.PFANS8008FORMVIEW_EFFECTIVE')) {
          ...
          for (let i = 0; i < tabletype.length; i++) {
            ...
            sumclaimamount = accAdd(sumclaimamount, Number(tabletype[i].claimamount));
