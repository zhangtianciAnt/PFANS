<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :title="title"
                         :workflowCode="workflowCode" @buttonClick="buttonClick"
        ...
        <el-form ref="ruleForm" :model="form" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS2002FORMVIEW_ORGIN')" name="first">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.application_date')" prop="application_date">
                    <el-date-picker v-model="form.application_date" :disabled="true"
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :error="errorgroup" :label="$t('label.PFANS1004VIEW_GROUPZW')" prop="group_name">
                    <org :disabled="!checkgroup" :error="errorgroup" :orglist="form.group_name" orgtype="2"
              ...
              <el-row>
                <el-col :span="24">
                  <el-table :data="tableD" :summary-method="getSummaries" border header-cell-class-name="sub_bg_color_blue" show-summary
                            stripe style="width: 73vw">
                    <el-table-column :label="$t('label.PFANS2006VIEW_NO')" align="center" type="index" width="80">
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1005FORMVIEW_ERROR')" align="center" prop="remarks"
                                     width="180">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.remarks" :disabled="!disable" maxlength="200">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1019FORMVIEW_EMPLOY')" align="center" prop="employ"
                                     width="180">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.employ" :disabled="!disable" maxlength="200">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1005VIEW_UNITPRICE')" align="center" prop="unitprice"
                                     width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.unitprice" :disabled="!disable" :min="0"
                                         :no="scope.row" :precision="2" :step="1"
                                         controls-position="right" @change="changeSum(scope.row)">
                        </el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS3005VIEW_QUANTITY')" align="center" prop="numbers"
                                     width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.numbers" :disabled="!disable" :min="0" :no="scope.row"
                                         :precision="0" :step="1"
                                         controls-position="right" @change="changeSum(scope.row)">
                        </el-input-number>
                      </template>
                    ...
                    <el-table-column :label="$t('label.PFANS1005VIEW_AMOUNT')" align="center" prop="amount" width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.amount" :disabled="true" :no="scope.row"
                                         :precision="2" controls-position="right" @change="changeSum(scope.row)">
                        </el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1005FORMVIEW_PJPROJECT')" align="center" prop="projects"
                                     width="180">
                      <template slot-scope="scope">
                        <el-select v-model="scope.row.projects" :disabled="!disable" :placeholder="$t('normal.error_09')"
                                   clearable>
                          <el-option
...
import {accAdd, getCurrentRole2, getOrgInfo, getOrgInfoByUserId, getStatus} from '@/utils/customize';
