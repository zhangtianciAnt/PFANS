<template>
  <div>
    <EasyNormalContainer ref="container"
                         ...
                         :title="title"
                         :userlist="userlist"
                         :workflowCode="workflowCode" @StartWorkflow="buttonClick"
      ...
      <div slot="customize">
        <el-form ref="reff" :model="form" :rules="rules" label-position="top" label-width="8vm" style="padding: 2vw">
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS1025VIEW_FIRSTDETAILS')" name="first">
              <div>
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :error="errorcustojapanese" :label="$t('label.PFANS1031FORMVIEW_DEPOSITJAPANESE')"
                                  prop="custojapanese">
                      <el-input v-model="form.custojapanese" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="8">
                    <el-form-item :error="errorcustochinese" :label="$t('label.PFANS1032FORMVIEW_DEPOSITARYCHINESE')"
                                  prop="custochinese">
                      <el-input v-model="form.custochinese" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item
                      :error="errorplacejapanese"
                      :label="$t('label.PFANS1030FORMVIEW_PRINCIPALPLAC')+$t('（')+$t('label.PFANS1024VIEW_JAPANESE')+$t('）')" prop="placejapanese">
                      <el-input v-model="form.placejapanese" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :error="errorplacechinese"
                                  :label="$t('label.PFANS1032FORMVIEW_PRINCIPALPLACECHINESE')" prop="placechinese">
                      <el-input v-model="form.placechinese" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="8">
                    <el-form-item :error="errordeployment" :label="$t('label.PFANS1024VIEW_DEPLOYMENT')"
                                  prop="deployment">
                      <el-input v-model="form.deployment" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :error="errorpjnamejapanese" :label="$t('label.PFANS1025VIEW_PJNAMEJAPANESE')"
                                  prop="pjnamejapanese">
                      <el-input v-model="form.pjnamejapanese" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :error="errorpjnamechinese" :label="$t('label.PFANS1025VIEW_PJNAMECHINESE')"
                                  prop="pjnamechinese">
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :error="errorclaimdatetimeStart" :label="$t('label.PFANS1025VIEW_OPENINGDATE')"
                  ...
                  <el-col :span="8">
                    <el-form-item :error="errorclaimdatetimeEnd" :label="$t('label.PFANS1025VIEW_ENDDATE')"
                  ...
                  <el-col :span="8">
                    <el-form-item :error="errorcurrencyposition" :label="$t('label.PFANS1025VIEW_CURRENCYFORMAT')"
                      ...
                      <!--                                 style="width:20vw">-->
                      <!--                      </dicselect>-->
                      <monthlyrate :data="form.currencyposition"
                                   :disabled="true"
                                   :month="month3"
                                   :multiple="multiple"
                                   style="width:20vw"
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :error="errorclaimamount" :label="$t('label.PFANS1024VIEW_CLAIMAMOUNT')"
                                  prop="claimamount">
                      <el-input v-model="form.claimamount" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
              ...
              <el-row v-if="this.form.contracttype != 'HT008002'
                ...
                <el-col :span="24">
                  <el-table :data="tableS" border header-cell-class-name="sub_bg_color_blue" stripe style="width: 70vw">
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_NUMBER')"
                      align="center" prop="claimtype" width="150"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_DELIVERYDATE')"
                      align="center" prop="deliverydate" width="170"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_COMPLETIONDATE')"
                      align="center" prop="completiondate" width="150"/>
                    <el-table-column
              ...
              <el-row v-if="this.form.contracttype == 'HT008002'
                        ...
                        || this.form.contracttype == 'HT008008'">
                <el-col :span="24">
                  <el-table :cell-style="{padding:'0px'}" :data="tableFS" border header-cell-class-name="sub_bg_color_blue" stripe
                            style="width: 100%">
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_NUMBER')"
                      align="center" prop="claimtype" width="100"/>
                    <el-table-column
                      :label="$t('label.PFANS1030FORMVIEW_DEPARTMENT')"
                      align="center" prop="department" width="260"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_DELIVERYDATE')"
                      align="center" prop="deliverydate" width="110"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_COMPLETIONDATE')"
                      align="center" prop="completiondate" width="110"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_CLAIMDATE')" align="center" prop="claimdate" width="110"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_SUPPORTDATE')" align="center" prop="supportdate" width="110"/>
                    <el-table-column
                      :label="$t('label.PFANS1024VIEW_CLAIMAMOUNT')" align="center" prop="claimamount" width="120"/>
                    <el-table-column
                      :label="$t('label.PFANS1030FORMVIEW_DISTRIAMOUNT')" align="center" prop="distriamount"
                      width="230">
            ...
            <el-tab-pane :label="$t('label.PFANS1025VIEW_SECONDDETAILS')" name="second">
              <div>
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :error="error" :label="$t('label.PFANS1008FORMVIEW_INITIATOR')" prop="user_id">
                      <user v-model="form.user_id" :disabled="true" :error="error" :selectType="selectType"
                            :userlist="userlistA" style="width:20vw" @getUserids="getUserids"></user>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_TELEPHONE')" prop="telephone">
                      <el-input v-model="form.telephone" :disabled="true" maxlength="20" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :error="errorvaluation" :label="$t('label.PFANS1025VIEW_VALUATION')" prop="valuation">
                  ...
                  <el-col :span="8">
                    <el-form-item :error="errorindividual" :label="$t('label.PFANS1025VIEW_INDIVIDUAL')"
                                  prop="individual">
                      <dicselect :code="code2"
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_PLANNUMBER')">
                      <el-input v-model="form.plannumber" :disabled="!disable" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_VALUATIONNUMBER')">
                      <el-input v-model="form.valuationnumber" :disabled="!disable" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1017FORMVIEW_PREPAREFOR')">
                      <el-input v-model="form.remarks" :disabled="!disable" style="width:45vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
              <el-table :data="tableT" :summary-method="getTsummaries"
                ...
                <el-table-column :label="$t('label.PFANS1012FORMVIEW_BUDGET')" align="center" width="150">
                  <template slot-scope="scope">
                    ...
                    <!--                    </el-input>-->
                    <el-select v-model="scope.row.budgetcode" :disabled="!disable" :no="scope.row" :placeholder="$t('normal.error_09')"
                               clearable style="width: 100%" @change="getBudgetunit">
                      <el-option
                ...
                <el-table-column :error="errorgroup" :label="$t('label.PFANS1025VIEW_DEPART')" align="center"
                                 prop="depart" width="170">
                  <template slot-scope="scope">
                    <org :disabled="scope.row.budgetcode ===$t('label.PFANS6008VIEW_EXPENSE')?true:!disable"
                         :error="errorgroup"
                         :no="scope.row"
                         :orglist="scope.row.depart"
                         orgtype="4"
                         style="width: 9rem"
                         @getOrgids="getGroupId"></org>
                    <el-input v-show='false' v-model="scope.row.companyend" :disabled="false"
                ...
                <el-table-column :label="$t('label.PFANS5008VIEW_PROGRAM')" align="center" width="200">
                  ...
                  <template slot-scope="scope">
                    <project :date="scope.row.projects" :disabled="scope.row.budgetcode ===$t('label.PFANS6008VIEW_EXPENSE')?true:!disable" :no="scope.row"
                             style="width: 100%"
                             @change="changePro">
                    </project>
                  </template>
                ...
                <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" width="600">
                  <el-table-column :label="$t('label.PFANS1025VIEW_MEMBER')" align="center" prop="member" width="150">
                    <template slot-scope="scope">
                      <el-input-number
                  ...
                  <el-table-column :label="$t('label.PFANS1025VIEW_OUTSOURCE')" align="center" prop="outsource"
                                   width="150">
                    <template slot-scope="scope">
                      <el-input-number
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1030FORMVIEW_EXCHANGERATE')">
                      ...
                      <el-input v-model="form.exchangerate" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
            ...
            <el-tab-pane :label="$t('label.PFANS1030FORMVIEW_DETAIL')" name="third">
              ...
              <el-row v-if="forreason">
                <el-form-item :label="$t('label.PFANS1028VIEW_RESON')" prop="reason">
                  <el-input v-model="strreason"
                            :autosize="{ minRows: 2, maxRows: 5}"
                            :disabled="!disable" :placeholder="$t('label.PFANS1030FORMVIEW_REASON')" style="width: 73vw"
                            type="textarea">
                  </el-input>
                </el-form-item>
              </el-row>
              <el-row>
                <el-table :data="tableD" :summary-method="getTsummariesTableD"
                          header-cell-class-name="sub_bg_color_blue"
                          show-summary stripe>
                  <el-table-column :label="$t('label.PFANS1030FORMVIEW_DEPARTMENT')" align="center" prop="incondepartment"
                                   width="150">
                    <template slot-scope="scope">
                      <el-select v-model="scope.row.incondepartment" :disabled="!disable" :placeholder="$t('normal.error_09')"
                                 clearable @change="changeDep(scope.row)">
                        <el-option
                  ...
                  <el-table-column :label="$t('label.PFANS1020FORMVIEW_RANK')" align="center" prop="attf" width="150">
                    <template slot-scope="scope">
                      <el-select v-model="scope.row.attf" :disabled="!disable" :placeholder="$t('normal.error_09')"
                                 clearable @change="changeRank(scope.row)">
                        <el-option
                  ...
                  <el-table-column :label="$t('label.PFANS1030FORMVIEW_PLANNED')" align="center" width="170">
                    <el-table-column :label="$t('label.PFANS1051MONTH4')" align="center" prop="inwork04" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH5')" align="center" prop="inwork05" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH6')" align="center" prop="inwork06" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH7')" align="center" prop="inwork07" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH8')" align="center" prop="inwork08" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH9')" align="center" prop="inwork09" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH10')" align="center" prop="inwork10" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH11')" align="center" prop="inwork11" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH12')" align="center" prop="inwork12" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH1')" align="center" prop="inwork01" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH2')" align="center" prop="inwork02" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1051MONTH3')" align="center" prop="inwork03" width="150">
                      <template slot-scope="scope">
                        <el-input-number
                  ...
                  <el-table-column :label="$t('label.PFANS1036FORMVIEW_TOTAL')" align="center" prop="totalall"
                                   width="120">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.totalall" :disabled="true" maxlength="20" style="width: 100%">
                      </el-input>
                    </template>
                  </el-table-column>
                  <el-table-column v-if="false" :label="$t('label.PFANS1030FORMVIEW_ATTFMOTH')" align="center"
                                   prop="BMtotal" width="120">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.BMtotal" :disabled="true" maxlength="20" style="width: 100%">
                      </el-input>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane :label="$t('label.PFANS2022VIEW_UPDATINGFILES')" name="fourth">
              <el-row>
                <el-col :span="8">
                  <el-form-item :error="errorfile" :label="$t('label.enclosure')" prop="enclosurecontent">
                    <el-upload
                      ref="upload"
