          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.application')" prop="dailypayment">
                <el-date-picker v-model="form.dailypayment"
                                :disabled="true"
                                style="width:20vw"
                                type="date"
                ></el-date-picker>
              ...
              <el-table :data="tableT" border header-cell-class-name="sub_bg_color_blue" stripe style="width: 72vw">
                ...
                <el-table-column :label="$t('label.PFANS1019FORMVIEW_MACHINENAME')" align="center" width="150">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.machinename" :disabled="!disable" :no="scope.row" style="width: 100%">
                    </el-input>
                  </template>
                </el-table-column>
                <el-table-column :label="$t('label.PFANS1019FORMVIEW_CUSTOMER')" align="center" width="230">
                  <template slot-scope="scope">
                    <user :disabled="!disable" :error="errorusername" :no="scope.row" :selectType="selectType"
                          :userlist="scope.row.customer"
                ...
                <el-table-column :label="$t('label.PFANS1019FORMVIEW_SOFTWARENAME')" align="center" width="130">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.softwarename" :disabled="!disable" :no="scope.row" maxlength="36"
                              style="width: 100%">
                    </el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1019FORMVIEW_DEVELOPER')" align="center" width="150">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.developer" :disabled="!disable" :no="scope.row" maxlength="20"
                              style="width: 100%">
                    </el-input>
                  </template>
                </el-table-column>
                <el-table-column :label="$t('label.PFANS1019FORMVIEW_EMPLOY')" align="center" width="150">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.employ" :disabled="!disable" :no="scope.row" maxlength="20"
                              style="width: 100%">
                    </el-input>
                  </template>
                </el-table-column>
