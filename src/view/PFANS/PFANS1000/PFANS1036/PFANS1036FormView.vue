<template>
  <div style="min-height: 100%">
    <EasyNormalContainer
      ...
      :title="title"
      :workflowCode="workflowCode" @buttonClick="buttonClick" @end="end" @start="start"
      @workflowState="workflowState"
    >
      <div slot="customize">
        <el-form ref="form" :model="form" :rules="rules" employedref="refform" label-position="top" label-width="8vw"
                 style="padding: 1.5vw">
          <el-row v-show="false">
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1036FORMVIEW_GROUP')">
                <el-input v-model="form.groupid" :disabled="true" style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row style="padding-top: 0.5%;padding-bottom: 1%">
            ...
            <el-col :span="6">
              <el-form-item :label="$t('label.PFANS2036VIEW_DEPARTMENT')" prop="center_id">
                <el-select v-model="form.center_id" :disabled="disabledC" style="width: 20vw"
                           @change="groupChange">
                  <el-option
            ...
            <el-col :span="10">
              <div style="padding-bottom: 0.5%;padding-left: 88%;width:20vw;margin-top: 2.5vw">
                ...
                <!--            <el-divider direction="vertical"></el-divider>-->
                <span
                  style="color:#f47f31">{{ (this.redirict === '0' ? this.$t('label.PFANS1036FORMVIEW_ZJJJDEPARTMENT') : this.$t('label.PFANS1036FORMVIEW_JJDEPARTMENT')) || '' }}</span>
                <el-divider direction="vertical"></el-divider>
          ...
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_PERSONNELPLAN')" name="first" style="margin-top: 2%">
              <div>
                <el-tabs v-model="activeName2" type="border-card">
                  <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_TOTAL')" name="first">
                    <el-table :data="tableA" header-cell-class-name="sub_bg_color_blue" stripe style="margin-top: 2%">
                      <el-table-column>
                        <el-table-column :formatter="formatterColumn" :label="$t('label.PFANS1036FORMVIEW_TOTALPLAN')" align="center" prop="total1"
                                         width="120">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.April')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount4"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving4"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour4"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay4"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.May')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount5"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving5"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour5"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay5"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.June')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount6"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving6"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour6"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay6"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.July')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount7"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving7"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour7"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay7"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.August')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount8"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving8"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour8"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay8"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.September')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount9"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving9"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour9"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay9"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.firsthalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amountfirst"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="givingfirst"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghourfirst"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="payfirst"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.October')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount10"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving10"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour10"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay10"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.November')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount11"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving11"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour11"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay11"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.December')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount12"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving12"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour12"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay12"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.January')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount1"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving1"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour1"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay1"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.February')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount2"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving2"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour2"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay2"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.March')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amount3"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="giving3"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghour3"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="pay3"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.secondhalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amountsecond"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="givingsecond"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghoursecond"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="paysecond"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_ANNUALTOTAL')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_NUMBER')" align="center" prop="amounttotal"
                                         width="50">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1045VIEW_SPAN2')" align="center" prop="givingtotal"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_WORKINGHOURS')" align="center" prop="workinghourtotal"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAY')" align="center" prop="paytotal"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                    </el-table>
                  ...
                  <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_CURRENTPERSONNEL')" name="second">
                    <el-table :data="tableC" :summary-method="val => getSummaries(val,'C')" header-cell-class-name="sub_bg_color_blue" show-summary
                              stripe>
                      <el-table-column :formatter="formatterColumn" align="center" prop="type" width="90">
                      </el-table-column>
                      <el-table-column :formatter="formatterColumn" :label="$t('label.PFANS1036FORMVIEW_RANK')" align="center"
                                       prop="level" width="60">
                      </el-table-column>
                      <el-table-column v-if="false" :label="$t('label.PFANS1036FORMVIEW_SUMMERPLANPC')" align="center"
                                       prop="summerplanpc" width="120">
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEPAYHOUR')" align="center" prop="payhour"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-model="scope.row.payhour" :min="0"
                                           :precision="2" controls-position="right" size="small" style="width:7vw"
                                           @change="changeHour(scope.row)"></el-input-number>
                        </template>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_OVERTIMEHOUR')" align="center" prop="overtimehour"
                                       width="130">
                        <template slot-scope="scope">
                          <el-input-number v-model="scope.row.overtimehour" :min="0"
                                           :precision="2" controls-position="right" size="small" style="width:7vw"
                                           @change="changeHour(scope.row)"></el-input-number>
                        </template>
                      </el-table-column>
                  ...
                  <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_CAREER')" name="third">
                    <el-table :data="tableD" :summary-method="val => getSummaries(val,'D')" header-cell-class-name="sub_bg_color_blue" show-summary
                              stripe>
                      <el-table-column :formatter="formatterColumn" align="center" prop="type" width="90">
                      </el-table-column>
                      <el-table-column :formatter="formatterColumn" :label="$t('label.PFANS1036FORMVIEW_RANK')" align="center"
            ...
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_EQUIPMENTINVESTMENT')" name="second"
                         style="margin-top: 2%">
              <div>
                <AssetsComponent ref="assest" :active="activeName"
                                 :tableLastYear="assets_lastyear" :tableLodYear="assets_lodyear"
                                 :tableNewYear="assets_newyear"
                                 @assets="Assets" @on-change-tableNewYear="changeTableNewYear"
                                 @on-change-tableLastYear="changeTableLastYear"></AssetsComponent>
              </div>
            </el-tab-pane>
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_SOFTWAREINVESTMENT')" name="third" style="margin-top: 2%">
              <div>
                <AssetsComponent ref="equipment" :active="activeName"
                                 :tableLastYear="equipment_lastyear" :tableLodYear="equipment_lodyear"
                                 :tableNewYear="equipment_newyear"
                                 @assets="Assetss" @on-change-tableNewYear="changeTableNewYear"
                                 @on-change-tableLastYear="changeTableLastYear"></AssetsComponent>
              </div>
            </el-tab-pane>
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_TRAVELEXPENSES')" name="forth" style="margin-top: 2%">
              <BussinessComponent :tableBusiness="business" @travel="getTravel"></BussinessComponent>
            </el-tab-pane>
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_PROJECTPLAN')" name="fifth" style="margin-top: 2%">
              <div>
                <el-tabs v-model="activeName6" type="border-card">
                  <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_TOTAL')" name="first">
                    <el-table :data="tableSZTotal" header-cell-class-name="sub_bg_color_blue" stripe>
                      <el-table-column>
                        <el-table-column :formatter="formatterColumn" align="center" prop="total5" width="220">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_1Q')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number1"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money1"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_2Q')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number2"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money2"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.firsthalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="numberfirst"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="moneyfirst"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_3Q')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number3"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money3"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_4Q')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number4"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money4"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.secondhalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="numbersecond"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="moneysecond"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_ANNUALTOTAL')" align="center" width="110">
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="numbertotal"
                                         width="110">
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="moneytotal"
                                         width="110">
                        </el-table-column>
                      </el-table-column>
                    </el-table>
                  ...
                  <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_B4')" name="fifth">
                    <TrustComponent :check="false" :disabled="false" :tableTrust="groupC"
                                    @sum="getSumC"></TrustComponent>
                  </el-tab-pane>
                </el-tabs>
              </div>
            </el-tab-pane>
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_VARIOUSFUNDS')" name="sixth" style="margin-top: 2%">
              <div>
                <el-tabs v-model="activeName7" type="border-card">
                  <el-tab-pane :label="$t('label.PFANS1036VIEW_COMMUNICATION')" name="first">
                    <el-table :data="tableO1" :summary-method="(val) => getSummaries(val,'o1')" header-cell-class-name="sub_bg_color_blue" height="650"
                              show-summary stripe>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_NO')" align="center" fixed type="index"
                                       width="50">
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_BIGPROJECT')" align="center" prop="programme"
                                       width="150">
                        <template slot-scope="scope">
                          <el-input v-model="scope.row.programme" maxlength="20" size="small"
                                    style="width: 100%;"></el-input>
                        </template>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_SMALLPROJECT')" align="center" prop="sprogramme"
                                       width="150">
                        <!--                        <template slot-scope="scope">-->
                      ...
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_UNITPRICE')" align="center" prop="price"
                                       width="135">
                        <template slot-scope="scope">
                          <el-input-number v-model="scope.row.price" :disabled="scope.row.disableEdit" :min="0" :step="1000"
                                           controls-position="right" size="small"
                                           style="width:7vw"
                                           @change="changeSum(scope.row)"></el-input-number>
                        </template>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLANTYPE')" align="center" prop="type"
                                       width="135">
                        <template slot-scope="scope">
                          <dicselect
                            :data="scope.row.type"
                      ...
                      <el-table-column :label="$t('label.firsthalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.April')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number4"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number4" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,4)">
                              </el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money4"
                        ...
                        <el-table-column :label="$t('label.May')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number5"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number5" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,5)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money5"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.June')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number6"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number6" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,6)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money6"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.July')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number7"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number7" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,7)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money7"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.August')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number8"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number8" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,8)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money8"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.September')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number9"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number9" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,9)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money9"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                      </el-table-column>
                      <el-table-column :label="$t('label.secondhalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.October')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number10"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number10" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,10)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money10"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.November')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number11"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number11" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,11)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money11"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.December')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number12"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number12" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,12)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money12"
                                           width="130">
                          </el-table-column>
                        </el-table-column>
                        <el-table-column :label="$t('label.January')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number1"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number1" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,1)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money1"
                                           width="130">
                        ...
                        <el-table-column :label="$t('label.February')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number2"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number2" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw" @change="changeSum(scope.row,2)"
                              ></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money2"
                        ...
                        <el-table-column :label="$t('label.March')" align="center" width="135">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number3"
                                           width="135">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number3" :disabled="!disable === true ? true : (scope.row.sprogramme === 'PJ147014' || scope.row.sprogramme === 'PJ148001' || scope.row.sprogramme === 'PJ148002' ||
                                                                  scope.row.sprogramme === 'PJ148003' ? true : false)" :min="0" :precision="1"
                                               :step="1" controls-position="right" size="small"
                                               style="width:7vw"
                                               @change="changeSum(scope.row,3)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money3"
                                           width="130">
                      ...
                      <el-table-column :label="$t('label.operation')" align="center" fixed="right" width="150">
                        <template slot-scope="scope">
                          <el-button
                  ...
                  <el-tab-pane :label="$t('label.PFANS1036VIEW_USING')" name="second">
                    <el-table :data="tableO2" :summary-method="(val) => getSummaries(val,'o2')" header-cell-class-name="sub_bg_color_blue" height="650"
                              show-summary stripe>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_NO')" align="center" fixed type="index"
                                       width="50">
                      </el-table-column>
                      ...
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_SMALLPROJECT')" align="center" prop="sprogramme"
                                       width="150">
                        <template slot-scope="scope">
                          <el-input v-model="scope.row.sprogramme" maxlength="20" size="small"
                                    style="width: 100%;"></el-input>
                        </template>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_UNITPRICE')" align="center" prop="price"
                                       width="135">
                        <template slot-scope="scope">
                          <el-input-number v-model="scope.row.price" :min="0" :step="1000" controls-position="right"
                                           size="small" style="width:7vw"
                                           @change="changeSum(scope.row)"></el-input-number>
                        </template>
                      </el-table-column>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLANTYPE')" align="center" prop="type"
                      ...
                      <el-table-column :label="$t('label.firsthalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.April')" align="center" width="130">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number4"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number4" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,4)">
                              </el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.May')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number5"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number5" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,5)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.June')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number6"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number6" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,6)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.July')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number7"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number7" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,7)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.August')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number8"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number8" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,8)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.September')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number9"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number9" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,9)"></el-input-number>
                            </template>
                          </el-table-column>
                      ...
                      <el-table-column :label="$t('label.secondhalfyear')" align="center" width="110">
                        <el-table-column :label="$t('label.October')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number10"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number10" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,10)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.November')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number11"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number11" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,11)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.December')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number12"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number12" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,12)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.January')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number1"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number1" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,1)"></el-input-number>
                            </template>
                          </el-table-column>
                        ...
                        <el-table-column :label="$t('label.February')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number2"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number2" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,2)"></el-input-number>
                            </template>
                          </el-table-column>
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_AMOUNT')" align="center" prop="money2"
                                           width="130">
                        ...
                        <el-table-column :label="$t('label.March')" align="center" width="110">
                          <el-table-column :label="$t('label.PFANS1036FORMVIEW_JOBNUMBER')" align="center" prop="number3"
                                           width="130">
                            <template slot-scope="scope">
                              <el-input-number v-model="scope.row.number3" :min="0" :precision="1" :step="1"
                                               controls-position="right" size="small" style="width:5vw"
                                               @change="changeSum(scope.row,3)"></el-input-number>
                            </template>
                          </el-table-column>
                  ...
                  <el-tab-pane :label="$t('label.PFANS1036VIEW_TRAINING')" name="third">
                    <el-table :data="tableO3" :summary-method="(val) => getSummaries(val,'o3')" header-cell-class-name="sub_bg_color_blue" height="650"
                              show-summary stripe>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_NO')" align="center" fixed type="index"
                                       width="50">
                      </el-table-column>
                  ...
                  <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_VARIOUSFUNDS')" name="fouth">
                    <el-table :data="tableO" :summary-method="(val) => getSummaries(val,'o4')" header-cell-class-name="sub_bg_color_blue" height="650"
                              show-summary stripe>
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_NO')" align="center" fixed type="index"
                                       width="50">
                      </el-table-column>
                      ...
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_UNITPRICE')" align="center" prop="price"
                                       width="135">
                        <template slot-scope="scope">
                          <el-input-number v-if="scope.row.sprogramme !== 'PJ148037'" v-model="scope.row.price" :disabled="scope.row.disableEdit" :min="0"
                                           :step="1000"
                                           controls-position="right" size="small"
                                           style="width:7vw" @change="changeSum(scope.row)">
                          </el-input-number>
                          <el-input-number v-if="scope.row.sprogramme === 'PJ148037'" v-model="scope.row.price" :disabled="scope.row.disableEdit"
                                           :step="1000"
                                           controls-position="right" size="small"
                                           style="width:7vw" @change="changeSum(scope.row)">
                          </el-input-number>
            ...
            <el-tab-pane :label="$t('label.PFANS1036FORMVIEW_PL')" name="seventh" style="margin-top: 2%">
              <div class="test">
                <el-table :data="tableP" :row-class-name="rowClass" :span-method="objectSpanMethod"
                          header-cell-class-name="sub_bg_color_blue" height="800">
                  <el-table-column :formatter="formatterDir" align="center" fixed prop="name" width="70">
                  </el-table-column>
                  <el-table-column :formatter="formatterDir" :label="$t('label.PFANS1036FORMVIEW_CONTENT')" align="center"
                                   fixed prop="name1" width="250">
                  </el-table-column>
                  <!--                  <el-table-column align="center" width="130" prop="name2" :formatter="formatterDir" fixed>-->
                  <!--                  </el-table-column>-->
                  <el-table-column :label="$t('label.firsthalfyear')" align="center" width="110">
                    <el-table-column :label="$t('label.April')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money4"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money4" :controls="false" :min="0"
                    ...
                    <el-table-column :label="$t('label.May')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money5"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money5" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.June')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money6"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money6" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.July')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money7"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money7" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.August')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money8"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money8" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.September')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money9"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money9" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                  ...
                  <el-table-column :label="$t('label.secondhalfyear')" align="center" width="110">
                    <el-table-column :label="$t('label.October')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money10"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money10" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.November')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money11"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money11" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.December')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money12"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money12" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.January')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money1"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money1" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.February')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money2"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money2" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                    ...
                    <el-table-column :label="$t('label.March')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="money3"
                                       width="110">
                        <template slot-scope="scope">
                          <el-input-number v-if="[40,44,45,48,54,55,56,57,58].includes(scope.$index)" v-model="scope.row.money3" :controls="false" :min="0"
                                           :precision="2" size="small"
                                           style="width:4vw"
                                           @change="computedSum"></el-input-number>
                  ...
                  <el-table-column :label="$t('label.PFANS1036FORMVIEW_ANNUALTOTAL')" align="center" width="110">
                    <el-table-column :label="$t('label.PFANS1036FORMVIEW_ANNUALTOTAL')" align="center" width="110">
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="moneytotal"
                                       width="110">
                        <template slot-scope="scope">
                      ...
                      <el-table-column :label="$t('label.PFANS1036FORMVIEW_PLAN')" align="center" prop="moneytotal_"
                                       width="110">
                        <!--                        <template slot-scope="scope">-->
                        <!--                          <span>{{scope.row.moneytotal}}</span>-->
                        <!--                        </template>-->
                      ...
                      <!--   事业计划消耗 START      -->
                      <el-table-column :label="$t('label.actualattend')" align="center" prop="act_"
                                       width="110">
                        <!--                        <template slot-scope="scope">-->
                        <!--                          <span>{{scope.row.moneytotal}}</span>-->
                        <!--                        </template>-->
...
export default {
  ...
  methods: {
    ...
    computedSum() {
      ...
      let total25 = 0;
      let total35 = 0;
      let total45 = 0;   //let total55 = 0; scc del 移除工数(人月)显示 10/14
      let total6 = 0;
      let total16 = 0;
      let total26 = 0;
      let total36 = 0;
      let total46 = 0;   //let total56 = 0; scc del 移除工数(人月)显示 10/14
      let total7 = 0;
      let total17 = 0;
      let total27 = 0;
      let total37 = 0;
      let total47 = 0;   //let total57 = 0; scc del 移除工数(人月)显示 10/14
      let total8 = 0;
      let total18 = 0;
      let total28 = 0;
      let total38 = 0;
      let total48 = 0;   //let total58 = 0; scc del 移除工数(人月)显示 10/14
      let total9 = 0;
      let total19 = 0;
      let total29 = 0;
      let total39 = 0;
      ...
      for (let i = 0; i < this.arr.length; i++) {
        ...
        //add ccm 20211008 PL添加年间合计 fr
        total0 = total0 + Number(this.tableP[0]['money' + this.arr[i]]);
        total10 = total10 + Number(this.tableP[10]['money' + this.arr[i]]);
        total1 = total1 + Number(this.tableP[1]['money' + this.arr[i]]);
        total11 = total11 + Number(this.tableP[11]['money' + this.arr[i]]);
        total2 = total2 + Number(this.tableP[2]['money' + this.arr[i]]);
        total12 = total12 + Number(this.tableP[12]['money' + this.arr[i]]);
        total3 = total3 + Number(this.tableP[3]['money' + this.arr[i]]);
        total13 = total13 + Number(this.tableP[13]['money' + this.arr[i]]);
        total4 = total4 + Number(this.tableP[4]['money' + this.arr[i]]);
        total14 = total14 + Number(this.tableP[14]['money' + this.arr[i]]);
        total5 = total5 + Number(this.tableP[5]['money' + this.arr[i]]);
        total15 = total15 + Number(this.tableP[15]['money' + this.arr[i]]);
        total6 = total6 + Number(this.tableP[6]['money' + this.arr[i]]);
        total16 = total16 + Number(this.tableP[16]['money' + this.arr[i]]);
        total7 = total7 + Number(this.tableP[7]['money' + this.arr[i]]);
        total17 = total17 + Number(this.tableP[17]['money' + this.arr[i]]);
        total8 = total8 + Number(this.tableP[8]['money' + this.arr[i]]);
        total18 = total18 + Number(this.tableP[18]['money' + this.arr[i]]);
        total9 = total9 + Number(this.tableP[9]['money' + this.arr[i]]);
        total19 = total19 + Number(this.tableP[19]['money' + this.arr[i]]);

        total20 = total20 + Number(this.tableP[20]['money' + this.arr[i]]);
        total30 = total30 + Number(this.tableP[30]['money' + this.arr[i]]);
        total21 = total21 + Number(this.tableP[21]['money' + this.arr[i]]);
        total31 = total31 + Number(this.tableP[31]['money' + this.arr[i]]);
        total22 = total22 + Number(this.tableP[22]['money' + this.arr[i]]);
        total32 = total32 + Number(this.tableP[32]['money' + this.arr[i]]);
        total23 = total23 + Number(this.tableP[23]['money' + this.arr[i]]);
        total33 = total33 + Number(this.tableP[33]['money' + this.arr[i]]);
        total24 = total24 + Number(this.tableP[24]['money' + this.arr[i]]);
        total34 = total34 + Number(this.tableP[34]['money' + this.arr[i]]);
        total25 = total25 + Number(this.tableP[25]['money' + this.arr[i]]);
        total35 = total35 + Number(this.tableP[35]['money' + this.arr[i]]);
        total26 = total26 + Number(this.tableP[26]['money' + this.arr[i]]);
        total36 = total36 + Number(this.tableP[36]['money' + this.arr[i]]);
        total27 = total27 + Number(this.tableP[27]['money' + this.arr[i]]);
        total37 = total37 + Number(this.tableP[37]['money' + this.arr[i]]);
        total28 = total28 + Number(this.tableP[28]['money' + this.arr[i]]);
        total38 = total38 + Number(this.tableP[38]['money' + this.arr[i]]);
        total29 = total29 + Number(this.tableP[29]['money' + this.arr[i]]);
        total39 = total39 + Number(this.tableP[39]['money' + this.arr[i]]);
        ...
        total42 = total42 + Number(this.tableP[42]['money' + this.arr[i]]);
        total52 = total52 + Number(this.tableP[52]['money' + this.arr[i]]);
        total43 = total43 + Number(this.tableP[43]['money' + this.arr[i]]);
        total53 = total53 + Number(this.tableP[53]['money' + this.arr[i]]);
        total44 = total44 + Number(this.tableP[44]['money' + this.arr[i]]);
        total54 = total54 + Number(this.tableP[54]['money' + this.arr[i]]);
      ...
      //add ccm 20211008 PL添加年间合计 fr
      this.$set(this.tableP[0], 'moneytotal', Number(total0).toFixed(2));
      this.$set(this.tableP[10], 'moneytotal', Number(total10).toFixed(2));
      this.$set(this.tableP[1], 'moneytotal', Number(total1).toFixed(2));
      this.$set(this.tableP[11], 'moneytotal', Number(total11).toFixed(2));
      this.$set(this.tableP[2], 'moneytotal', Number(total2).toFixed(2));
      this.$set(this.tableP[12], 'moneytotal', Number(total12).toFixed(2));
      this.$set(this.tableP[3], 'moneytotal', Number(total3).toFixed(2));
      this.$set(this.tableP[13], 'moneytotal', Number(total13).toFixed(2));
      this.$set(this.tableP[4], 'moneytotal', Number(total4).toFixed(2));
      this.$set(this.tableP[14], 'moneytotal', Number(total14).toFixed(2));
      this.$set(this.tableP[5], 'moneytotal', Number(total5).toFixed(2));
      this.$set(this.tableP[15], 'moneytotal', Number(total15).toFixed(2));
      this.$set(this.tableP[6], 'moneytotal', Number(total6).toFixed(2));
      this.$set(this.tableP[16], 'moneytotal', Number(total16).toFixed(2));
      this.$set(this.tableP[7], 'moneytotal', Number(total7).toFixed(2));
      this.$set(this.tableP[17], 'moneytotal', Number(total17).toFixed(2));
      this.$set(this.tableP[8], 'moneytotal', Number(total8).toFixed(2));
      this.$set(this.tableP[18], 'moneytotal', Number(total18).toFixed(2));
      this.$set(this.tableP[9], 'moneytotal', Number(total9).toFixed(2));
      this.$set(this.tableP[19], 'moneytotal', Number(total19).toFixed(2));

      this.$set(this.tableP[20], 'moneytotal', Number(total20).toFixed(2));
      this.$set(this.tableP[30], 'moneytotal', Number(total30).toFixed(2));
      this.$set(this.tableP[21], 'moneytotal', Number(total21).toFixed(2));
      this.$set(this.tableP[31], 'moneytotal', Number(total31).toFixed(2));
      this.$set(this.tableP[22], 'moneytotal', Number(total22).toFixed(2));
      this.$set(this.tableP[32], 'moneytotal', Number(total32).toFixed(2));
      this.$set(this.tableP[23], 'moneytotal', Number(total23).toFixed(2));
      this.$set(this.tableP[33], 'moneytotal', Number(total33).toFixed(2));
      this.$set(this.tableP[24], 'moneytotal', Number(total24).toFixed(2));
      this.$set(this.tableP[34], 'moneytotal', Number(total34).toFixed(2));
      this.$set(this.tableP[25], 'moneytotal', Number(total25).toFixed(2));
      this.$set(this.tableP[35], 'moneytotal', Number(total35).toFixed(2));
      this.$set(this.tableP[26], 'moneytotal', Number(total26).toFixed(2));
      this.$set(this.tableP[36], 'moneytotal', Number(total36).toFixed(2));
      this.$set(this.tableP[27], 'moneytotal', Number(total27).toFixed(2));
      this.$set(this.tableP[37], 'moneytotal', Number(total37).toFixed(2));
      this.$set(this.tableP[28], 'moneytotal', Number(total28).toFixed(2));
      this.$set(this.tableP[38], 'moneytotal', Number(total38).toFixed(2));
      this.$set(this.tableP[29], 'moneytotal', Number(total29).toFixed(2));
      this.$set(this.tableP[39], 'moneytotal', (Math.round(Number(total39) * 100) / 100).toFixed(2));

      this.$set(this.tableP[40], 'moneytotal', Number(total40).toFixed(2));
      this.$set(this.tableP[50], 'moneytotal', Number(Number(this.tableP[50]['money6']) + Number(this.tableP[50]['money9']) + Number(this.tableP[50]['money12']) + Number(this.tableP[50]['money3'])).toFixed(2));
      this.$set(this.tableP[41], 'moneytotal', Number(total41).toFixed(2));
      this.$set(this.tableP[51], 'moneytotal', Number(Number(this.tableP[51]['money6']) + Number(this.tableP[51]['money9']) + Number(this.tableP[51]['money12']) + Number(this.tableP[51]['money3'])).toFixed(2));
      this.$set(this.tableP[42], 'moneytotal', Number(total42).toFixed(2));
      this.$set(this.tableP[52], 'moneytotal', Number(total52).toFixed(2));
      this.$set(this.tableP[43], 'moneytotal', Number(total43).toFixed(2));
      this.$set(this.tableP[53], 'moneytotal', Number(total53).toFixed(2));
      this.$set(this.tableP[44], 'moneytotal', Number(total44).toFixed(2));
      this.$set(this.tableP[54], 'moneytotal', Number(total54).toFixed(2));
