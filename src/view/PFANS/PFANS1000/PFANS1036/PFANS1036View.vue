              ...
              <el-col :span="14">
                <el-form-item :label="$t('label.PFANS1006FORMVIEW_DISTINGUISH')">
                  <el-radio v-model="radio" label="1" style="margin-left: 50px">
                    {{ $t('label.PFANS1036FORMVIEW_EQUIPMENTINVESTMENT') }}
                  </el-radio>
                  <el-radio v-model="radio" label="2">{{ $t('label.PFANS1036FORMVIEW_SOFTWAREINVESTMENT') }}</el-radio>
                </el-form-item>
              </el-col>
              <el-col :span="4">
                <el-button type="primary" @click="checkliste">
                  {{ $t('button.confirm') }}
                </el-button>
              </el-col>
            </el-row>
...
import {Decrypt, getCurrentRole3, getStatus, getUserInfo} from '@/utils/customize';
