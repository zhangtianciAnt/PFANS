              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1032FORMVIEW_CONTRACTNUMBER')" prop="contractnumber">
                    <el-input v-model="form.contractnumber" :disabled="!disabled1" maxlength='20'
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1031FORMVIEW_DEPOSITJAPANESE')" prop="trusteejapanese">
                    <el-input v-model="form.trusteejapanese" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1032FORMVIEW_DEPOSITARYCHINESE')" prop="trusteechinese">
                    <el-input v-model="form.trusteechinese" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1027FORMVIEW_JAPANESE')" prop="entrustedjapanese">
                    <el-input v-model="form.entrustedjapanese" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1032FORMVIEW_PRINCIPALPLACECHINESE')" prop="entrustedchinese">
                    <el-input v-model="form.entrustedchinese" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1024VIEW_DEPLOYMENT')" prop="deployment">
                    <el-input v-model="form.deployment" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1025VIEW_PJNAMEJAPANESE')" prop="pjjapanese">
                    <el-input v-model="form.pjjapanese" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1025VIEW_PJNAMECHINESE')" prop="pjchinese">
                    <el-input v-model="form.pjchinese" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1025VIEW_OPENINGDATE')" prop="startdate">
                    <el-date-picker v-model="form.startdate" :disabled="!disabled1" style="width: 20vw"
                                    type="date"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1025VIEW_ENDDATE')" prop="enddate">
                    <el-date-picker v-model="form.enddate" :disabled="!disabled1" style="width: 20vw"
                                    type="date"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1024VIEW_CLAIMAMOUNT')" prop="claimamount">
                    <el-input v-model="form.claimamount" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1024VIEW_LOADINGJUDGE')" prop="loadingjudge">
                    <el-input v-model="form.loadingjudge" :disabled="!disabled1" maxlength='20'
                              style="width: 20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-table :data="tablefirst" border header-cell-class-name="sub_bg_color_blue" stripe>
                <el-table-column
                ...
                <el-table-column
                  ...
                  align="center" prop="deliverydate" width="150"/>
                <el-table-column
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1027FORMVIEW_NUMBER')" prop="requestnumber">
                      <el-input v-model="form.requestnumber" :disabled="!disabled" maxlength='20'
                                style="width: 20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1027FORMVIEW_METHOD')">
                      <el-radio-group v-model="radio1" @change="radio1change">
                        <el-radio :disabled="!disabled" :label="1">{{ $t('label.PFANS1027FORMVIEW_BATCH') }}</el-radio>
                        <el-radio :disabled="!disabled" :label="2">{{ $t('label.PFANS1027FORMVIEW_SETTLEMENT') }}
                        </el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1027FORMVIEW_FORM')">
                      <el-radio-group v-model="radio2" @change="radio2change">
                        <el-radio :disabled="!disabled" :label="1">{{ $t('label.PFANS1027FORMVIEW_CONTRACT') }}
                        </el-radio>
                        <el-radio :disabled="!disabled" :label="2">{{ $t('label.PFANS1027FORMVIEW_APPOINT') }}
                        </el-radio>
                        <el-radio :disabled="!disabled" :label="3">{{ $t('label.PFANS1027FORMVIEW_CONSERVATIVE') }}
                        </el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1027FORMVIEW_DEFECTS')">
                      <el-radio-group v-model="radio3" @change="radio3change">
                        <el-radio :disabled="!disabled" :label="1">{{ $t('label.PFANS1027FORMVIEW_YES') }}</el-radio>
                        <el-radio :disabled="!disabled" :label="2">{{ $t('label.PFANS1027FORMVIEW_NO') }}</el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                  ...
                  <el-table
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.appoint1" :disabled="!disabled" style="width: 11rem"
                    ...
                    <el-table-column
                      ...
                      width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.functionsprice1" :disabled="!disabled" :max="1000000000"
                                         :min="0" :precision="2" :step="1" controls-position="right"
                                         style="width: 11rem" @change="changeSum1(scope.row)"></el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.functionhour1" :disabled="!disabled" :max="1000000000"
                                         :min="0" :precision="2" :step="1" controls-position="right"
                                         style="width: 11rem" @change="changeSum1(scope.row)"></el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.functionamount1" :disabled="!disabled1"
                                         :max="1000000000" :min="0" :precision="2" controls-position="right"
                                         style="width: 11rem" @change="changeSum1(scope.row)"></el-input-number>
                      </template>
                    </el-table-column>
                    ...
                    <el-col :span="24">
                      <el-table
                        ...
                        <el-table-column
                          ...
                          width="200">
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.detailed1" :disabled="!disabled"
                        ...
                        <el-table-column
                          ...
                          width="200">
                          <template slot-scope="scope">
                            <el-input-number v-model="scope.row.cost1" :disabled="!disabled" :max="1000000000"
                                             :min="0" :precision="2" :step="1"
                                             controls-position="right" style="width: 11rem" @change="changeSum(scope.row)"></el-input-number>
                          </template>
                        </el-table-column>
                        <!--<el-table-column-->
                        <!--prop="amount1"-->
...
import {getMonthlyrateInfo, getUserInfo} from '@/utils/customize';
