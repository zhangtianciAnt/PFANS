              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1025VIEW_OPENINGDATE')" prop="startdate">
                    <el-date-picker :disabled="!disabled1" type="date" v-model="form.startdate"
                                    style="width: 20vw"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1025VIEW_ENDDATE')" prop="enddate">
                    <el-date-picker :disabled="!disabled1" type="date" v-model="form.enddate"
                                    style="width: 20vw"></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1027FORMVIEW_METHOD')">
                      <el-radio-group v-model="radio1" @change="radio1change">
                        ...
                        <el-radio :label="2" :disabled="!disabled">{{$t('label.PFANS1027FORMVIEW_SETTLEMENT')}}
                        </el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1027FORMVIEW_FORM')">
                      <el-radio-group v-model="radio2" @change="radio2change">
                        ...
                        <el-radio :label="3" :disabled="!disabled">{{$t('label.PFANS1027FORMVIEW_CONSERVATIVE')}}
                        </el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-table
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        <el-input type="textarea" v-model="scope.row.appoint1" style="width: 11rem"
                    ...
                    <el-table-column
                      ...
                      width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.functionsprice1" @change="changeSum1(scope.row)" :step="1"
                                         controls-position="right" style="width: 11rem" :disabled="!disabled" :min="0"
                                         :max="1000000000" :precision="2"></el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column
                      prop="functionhour1"
                      ...
                      width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.functionhour1" @change="changeSum1(scope.row)" :step="1"
                                         controls-position="right" style="width: 11rem" :disabled="!disabled" :min="0"
                                         :max="1000000000" :precision="2"></el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      width="200">
                      <template slot-scope="scope">
                        <el-input-number v-model="scope.row.functionamount1" @change="changeSum1(scope.row)"
                                         controls-position="right" style="width: 11rem" :disabled="!disabled1" :min="0"
                                         :max="1000000000" :precision="2"></el-input-number>
                      </template>
                    </el-table-column>
                    ...
                    <el-col :span="24">
                      <el-table
                        ...
                        <el-table-column
                          ...
                          width="200">
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.detailed1" style="width: 11rem"
                                      :disabled="!disabled"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column
                          ...
                          width="200">
                          <template slot-scope="scope">
                            <el-input-number v-model="scope.row.cost1" @change="changeSum(scope.row)" :step="1"
                                             controls-position="right" style="width: 11rem" :disabled="!disabled"
