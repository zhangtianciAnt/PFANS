      ...
      <div slot="customize">
        <el-form ref="refform" :model="form" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-tabs v-model="activeName" type="border-card">
              ...
              <div>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1012VIEW_CAIWUPERSONALCODE')">
                      <el-input v-model="form.personalcode" :disabled="domesticOrNot()" style="width: 20vw">
                      </el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1013VIEW_RELATION')" prop="business_id">
                      <el-select v-model="form.business_id" :disabled="true" clearable style="width:20vw"
                      ...
                      <!--                      add-ws-7/27-禅道154任务-->
                      <el-button size="small" type="primary" @click="clickBun">{{ this.$t('button.view') }}</el-button>
                      <!--                      add-ws-7/27-禅道154任务-->
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                  ...
                  <el-col v-if="form.place === '其他' || form.place === 'PJ036005'" :span="8">
                    <el-form-item :label="$t('label.PFANS1013VIEW_REGIONNAME')">
                      <el-input v-model="form.regionname" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    ...
                    <el-form-item :label="$t('label.PFANS1013VIEW_ASKDATENUMBER')">
                      <el-input v-model="form.datenumber" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1013VIEW_REALDATENUMBER')">
                      <el-input v-model="form.realdatenumber" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <!--       add_qhr_0527 添加实际出差开始日、实际出差结束日和实际出差天数-->
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS5004VIEW_PROJECTNAMW')">
                      <el-select v-model="form.project_id" :disabled="true" clearable style="width: 20vw">
                        <el-option
                ...
                <el-row>
                  ...
                  <el-col v-show="show2" :span="8">
                    <el-form-item :label="$t('label.PFANS1002VIEW_LEVEL')">
                      <el-input v-model="form.level" :disabled="true" style="width: 20vw">
                      </el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1013FORMVIEW_LOAN')">
                      <el-select v-model="form.loan" :disabled="!disable" clearable style="width:20vw"
                                 @change="change2">
                        <el-option
                          v-for="item in loans"
                          :key="item.value"
                      ...
                      <el-button :disabled="disable" size="small" type="primary" @click="clickBunloan">
                        {{ this.$t('button.view') }}
                      </el-button>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1012VIEW_REIMBURSEMENTDATE')">
                      <el-date-picker v-model="form.reimbursementdate" :disabled="domesticOrNot()" style="width:20vw"
                    ...
                    <el-collapse-item name="2">
                      ...
                      <el-table :data="tableW"
                        ...
                        <el-table-column :label="$t('label.PFANS1013FORMVIEW_CURRENCYEXCHANGERATE')" align="center"
                                         ...
                                         width="180">
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.currencyexchangerate" :disabled="true" style="width: 100%">
                            </el-input>
                          </template>
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1013FORMVIEW_FOREIGNCURRENCYAMOUNT')" align="center"
                                         width="180">
                          <template slot-scope="scope">
                            <el-input-number v-model="scope.row.amount" :disabled="!disable" :max="9999999" :min="0"
                                             :no="scope.row" :precision="2" :step="1"
                                             controls-position="right" style="width: 100%" @change="changeamount(scope.row)">
                            </el-input-number>
                          </template>
                        </el-table-column>
                        <el-table-column :label="$t('label.PFANS1013FORMVIEW_EXCHANGERATE')" align="center" width="180">
                          <template slot-scope="scope">
                            <el-input-number v-model="scope.row.exchangerate" :disabled="!disable" :max="9999999" :min="0"
                                             :no="scope.row" :step="0.0001"
                        ...
                        <el-table-column :label="$t('label.PFANS1013FORMVIEW_EXCHANGERMB')" align="center"
                                         ...
                                         width="180">
                          <template slot-scope="scope">
                            <el-input-number v-model="scope.row.exchangermb" :disabled="!disable" :max="9999999" :min="0"
                                             :no="scope.row" :precision="2"
                      ...
                      <el-col :span="8">
                        <el-form-item :label="$t('label.PFANS1013FORMVIEW_USEXCHANGERATE')">
                          <el-input v-model="form.usexchangerate" :disabled="true" style="width:20vw">
                          </el-input>
                        </el-form-item>
                      </el-col>
                    </el-collapse-item>
                ...
                <el-row>
                  <el-form-item :label="$t('label.PFANS1013FORMVIEW_FYCBSM')" prop="remark">
                    <el-input v-model="form.remark" :disabled="!disable" style="width: 70vw"
                              type="textarea">
                    </el-input>
                  </el-form-item>
                </el-row>
                    ...
                    <el-collapse-item name="1">
                      ...
                      <el-table :data="tableF"
                        ...
                        <el-table-column :label="$t('label.PFANS1012FORMVIEW_INVOICET')" align="center" width="200">
                          <template slot-scope="scope">
                            <el-input v-show="false" v-model="scope.row.invoicetype" :disabled="true"
                                      style="width: 100%">
                            </el-input>
                        ...
                        <el-table-column :label="$t('label.PFANS1012FORMVIEW_INVOICEM')" align="center" width="150">
                          <template slot-scope="scope">
                            <el-input-number v-model="scope.row.invoiceamount" :disabled="!disable" :max="9999999" :min="0"
                                             :no="scope.row" :precision="2" :step="1"
                                             controls-position="right" style="width: 100%"
                ...
                <el-col :span="24">
                  <el-table :data="tableT" :summary-method="getTsummaries" border
                    ...
                    <el-table-column :label="$t('label.PFANS1012FORMVIEW_INVOICEN')" align="center" width="150">
                      <template slot-scope="scope">
                        <el-select v-model="scope.row.invoicenumber" :disabled="!disable" clearable style="width: 100%"
                    ...
                    <el-table-column :label="$t('label.PFANS1012FORMVIEW_BUDGET')" align="center" width="200">
                      <template slot-scope="scope">
                        ...
                        <!--                        </el-input>-->
                        <el-select v-model="scope.row.budgetcoding" :disabled="checktaxes" :no="scope.row" :placeholder="$t('normal.error_09')"
                    ...
                    <el-table-column :label="$t('label.PFANS1012FORMVIEW_PL')" align="center" width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.plsummary" :disabled="true" style="width: 100%">
                        </el-input>
                      </template>
                    </el-table-column>
                    ...
                    >
                      <template slot-scope="scope">
                        ...
                        <!--                        </dicselect>-->
                        <el-input v-model="scope.row.accountcode" :disabled="true" style="width: 100%">
                        </el-input>
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column :label="$t('label.PFANS1012VIEW_STARTINGPOINT')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-tooltip :content="scope.row.startingpoint"
                                    ...
                                    placement="top">
                          <el-input v-model="scope.row.startingpoint" :disabled="checktaxes" maxlength="20"
                                    style="width: 100%"/>
                        </el-tooltip>
                      </template>
                    </el-table-column>
                    <el-table-column v-if="!domesticOrNot()" :key="Math.random()" :label="$t('label.PFANS1012VIEW_RMB')" align="center"
                                     prop="rmb" width="200">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column v-if="this.form.type === '0'? false : true" :label="$t('label.PFANS1012VIEW_CURRENCY')"
                    ...
                    <el-table-column v-if="showforeigncurrency" :label="$t('label.PFANS1012VIEW_FOREIGNCURRENCY')"
                                     align="center"
                                     prop="foreigncurrency" width="200">
                      <template slot-scope="scope">
                        <el-input-number
                    ...
                    <el-table-column :label="$t('label.PFANS1012VIEW_ANNEXNO')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.annexno" :disabled="checktaxes" maxlength="20" style="width: 100%">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.operation')" align="center" width="200">
              ...
              <el-row>
                <el-col :span="24">
                  <el-table :data="tableA" :summary-method="getAsummaries"
                    ...
                    <el-table-column :label="$t('label.date')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-date-picker v-model="scope.row.accommodationdate" :disabled="!disable" style="width: 100%"
                    ...
                    <el-table-column v-if="showAout" :label="$t('label.PFANS1002VIEW_REGION')" align="center"
                                     width="200">
                      <template slot-scope="scope">
                    ...
                    <el-table-column v-else :label="$t('label.PFANS1013FORMVIEW_CITY')" align="center" width="200">
                      <template slot-scope="scope">
                    ...
                    <el-table-column :label="$t('label.PFANS1013FORMVIEW_FACILITYNAME')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.facilityname" :disabled="checktaxes" maxlength="20">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column v-if="this.form.type === '0'? false : true" :label="$t('label.PFANS1012VIEW_CURRENCY')"
                    ...
                    <el-table-column v-if="this.form.type === '0'? false : true" :label="$t('label.PFANS1013FORMVIEW_TRAVELALLOWANCE1')"
                                     align="center"
                                     prop="travel" width="200">
                      <template slot-scope="scope">
                        <el-input-number
                          v-if="checktaxes"
                    ...
                    <el-table-column v-if="!domesticOrNot()" :key="Math.random()"
                                     :label="$t('label.PFANS1013FORMVIEW_TRAVELALLOWANCE')" align="center" prop="rmb" width="200">
                      <template slot-scope="scope">
                        <el-input-number
                          v-model="scope.row.rmb"
                          :disabled="(scope.row.accountcode === 'PJ132005' || scope.row.accountcode === 'PJ132006' || scope.row.accountcode === 'PJ119005' || scope.row.accountcode === 'PJ119006'|| scope.row.accountcode === '' || checktaxes) ? true : false" :max="1000000000"
                          :min="0"
                          :precision="2"
                          controls-position="right"
                          style="width: 100%"
                    ...
                    <el-table-column :label="$t('label.PFANS1012VIEW_ANNEXNO')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.annexno" :disabled="checktaxes" maxlength="36">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.operation')" align="center" width="200">
            ...
            <el-tab-pane v-if="this.form.type === '0'? false : true"
                         :disabled="this.form.business_id === '' ? true : false" :label="$t('label.PFANS1012VIEW_OTHER')"
                         name="fourth">
              <el-row>
                <el-col :span="24">
                  <el-table :data="tableR" :summary-method="getRsummaries" border
                    ...
                    <el-table-column :label="$t('label.date')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-date-picker v-model="scope.row.otherdetailsdate" :disabled="!disable" style="width: 100%">
                        </el-date-picker>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1012FORMVIEW_INVOICEN')" align="center" width="150">
                      <template slot-scope="scope">
                        <el-select v-model="scope.row.invoicenumber" :disabled="!disable" style="width: 100%"
                                   @change="changeinvoicenumber(scope.row)">
                          <el-option
                            v-for="item in optionsdata"
                            :key="item.value"
                    ...
                    <el-table-column :label="$t('label.PFANS1012VIEW_REGION')" align="center" width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.region" :disabled="checktaxes" maxlength="20"
                                  style="width: 100%">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1012VIEW_ABSTRACT')" align="center" width="200">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.remarks" :disabled="checktaxes" maxlength="20" style="width: 100%">
                        </el-input>
                      </template>
                    </el-table-column>
