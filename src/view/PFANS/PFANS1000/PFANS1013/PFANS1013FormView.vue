                    ...
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS1013VIEW_TELEPHONE')" prop="telephone">
                        <el-input :disabled="!disable" maxlength="20" style="width: 11rem"
                                  v-model.trim="form.telephone"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row :gutter="32">
                    ...
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS1013VIEW_RELATION')" prop="relation">
                       <!-- <dicselect
                        ...
                        <el-input :disabled="true" style="width: 11rem" v-model="form.relation"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                    ...
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS1013FORMVIEW_LOAN')" prop="loan">
                       <!-- <dicselect
                        ...
                        <el-input :disabled="true" style="width: 11rem" v-model="form.loan"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
          ...
          var checkuser = (rule, value, callback) => {
            ...
            return {
              ...
              tableData: [{
                ...
                {
                  costitem:this.$t('label.PFANS1012VIEW_OTHEREXPENSEC'),
                  rmb: "",
                }],
              tableData2:[{
                costitem:this.$t('label.PFANS1012VIEW_TRAFFICEXPENSEC'),
        ...
        methods: {
          ...
          getValue2(sums){
            ...
            if(this.form.currency==='PJ003001'){
              ...
              this.tableData2[0].jspcurrency=sums[5];
              this.tableData2[1].jspcurrency=this.tableAValue[8];
              this.tableData2[2].jspcurrency=this.tableAValue[9]+this.tableAValue[10];
              this.tableData2[3].jspcurrency=this.tableRValue[4];
            }else {
