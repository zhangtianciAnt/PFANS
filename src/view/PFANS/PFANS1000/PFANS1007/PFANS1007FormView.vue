        ...
        <el-form :model="form" :rules="rules" label-position="left" label-width="8rem" ref="refform"
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane :label="$t('label.PFANS1007FORMVIEW_FIXEDASSETINFORMATION')" name="first">
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1007FORMVIEW_FILENAME')" prop="filename">
                    <el-input :disabled="!disabled" type="textarea" style="width: 57rem" v-model="form.filename"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1007FORMVIEW_SUMMARY')" prop="summary">
                    <el-input :disabled="!disabled" type="textarea" style="width: 57rem" v-model="form.summary"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1007FORMVIEW_TOTALVALUE')" prop="totalvalue">
                    <el-input-number v-model="form.totalvalue" controls-position="right" style="width: 11rem" :disabled="!disabled" :min="0" :max="1000000000" :precision="2"></el-input-number>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1007FORMVIEW_TOTALNETWORTH')" prop="totalnetworth">
                    <el-input-number v-model="form.totalnetworth" controls-position="right" style="width: 11rem" :disabled="!disabled" :min="0" :max="1000000000" :precision="2"></el-input-number>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1007FORMVIEW_REASONSFORQUOTATION')" label-width="6rem" v-show="show">
