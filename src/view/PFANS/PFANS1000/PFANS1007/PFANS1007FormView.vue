        ...
        <el-form :model="form" :rules="rules" label-position="top" label-width="8vw" ref="refform"
          ...
          <el-tabs v-model="activeName" type="border-card">
            ...
            <el-tab-pane :label="$t('label.PFANS1007FORMVIEW_SCRAPASSETDETAILS')" name="second">
              <el-row>
                <el-table :data="table1" header-cell-class-name="sub_bg_color_blue" border="true" stripe>
            ...
            <el-tab-pane :label="$t('label.PFANS1007FORMVIEW_SALESASSETDETAILS')" name="third">
              <el-row>
                <el-table :data="table2" header-cell-class-name="sub_bg_color_blue" border="true" stripe>
