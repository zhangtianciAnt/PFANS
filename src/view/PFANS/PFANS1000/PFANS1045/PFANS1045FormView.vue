<template>
  <div style="min-height: 100%">
    <EasyNormalContainer
      ...
      :title="title"
      :workflowCode="workflowCode" @StartWorkflow="buttonClick" @buttonClick="buttonClick"
    ...
    >
      <div slot="customize">
        <el-form ref="reff" :model="form" :rules="rules" label-position="top" label-width="8vw"
                 style="padding: 2vw">
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS2023FORMVIEW_INTELLIGENCE')" name="first">
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1045VIEW_OUTSOURCINGCOMPANY')"
                    ...
                    <div class="dpSupIndex" style="width: 20vw">
                      <el-container>
                        <input v-model="form.outsourcingcompany" :disabled="true"
                               class="content bg">
              ...
              <el-row>
                <el-form-item :label="$t('label.PFANS1012VIEW_ABSTRACT')" prop="remark">
                  <el-input v-model="form.remark" :disabled="!disable" style="width: 72.5vw"
                            type="textarea">
                  </el-input>
                </el-form-item>
              </el-row>
              <el-row v-if="this.form.type === '1'?true:false">
                ...
                <el-table :data="tableF" :summary-method="getFsummaries" border
                          header-cell-class-name="sub_bg_color_blue" show-summary stripe style="width: 72.5vw">
                  ...
                  <el-table-column :label="$t('label.PFANS1017FORMVIEW_PREPAREFOR')" align="center" width="475">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.remark" :disabled="!disable2" style="width: 100%">
                      </el-input>
                    </template>
                  </el-table-column>
            ...
            <el-tab-pane v-if="this.$route.params._id" :label="$t('label.PFANS1002FORMVIEW_NUBERSGLJC')" name="second">
              <el-row>
                <el-table
                  :data="DataList"
                  :summary-method="getDsummaries" border
                  header-cell-class-name="sub_bg_color_blue"
                  show-summary stripe style="width: 1150px"
                >
                  <el-table-column
...
import {downLoadUrl, getStatus, uploadUrl} from '@/utils/customize';
