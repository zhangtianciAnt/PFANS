<template>
  <div>
    <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns7" :data="data" :psearchValue="search"
                     :rowid="row" :title="title" @buttonClick="buttonClick" @reget="getCompanyProjectList"
                     @rowClick="rowClick">
    </EasyNormalTable>
  </div>
</template>
