<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading"
      ...
      <div slot="customize">
        <el-form ref="reff" :model="form" label-position="top" label-width="8vw" style="padding: 2vw">
          <el-row>
            <el-col :span="8">
          ...
          <el-row type="hidden">
            <el-col :span="8">
              <el-form-item v-show="show " :label="$t('label.PFANS1012FORMVIEW_JCTYPE')">
                <el-select v-model="form.judgementnumber" clearable style="width: 20vw" @change="changedata">
                  <el-option
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item v-show="showdata" :label="$t('label.judgement')">
                <el-input v-model="form.judgement" :disabled="true" style="width:50vw" type="textarea"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <div v-if="show7">
            <el-table
              ...
              height="250" stripe style="width: 1205px"
            >
              <el-table-column
