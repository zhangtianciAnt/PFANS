            ...
            <el-tab-pane :label="$t('label.PFANS1012VIEW_SUMMONS')" name="first">
              <div>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1012VIEW_CURRENCYEXPENDITURE')" v-if="this.form.type === 'PJ001001'?false:true">
                      <el-input-number
                        :disabled="true"
                        :max="1000000000"
                        :min="0"
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1012VIEW_TORMB')" v-if="this.form.type === 'PJ001001'?false:true">
                      <el-input-number
                        :disabled="true"
                        :max="1000000000"
                        :min="0"
