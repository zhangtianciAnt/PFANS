...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            workflowState(val) {
                if (val.state === '1') {
                    if (val.workflowCode === 'W0055') {
                        this.status = '3';
                    } else if (val.workflowCode === 'W0054') {
                        this.status = '0';
                    }
                } else if (val.state === '2') {
                    // if (val.workflowCode === 'W0055') {
            ...
            start() {
                if (this.status === '4' || this.status === '6' || (this.workflowCode === 'W0054' && this.status === '0')) {
                    this.status = '5';
                } else {
                    this.status = '2';
                }
