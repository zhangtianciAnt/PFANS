      ...
      <div slot="customize">
        <el-form ref="refform" :model="refform" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-row style="padding-top: 2%;padding-bottom: 2%">
            ...
            <el-col :span="6">
              <el-form-item :label="$t('label.PFANS2036VIEW_DEPARTMENT')" prop="center_id">
                <el-select v-model="refform.center_id" :disabled="disabledT" style="width: 20vw"
                           @change="groupChange">
                  <el-option
          ...
          <el-row v-if="tabledatashow">
            <el-table :data="tableData" :header-cell-style="getHeaderClass" border
                      border highlight-current-row lazy max-height="400"
                      row-key="rowid"
                      stripe
                      style="width: 100%"
                      tooltip-effect="dark">
              ...
              <el-table-column :label="$t('label.PFANS1040FORMVIEW_AMOUNT')" align="center" width="280">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.amountpersonnel" :disabled="true" maxlength="100"
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.amountwpersonnel" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              ...
              <el-table-column :label="$t('label.April')" align="center" width="280">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel4" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel4" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.May')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel5" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel5" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.June')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel6" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel6" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.July')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel7" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel7" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.August')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel8" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel8" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.September')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel9" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel9" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              ...
              <el-table-column :label="$t('label.October')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel10" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel10" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.November')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel11" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel11" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.December')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel12" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel12" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.January')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel1" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel1" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.February')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel2" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel2" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.March')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.personnel3" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.wpersonnel3" :disabled="true" maxlength="100"
                              style="width: 100%"></el-input>
                  </template>
                </el-table-column>
              </el-table-column>
              ...
              <el-table-column :label="$t('label.PFANS1039FORMVIEW_YEARTOTAL')" align="center" width="150">
                <el-table-column :formatter="formatterDir" :label="$t('label.PFANS1039FORMVIEW_NPERSONNEL')" align="center"
                                 prop="npersonnel" width="120"/>
                <el-table-column :formatter="formatterDir" :label="$t('label.PFANS1039FORMVIEW_WPERSONNEL')" align="center"
                                 prop="wpersonnel" width="120"/>
              </el-table-column>
              <!--              添加年间合计 ztc tos-->
            </el-table>
          </el-row>
          <el-row>
            <el-table :data="tableDataA" :header-cell-style="getHeaderClass" border
                      border highlight-current-row lazy max-height="400"
                      row-key="rowid"
                      stripe
                      style="width: 100%"
              ...
              <el-table-column :label="$t('label.PFANS1043FORMVIEW_THEMENAME')"
                               align="center" fixed width="200">
                <template slot-scope="scope">
                  <el-col :span="24">
                    <div>
                      <el-container>
                        <el-input v-model="scope.row.themename"
                        ...
                        <el-dialog :title="$t('title.PFANS1043VIEW')" :visible.sync="dialogTableVisible" append-to-body
                                   center
                                   lock-scroll size="50%"
                                   top="8vh">
                            ...
                            <el-row style="text-align: center;height: 90%;overflow: hidden">
                              <el-table
                                ...
                                <el-table-column :label="$t('label.PFANS1039FORMVIEW_TEAM')"
                                                 property="dividevalue1"
                                                 show-overflow-tooltip width="120"></el-table-column>
                                <el-table-column :label="$t('label.PFANS1043FORMVIEW_CONTRACT')"
                                                 property="contractvalue1"
                                                 show-overflow-tooltip width="120"></el-table-column>
                                <el-table-column :label="$t('label.PFANS8011VIEW_CURRENCY')"
                                                 property="currencyvalue1"
                                                 show-overflow-tooltip width="120"></el-table-column>
                                <el-table-column :label="$t('label.PFANS5001FORMVIEW_ENTRUST')"
                                                 property="toolsorgsvalue1"
                                                 show-overflow-tooltip width="120"></el-table-column>
                                <el-table-column
              ...
              <el-table-column :label="$t('label.remarks')" align="center" width="230">
                <template slot-scope="scope">
                  <el-input v-model="scope.row.remarks" :disabled="true" maxlength="100"
              ...
              <el-table-column :label="$t('label.April')" align="center" width="280">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel4" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum(scope.row)">
                    </el-input-number>
                  </template>
                </el-table-column>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount4" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum(scope.row)">
                    </thousandnum>
              ...
              <el-table-column :label="$t('label.May')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel5" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum(scope.row)">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount5" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum(scope.row)">
              ...
              <el-table-column :label="$t('label.June')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel6" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum(scope.row)">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount6" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum(scope.row)">
              ...
              <el-table-column :label="$t('label.PFANS2005FORMVIEW_JDHJ')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sumpersonnel1" :disabled="true"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2" controls-position="right" size="small" style="width: 100%">
                    </el-input-number>
                  </template>
                </el-table-column>
                <!--                  region add_qhr_20210531  将社内和外注合并成一个输入框并改命名为【人数】-->
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.sumamount1" :disabled="true"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2" controls-position="right" size="small" style="width: 100%">
                    </thousandnum>
              ...
              <el-table-column :label="$t('label.July')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel7" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum1(scope.row)">
                    </el-input-number>
                  </template>
                </el-table-column>
                <!--                  region add_qhr_20210531  将社内和外注合并成一个输入框并改命名为【人数】-->
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount7" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum1(scope.row)">
                    </thousandnum>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.August')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel8" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum1(scope.row)">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount8" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum1(scope.row)">
              ...
              <el-table-column :label="$t('label.September')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel9" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum1(scope.row)">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount9" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum1(scope.row)">
              ...
              <el-table-column :label="$t('label.PFANS2005FORMVIEW_JDHJ')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sumpersonnel2" :disabled="true"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2" controls-position="right" size="small" style="width: 100%">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.sumamount2" :disabled="true"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2" controls-position="right" size="small" style="width: 100%">
                    </thousandnum>
              ...
              <el-table-column :label="$t('label.October')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel10" :disabled="disabled"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum2(scope.row)">
                    </el-input-number>
                  </template>
                </el-table-column>
                <!--                  region add_qhr_20210531  将社内和外注合并成一个输入框并改命名为【人数】-->
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount10" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum2(scope.row)">
                    </thousandnum>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.November')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel11" :disabled="disabled"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum2(scope.row)">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount11" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum2(scope.row)">
              ...
              <el-table-column :label="$t('label.December')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel12" :disabled="disabled"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum2(scope.row)">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount12" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum2(scope.row)">
              ...
              <el-table-column :label="$t('label.PFANS2005FORMVIEW_JDHJ')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sumpersonnel3" :disabled="true"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2" controls-position="right" size="small" style="width: 100%">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.sumamount3" :disabled="true"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2" controls-position="right" size="small" style="width: 100%">
                    </thousandnum>
              ...
              <el-table-column :label="$t('label.January')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel1" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum3(scope.row)">
                    </el-input-number>
                  </template>
                </el-table-column>
                <!--                  region add_qhr_20210531  将社内和外注合并成一个输入框并改命名为【人数】-->
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount1" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum3(scope.row)">
                    </thousandnum>
                  </template>
                </el-table-column>
              </el-table-column>
              <el-table-column :label="$t('label.February')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel2" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum3(scope.row)">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount2" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum3(scope.row)">
              ...
              <el-table-column :label="$t('label.March')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.personnel3" :disabled="disabled" :max="10000000000"
                                     :min="0"
                                     :precision="2"
                                     controls-position="right" size="small" style="width: 100%" @change="nsum3(scope.row)">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="190">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount3" :disabled="disabled"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2"
                                 controls-position="right" size="small" style="width: 100%" @change="amountsum3(scope.row)">
              ...
              <el-table-column :label="$t('label.PFANS2005FORMVIEW_JDHJ')" align="center" width="150">
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center" width="120">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sumpersonnel4" :disabled="true"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2" controls-position="right" size="small" style="width: 100%">
                    </el-input-number>
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.sumamount4" :disabled="true"
                                 :max="10000000000"
                                 :min="0"
                                 :precision="2" controls-position="right" size="small" style="width: 100%">
                    </thousandnum>
              ...
              <!--              添加年间合计 ztc fr-->
              <el-table-column :label="$t('label.PFANS1039FORMVIEW_YEARTOTAL')" align="center" width="150">
                <el-table-column :formatter="formatterDir" :label="$t('label.PFANS1039FORMVIEW_PERSONNUMBER')" align="center"
                                 prop="personnumber" width="120"/>
                <el-table-column :formatter="formatterDir" :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center"
                                 prop="amount" width="120"/>
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <thousandnum v-model="scope.row.amount" :disabled="true"
                                 :max="10000000000"
                                 :min="0"
