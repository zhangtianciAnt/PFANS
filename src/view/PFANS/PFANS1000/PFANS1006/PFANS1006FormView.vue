      ...
      <div slot="customize">
        <el-form ref="refform" :model="form" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_INFORMATION')" name="first">
              <div>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item v-show=flag :label="$t('label.PFANS1012VIEW_MODULE')">
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :error="errorreimbursement" :label="$t('label.PFANS1006FORMVIEW_REIMBURSEMENT')"
                                  prop="reimbursement">
                      <el-date-picker v-model="form.reimbursement" :disabled="!disable" :error="errorreimbursement"
                                      style="width:20vw">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1006FORMVIEW_CURRENCYCHOICE')" prop="currencychoice">
                      ...
                      <!--                                 style="width:20vw">-->
                      <!--                      </dicselect>-->
                      <monthlyrate :data="form.currencychoice"
                                   :disabled="!disable"
                                   :month="month3"
                                   :multiple="multiple"
                                   style="width:20vw"
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1006FORMVIEW_DISTINGUISH')">
                      ...
                      <!--                      </el-radio-group>-->
                      <el-radio-group v-model="form.publicradio" :disabled="!disable" @change="radioChange">
                        <el-radio label="1">{{ $t('label.PFANS1006FORMVIEW_PUBLIC') }}</el-radio>
                        <el-radio label="2">{{ $t('label.PFANS1006FORMVIEW_DEDICATED') }}</el-radio>
                      </el-radio-group>
                ...
                <el-row>
                  ...
                  <el-col v-if="this.role2==='0'" :span="8">
                    <el-form-item :label="$t('label.status')">
                      <el-select v-model="form.processingstatus" :disabled="acceptShow" :placeholder="$t('normal.error_09')"
                                 clearable
                                 style="width: 20vw" @change="prostatusChange">
                        <el-option
                  ...
                  <!--add-fjl-0928-作废原因-->
                  <el-col :span="8">
                    <el-form-item v-show="showvoid" :label="$t('label.PFANS1006FORMVIEW_REASONVOID')" prop="reasonvoid">
                      <el-input v-model="form.reasonvoid" :disabled="acceptShow"
                                style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <!--add-fjl-0928-作废原因-->
                ...
                <el-row>
                  <el-form-item :label="$t('label.PFANS1006FORMVIEW_ABSTRACT')" prop="remark">
                    <el-input v-model="form.remark" :disabled="!disable" maxlength="20" style="width:72vw"
                              type="textarea">
                    </el-input>
                  </el-form-item>
                </el-row>
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.remarks')">
                      <el-input v-model="form.remarks" :disabled="!disable" :rows="4" style="width:72vw"
                                type="textarea">
                      </el-input>
                    </el-form-item>
                  </el-col>
                ...
                <el-collapse v-model="active">
                  <el-collapse-item name="1">
                    ...
                    <el-row>
                      <el-col :span="8">
                        <el-form-item v-show="show8" :error="errorsuppliername"
                                      :label="$t('label.PFANS6001VIEW_SUPPLIERNAME')" prop="suppliername">
                          <div class="dpSupIndex" prop="suppliername" style="width: 20vw">
                            <el-container>
                              <input v-model="form.accountpayeename" :disabled="true" :error="errorsuppliername"
                                     class="content bg">
                      ...
                      <el-col :span="8">
                        <el-form-item v-if="show9" :label="$t('label.PFANS1012VIEW_PAYEENAME')" prop="payeename">
                          <el-input v-model="form.payeename" :disabled="true" style="width:20vw"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item v-if="show7" :label="$t('label.PFANS1012VIEW_FOREIGNPAYEECODE')" prop="payeecode">
                          <el-input v-model="form.payeecode" :disabled="true"
                                    style="width:20vw"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      <el-col :span="8">
                        <el-form-item v-if="show1" :label="$t('label.PFANS1012VIEW_PAYEEBANKNUMBER')"
                                      prop="payeebankaccountnumber">
                          <el-input v-model="form.payeebankaccountnumber" :disabled="true" style="width:20vw"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="8">
                        <el-form-item v-if="show1" :label="$t('label.PFANS1012VIEW_PAYEEBANKACCOUNT')"
                                      prop="payeebankaccount">
                          <el-input v-model="form.payeebankaccount" :disabled="true" style="width:20vw"
                          ></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      ...
                      <el-col :span="8">
                        <el-form-item v-if="show2" :error="errorname" :label="$t('label.PFANS1006FORMVIEW_USERNAME')">
                      ...
                      <!--                //add-ws-5/18-No70-增加收款人-->
                      <el-col :span="8">
                        <el-form-item v-if="show2" :label="$t('label.PFANS1012VIEW_CAIWUPERSONALCODE')" prop="name">
                          <el-input v-model="form.name" :disabled="true" maxlength="20" style="width:20vw"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row style="padding-top:1vw">
                      <el-col :span="8">
                        <el-form-item :label="$t('label.PFANS1006FORMVIEW_REASONFORDELAY')" prop="reasonfordelay">
                          <el-input v-model="form.reasonfordelay" :disabled="!disable" :rows="4" style="width:72vw"
                                    type="textarea">
                          </el-input>
                        </el-form-item>
                      </el-col>
            ...
            <el-tab-pane v-if="showtab" :label="$t('label.PFANS1002FORMVIEW_NUBERSGLJC')" name="second">
              <el-row>
                <el-table
                  :data="DataList"
                  border
                  header-cell-class-name="sub_bg_color_blue" stripe style="width: 978px"
                >
                  <el-table-column
