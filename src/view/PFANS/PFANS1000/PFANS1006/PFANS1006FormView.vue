      ...
      <div slot="customize">
        <el-form :model="form" :rules="rules" label-position="left" label-width="8rem" ref="refform"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item  :error="errorreimbursement"   :label="$t('label.PFANS1006FORMVIEW_REIMBURSEMENT')" prop="reimbursement">
                <el-date-picker :disabled="!disable" :error="errorreimbursement"    style="width: 11rem"  v-model="form.reimbursement">
                </el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1006FORMVIEW_CURRENCYCHOICE')" >
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1012VIEW_FOREIGNPAYEECODE')" v-show="show1" prop="payeecode">
                <el-input :disabled="!disable" style="width: 11rem" type="email" maxlength="20"
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1012VIEW_PAYEEBANKNUMBER')" v-show="show1" prop="payeebankaccountnumber">
                <el-input :disabled="!disable" style="width: 11rem" v-model="form.payeebankaccountnumber" maxlength="20"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1012VIEW_PAYEEBANKACCOUNT')" v-show="show1" prop="payeebankaccount">
                <el-input :disabled="!disable" style="width: 11rem" v-model="form.payeebankaccount" maxlength="20"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1012VIEW_PAYEENAME')" v-show="show3" prop="accountpayeename">
                <el-input :disabled="!disable" style="width: 11rem" v-model="form.accountpayeename" maxlength="20"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row style="padding-top:1rem">
            <el-col :span="8">
              <el-form-item  :label="$t('label.PFANS1006FORMVIEW_REASONFORDELAY')" prop="reasonfordelay">
                <el-input :disabled="!disable" :rows="4" type="textarea" style="width:57.1rem" v-model="form.reasonfordelay">
                </el-input>
              </el-form-item>
            </el-col>
          </el-row>
