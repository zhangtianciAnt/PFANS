      ...
      <div slot="customize">
        <el-form :model="form" :rules="rules" label-position="top" label-width="8vw" ref="refform"
          ...
          <el-row style="padding-top:1.5rem">
            <el-table :data="tableT" border header-cell-class-name="sub_bg_color_blue" style="width: 72vw" stripe="true">
          ...
          <el-row style="width: 800px" align="right">
            <el-table :data="tableP" border header-cell-class-name="sub_bg_color_blue"  style="width: 1041px" stripe="true">
