                ...
                <el-col :span="24">
                  <el-table :data="tableT" border header-cell-class-name="sub_bg_color_blue" stripe style="width: 72vw">
                    ...
                    <el-table-column :label="$t('label.PFANS1010FORMVIEW_JOINREASON')" align="center">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.reason" :disabled="!disable" :no="scope.row">
                        </el-input>
                      </template>
                    </el-table-column>
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS1010FORMVIEW_COMPANYNAME')" prop="company">
                        <el-input v-model="form.company" :disabled="!disable" maxlength='50'
                                  style="width:20vw"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
                  <el-row align="right" style="width: 800px">
                    <el-col :span="24">
                      <el-table :data="tableP" border header-cell-class-name="sub_bg_color_blue" stripe
                                style="width: 46vw">
                        <el-table-column :label="$t('label.PFANS1010FORMVIEW_PARTICIPANTS')" align="center">
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.participants" :disabled="!disable" :no="scope.row">
                            </el-input>
                          </template>
                        </el-table-column>
                        <el-table-column :label="$t('label.operation')" align="center" width="200">
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS1010FORMVIEW_PURPOSEOFUSE')">
                        <el-input v-model="form.objective" :disabled="!disable" style="width:72vw"
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS1010FORMVIEW_RECEPTIONPLACE')">
                        <el-input v-model="form.place" :disabled="!disable" style="width:72vw"
                                  type="textarea"></el-input>
                      </el-form-item>
                    </el-col>
                  </el-row>
...
import {accAdd, getOrgInfo, getOrgInfoByUserId, getStatus} from '@/utils/customize';
