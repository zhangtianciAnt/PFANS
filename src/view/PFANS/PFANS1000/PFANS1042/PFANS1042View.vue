                            ...
                            this.$store
                                ...
                                .then(response => {
                                    ...
                                    for (let j = 0; j < response.length; j++) {
                                        // add_fjl  --start
                                        //-format画面的值为 0.00
                                        response[j].outst1 = this.numFormat(response[j].outst1);
                                        response[j].outst2 = this.numFormat(response[j].outst2);
                                        response[j].outst3 = this.numFormat(response[j].outst3);
                                        response[j].inst = this.numFormat(response[j].inst);
                                        response[j].intotal = this.numFormat(response[j].intotal);
                                        response[j].centerintotal = this.numFormat(response[j].centerintotal);
                                        response[j].emhours = this.numFormat(response[j].emhours);
                                        response[j].outhours = this.numFormat(response[j].outhours);
                                        response[j].peocost = this.numFormat(response[j].peocost);
                                        response[j].outcost = this.numFormat(response[j].outcost);
                                        response[j].inwetuo = this.numFormat(response[j].inwetuo);
                                        response[j].researchcost = this.numFormat(response[j].researchcost);
                                        response[j].departmentcom = this.numFormat(response[j].departmentcom);
                                        ...
                                        response[j].departmenttotal = this.numFormat(response[j].departmenttotal);
                                        response[j].allocation = this.numFormat(response[j].allocation);
                                        response[j].costtotal = this.numFormat(response[j].costtotal);
                                        response[j].process = this.numFormat(response[j].process);
                                        response[j].marginal = this.numFormat(response[j].marginal);
                                        response[j].Operating = this.numFormat(response[j].Operating);
                                        response[j].twocost = this.numFormat(response[j].twocost);
                                        response[j].peocostsum = this.numFormat(response[j].peocostsum);
                                        response[j].depreciationsoft = this.numFormat(response[j].depreciationsoft);
                                        response[j].depreciationequipment = this.numFormat(response[j].depreciationequipment);
                                        response[j].leasecost = this.numFormat(response[j].leasecost);
                                        response[j].temporaryrent = this.numFormat(response[j].temporaryrent);
                                        response[j].costsubtotal = this.numFormat(response[j].costsubtotal);
                                        response[j].surveyfee = this.numFormat(response[j].surveyfee);
                                        response[j].othersoftwarefree = this.numFormat(response[j].othersoftwarefree);
                                        response[j].expensessubtotal = this.numFormat(response[j].expensessubtotal);
                                        response[j].transferone = this.numFormat(response[j].transferone);
                                        response[j].transfertwo = this.numFormat(response[j].transfertwo);
                                        response[j].allocationsum = this.numFormat(response[j].allocationsum);
                                        ...
                                        response[j].otherincome = this.numFormat(response[j].otherincome);
                                        response[j].otherexpentotal = this.numFormat(response[j].otherexpentotal);
                                        response[j].interestrate = this.numFormat(response[j].interestrate);
                                        response[j].exchanges = this.numFormat(response[j].exchanges);
                                        response[j].operatingprofit = this.numFormat(response[j].operatingprofit);
                                        response[j].pretaxprofit = this.numFormat(response[j].pretaxprofit);
                                        response[j].taxallowance = this.numFormat(response[j].taxallowance);
                                        response[j].posttaxbenefit = this.numFormat(response[j].posttaxbenefit);
                                        response[j].operatingmargin = this.numFormat(response[j].operatingmargin);
                                        response[j].outsourcinghours = this.numFormat(response[j].outsourcinghours);
                                        response[j].outsourcing = this.numFormat(response[j].outsourcing);
                                        response[j].outsourcingname = this.numFormat(response[j].outsourcingname);
                                        response[j].employeename = this.numFormat(response[j].employeename);
                                        response[j].outsourcingpjhours = this.numFormat(response[j].outsourcingpjhours);
                                        response[j].employeepjhours = this.numFormat(response[j].employeepjhours);
                                        response[j].employeeuptime = this.numFormat(response[j].employeeuptime);
                                        response[j].externalpjrate = this.numFormat(response[j].externalpjrate);
                                        response[j].externalinjectionrate = this.numFormat(response[j].externalinjectionrate);
                                        response[j].memberpjrate = this.numFormat(response[j].memberpjrate);
