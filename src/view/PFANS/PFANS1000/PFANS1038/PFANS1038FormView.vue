      ...
      <el-form ref="form" :model="form" :rules="rules" label-position="top" label-width="8vw">
        ...
        <el-tabs v-model="activeName" type="border-card">
          ...
          >
            ...
            <el-table
              :data="tableData"
              :style="{width:(this.$route.params.type === 0?'80VW':'75VW'),marginLeft:'0%',marginTop: '1%'}" border
              ...
              <!--操作-->
              <!--              人员计划添加删除按钮 ztc fr-->
              <el-table-column :label="$t('label.operation')" align="left" width="80">
                <template slot-scope="scope">
                  <el-button
                    :disabled="disabled"
                    plain
          ...
          <el-tab-pane :label="$t('label.PFANS1038VIEW_NEWHIRES')" name="second">
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-col :span="8">
                    <div class="dpSupIndex" prop="supchinese" style="width:16vw">
                      <el-container>
                        <input v-model="scope.row.supchinese" :disabled="disabled"
                        ...
                        <el-dialog :visible.sync="dialogVisibleE" append-to-body
                                   center
                                   lock-scroll size="50%"
                                   top="8vh">
...
import {getCurrentRoleNew, getDepartmentById, getOrgInfoByUserId, getUserInfo} from '@/utils/customize';
