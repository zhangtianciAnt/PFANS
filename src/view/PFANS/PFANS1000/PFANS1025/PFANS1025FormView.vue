<template>
  <div style="min-height: 100%">
        ...
        <el-form ref="reff" :model="form" :rules="rules" label-position="top" label-width="8vm" style="padding: 2vw">
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS1025VIEW_FIRSTDETAILS')" name="first">
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1024VIEW_DELIVERYDATE')">
                      <el-date-picker v-model="form.deliverydate" :disabled="true" style="width:20vw">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                </el-row>
              ...
              <el-row>
                <el-col :span="24">
                  <el-table :data="tableS" border header-cell-class-name="sub_bg_color_blue" stripe style="width: 80vw"
                    ...
                    <el-table-column :label="$t('label.PFANS1024VIEW_NUMBER')" align="center" width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.claimtype" :disabled="true" maxlength="20" style="width: 100%">
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1024VIEW_DELIVERYDATE')" align="center" width="170">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.deliverydate" :disabled="true" maxlength="20"
                                  style="width: 100%"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1024VIEW_COMPLETIONDATE')" align="center" prop="member"
                                     width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.completiondate" :disabled="true" maxlength="20"
                                  style="width: 100%"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1024VIEW_CLAIMDATE')" align="center" width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.claimdate" :disabled="true" maxlength="20"
                                  style="width: 100%"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1024VIEW_SUPPORTDATE')" align="center" prop="outsource"
                                     width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.supportdate" :disabled="true" maxlength="20"
                                  style="width: 100%"></el-input>
                      </template>
                    </el-table-column>
                    ...
                    <el-table-column :label="$t('label.PFANS1017FORMVIEW_PREPAREFOR')" align="center" width="300">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.remarksqh" :disabled="true" style="width:13vw">
                        </el-input>
                      </template>
                    </el-table-column>
            ...
            <el-tab-pane :label="$t('label.PFANS1025VIEW_SECONDDETAILS')" name="second">
              <div>
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :error="error" :label="$t('label.PFANS1008FORMVIEW_INITIATOR')" prop="user_id">
                      <user v-model="form.user_id" :error="error" :selectType="selectType"
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_TELEPHONE')" prop="telephone">
                      <el-input v-model="form.telephone" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_EQUIPMENT')">
                      <el-input v-model="form.equipment" :disabled="!disable" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_COMMDEPARTMENT')">
                      <el-input v-model="form.commdepartment" :disabled="!disable" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_COMMISSION')">
                      <el-input v-model="form.commission" :disabled="!disable" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <!--add-ws-7/17-禅道116任务-->
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1025VIEW_POLICYCONTRACT')">
                      <el-select v-model="form.policycontract_id" :disabled="!disable" clearable style="width: 20vw"
                      ...
                      <!--                      add-ws-7/27-禅道154任务-->
                      <el-button :disabled="this.form.policycontract_id?false:true" size="small" type="primary"
                                 @click="clickBun">{{ this.$t('button.view') }}
                      </el-button>
                      <!--                      add-ws-7/27-禅道154任务-->
                    </el-form-item>
                  </el-col>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item v-show="showPlan" :label="$t('label.PFANS1004VIEW_CLASSIFICATIONTYPE')"
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1017FORMVIEW_PREPAREFOR')">
                      <el-input v-model="form.remarks" :disabled="!disable" style="width:70vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
              </div>
              <el-table :data="tableT" :summary-method="getTsummaries"
                ...
                <el-table-column :label="$t('label.PFANS5008VIEW_PROGRAM')" align="center" width="200">
                  ...
                  <template slot-scope="scope">
                    <!--   add_qhr_20210721 修改权限 可以随意更改-->
                    <project :date="scope.row.projects"
                             :disabled="false" :no="scope.row" style="width: 100%"
                             @change="changePro">
                    </project>
                  </template>
                </el-table-column>
                <!--  region   add_qhr_20210721 隐藏表格项目列-->
                <el-table-column v-if="false" :label="$t('label.PFANS5008VIEW_PROGRAM')" align="center" width="600">
                  <!--  endregion   add_qhr_20210721 隐藏表格项目列-->
                  <el-table-column v-if="checkdisable" :label="$t('label.PFANS1025VIEW_MEMBER')" align="center" prop="member"
                                   width="150">
                    <template slot-scope="scope">
                      <el-input-number
                  ...
                  <el-table-column v-if="checkdisable" :label="$t('label.PFANS1025VIEW_COMMUNITY')" align="center"
                                   width="150">
                    <template slot-scope="scope">
                      <el-input-number
                ...
                <el-table-column :label="$t('label.PFANS1004VIEW_BUSINESSPLANBALANCE')" align="center"
                                 prop="businessplanbalance"
                                 width="200">
                  <template slot-scope="scope">
                    <el-input-number
    ...
    <PFANS1045Pop ref="PFANS1045Pop" :params="urlparams" :url="url"></PFANS1045Pop>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getBussMoney() {
      if (this.form.classificationtype != null) {
