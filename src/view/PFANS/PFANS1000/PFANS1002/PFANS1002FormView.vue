          ...
          <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
              ...
              <div>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS5009VIEW_PROJECTNAME')" prop="companyprojectsname">
                      <el-select v-model="form.companyprojectsname" :disabled="!disable" clearable style="width: 20vw">
                        <el-option
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1002VIEW_CONDOMINIUMCOMPANY1')" prop="condominiumcompany">
                      <el-input v-model="form.condominiumcompany" :disabled="!disable" maxlength="20"
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1002VIEW_CITY1')" prop="city">
                      <el-input v-model="form.city" :disabled="!disable" maxlength="20"
                                style="width: 20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                ...
                <el-row v-if="this.form.checkch === '1'">
                  <el-form-item :label="$t('label.PFANS1002VIEW_QXCCLY')" prop="remark">
                    <el-input v-model="form.remark" :disabled="false" style="width: 70vw"
                              type="textarea">
                    </el-input>
                  </el-form-item>
                </el-row>
            ...
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_PURPOSE')" name="second">
              <div>
                <el-row type="flex">
                  ...
                  <el-col :span="8">
                    <el-form-item v-if="show" :label="$t('label.PFANS1002VIEW_OBJECTIVETYPEOTHER')"
                                  prop="objectivetypeother">
                      <el-input v-model="form.objectivetypeother" :disabled="!disable" maxlength="20"
                                style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item prop="details">
                      <el-input v-model="form.details" :disabled="!disable" :rows="3" style="width: 70vw"
                ...
                <el-col :span="24">
                  <el-table :data="tablePD" border header-cell-class-name="sub_bg_color_blue" stripe
                    ...
                    <el-table-column :label="$t('label.PFANS1002VIEW_PLACE2')" align="center">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.place" :disabled="!disable" maxlength="20"
                                  style="width: 100%;"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.PFANS1002VIEW_CONTENT2')" align="center">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.content" :disabled="!disable" maxlength="20"
                                  style="width: 100%;"></el-input>
                      </template>
                    </el-table-column>
                  </el-table>
            ...
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_RELATION')" name="fourth">
              <div>
                ...
                <el-row>
                  ...
                  <!--                  </el-col>-->
                  <el-col :span="8">
                    <el-form-item v-if="showPlan" :label="$t('label.PFANS1002VIEW_CLASSIFICATIONTYPE')"
                  ...
                  <el-col :span="8">
                    <el-form-item v-if="showPlan" :label="$t('label.PFANS3003FORMVIEW_BALANCE')">
                      <el-input-number
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1002VIEW_CURRENCY')" prop="currency">
                      ...
                      <!--                                 style="width: 20vw">-->
                      <!--                      </dicselect>-->
                      <monthlyrate :data="form.currency"
                                   :disabled="!disable"
                                   :month="month7"
                                   :multiple="multiple"
                                   style="width: 20vw"
                  ...
                  <el-col :span="8">
                    <el-form-item v-if="show4" :label="$t('label.PFANS1012VIEW_CURRENCYRATE')">
                      <el-input v-model="form.otherfxrate" :disabled="true" style="width: 20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  ...
                  <el-col :span="8">
                    <template>
                      <el-form-item :label="$t('label.PFANS1012VIEW_TEMPORARYLOAN')" prop="loanapno">
                        <el-input v-model="form.loanapno" :disabled="true" maxlength="20"
                                  style="width: 20vw"></el-input>
                        <el-button :disabled="clickBunable" size="small" type="primary" @click="clickBun">
                          {{ $t('button.view') }}
                        </el-button>
                      </el-form-item>
                    </template>
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1002VIEW_PASSPORTNO')" prop="passportno">
                      <el-input v-model="form.passportno" :disabled="!disable" maxlength="20"
                                style="width: 20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
            ...
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_MANAGEMENT')" name="fifth">
              <div>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item v-if="show7" :label="$t('label.PFANS1002VIEW_TECHNOLOGY')" prop="technology">
                      <el-input v-model="form.technology" :disabled="!disable" style="width: 70vw"
                                type="textarea"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item v-if="show8" :label="$t('label.PFANS1002VIEW_JUDGMENTNO')" prop="judgmentno">
                      <el-input v-model="form.judgmentno" :disabled="!disable" maxlength="20"
                                style="width: 20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item v-if="show9" :label="$t('label.PFANS1002VIEW_FIXEDASSETSNO1')"
                                  prop="fixedassetsno">
                      <el-input v-model="form.fixedassetsno" :disabled="!disable" maxlength="20"
                                style="width: 20vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
            ...
            <el-tab-pane :label="$t('label.PFANS1002FORMVIEW_OTHERS1')" name="sixth">
              <div>
                <el-row>
                  ...
                  <el-col :span="16">
                    <el-form-item v-if="show10" :label="$t('label.PFANS1002VIEW_REGULATIONS')" prop="regulations">
                      <el-input-number
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item v-if="show10" :label="$t('label.PFANS1002VIEW_REASON1')" prop="reason">
                      <el-input v-model="form.reason" :disabled="!disable" style="width: 70vw"
                                type="textarea"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item :label="$t('label.PFANS1002VIEW_OTHEREXPLANATION1')" prop="otherexplanation">
                      <el-input v-model="form.otherexplanation" :disabled="!disable" :rows="3" style="width: 70vw"
                                type="textarea"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
...
import {accAdd, getCurrentRole, getOrgInfo, getOrgInfoByUserId, getStatus, getUserInfoName} from '@/utils/customize';
