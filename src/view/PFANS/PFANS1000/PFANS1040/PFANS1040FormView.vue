          ...
          <el-row>
            <el-table :data="tableDataA" :header-cell-style="getHeaderClass" border
              ...
              <el-table-column :label="$t('label.PFANS2005FORMVIEW_JDHJ')" align="center" width="150">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sumamount2" :disabled="true"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2" controls-position="right" size="small"
                                     style="width: 100%">
              ...
              <el-table-column :label="$t('label.PFANS2005FORMVIEW_JDHJ')" align="center" width="150">
                ...
                <el-table-column :label="$t('label.PFANS1039FORMVIEW_AMOUNT')" align="center" width="180">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.sumamount3" :disabled="true"
                                     :max="10000000000"
                                     :min="0"
                                     :precision="2" controls-position="right" size="small"
                                     style="width: 100%">
