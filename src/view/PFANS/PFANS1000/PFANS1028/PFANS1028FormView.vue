                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1028VIEW_CAREER')">
                      <el-input v-model="form.career" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                  ...
                  <el-col :span="8">
                    ...
                    <el-form-item :label="$t('label.PFANS1028VIEW_NO')">
                      <el-input v-model="form.gfjudgeno" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <!--取契约番号-->
                  ...
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1028VIEW_JUDGENO')">
                      <el-input v-model="form.jxjudgeno" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <!--带出PJ名-->
                    <el-form-item :label="$t('label.PFANS1028VIEW_NAME')">
                      <el-input v-model="form.janame" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1032FORMVIEW_DEPOSITARY')">
                      <el-input v-model="form.custoenglish" :disabled="true" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <!--写达到TO-->
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item
                      ...
                      <el-row>
                        <el-col :span="4">
                          <el-checkbox v-model="checked1" :disabled="disabled1"
                                       @change="getChecked1">
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item :label="$t('label.PFANS1028VIEW_TECHNICAL')">
                      <el-input v-model="form.technical" :disabled="!disable" style="width: 70vw"
                  ...
                  <el-col :span="24">
                    <el-form-item
                      ...
                      <el-row>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other1" :disabled="!disable"><p>
                              {{ $t('label.PFANS1028VIEW_BOOKS') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other2" :disabled="!disable"><p>
                              {{ $t('label.PFANS1028VIEW_SOFTWARE') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other3" :disabled="!disable"><p>
                              {{ $t('label.PFANS1028VIEW_MAIL') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other4" :disabled="!disable"><p>
                      ...
                      <el-row>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other5" :disabled="!disable" @change="getChecked8"><p>
                              {{ $t('label.PFANS1028VIEW_MEETING') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show1" :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other6" :disabled="!disable" @change="getChecked9"><p>
                              {{ $t('label.PFANS1028VIEW_COUNTRY2') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show1" :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other7" :disabled="!disable" @change="getChecked10"><p>
                              {{ $t('label.PFANS1028VIEW_OTHERC2') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show3" :span="6">
                          <el-input v-model="form.oreason" :disabled="!disable" maxlength='100'
                      ...
                      <el-row>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other8" :disabled="!disable" @change="getChecked11"><p>
                              {{ $t('label.PFANS1028VIEW_OVERSEA') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show2" :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other9" :disabled="!disable" @change="getChecked12"><p>
                              {{ $t('label.PFANS1028VIEW_COUNTRY3') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show2" :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other10" :disabled="!disable" @change="getChecked13"><p>
                              {{ $t('label.PFANS1028VIEW_OTHERC2') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show4" :span="6">
                          <el-input v-model="form.othreason" :disabled="!disable" maxlength='100'
                                    style="width: 10vw"></el-input>
                        </el-col>
                      </el-row>
                      <el-row>
                        <el-col :span="6">
                          <el-form-item>
                            <el-checkbox v-model="form.other11" :disabled="!disable" @change="getChecked14"><p>
                              {{ $t('label.PFANS1028VIEW_OTHER') }}</p></el-checkbox>
                          </el-form-item>
                        </el-col>
                        <el-col v-show="show5" :span="6">
                          <el-input v-model="form.otherreason" :disabled="!disable" maxlength='100'
                ...
                <el-collapse>
                  <el-collapse-item>
                    ...
                    <el-row>
                      ...
                      <el-col :span="24">
                        <el-form-item :label="$t('label.PFANS1028VIEW_JUDGENO')" style="margin-left: 50px">
                          <el-input v-model="form.jxjudgeno" :disabled="true"
                                    style="width: 20vw ; margin-left: 1px"></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item>
                    ...
                    <el-row>
                      <el-col :span="12">
                        <el-form-item :label="$t('label.PFANS1028VIEW_REASON')" style="margin-left: 50px">
                          <el-input v-model="form.reason" :disabled="!disable"
                                    style="width:20vw ; margin-left: 1px"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      ...
                      <el-col v-show="show8" :span="12">
                        <el-form-item :label="$t('label.PFANS1028VIEW_RESON')">
                          <el-input v-model="form.weaponreson" :disabled="!disable" style="width:20vw"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      ...
                      <el-col v-show="show8" :span="12">
                        <el-form-item :label="$t('label.PFANS1028VIEW_RESON')">
                          <el-input v-model="form.wordreson" :disabled="!disable" style="width:20vw"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                      ...
                      <el-col v-show="show8" :span="12">
                        <el-form-item :label="$t('label.PFANS1028VIEW_RESON')">
                          <el-input v-model="form.specifireson" :disabled="!disable" style="width:20vw"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                      ...
                      <el-col :span="24">
                        <el-form-item :label="$t('label.PFANS1028VIEW_JUDGENO')" style="margin-left: 50px">
                          <el-input v-model="form.lyjudgeno" :disabled="true"
                                    style="width: 20vw ; margin-left: 1px"></el-input>
                        </el-form-item>
                      </el-col>
                    ...
                    <el-row>
                      <el-col :span="12">
                        <el-form-item :label="$t('label.PFANS1028VIEW_REASON')" style="margin-left: 50px">
                          <el-input v-model="form.mareason" :disabled="!disable"
                                    style="width:20vw ; margin-left: 1px"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                ...
                <el-collapse>
                  <el-collapse-item>
                    ...
                    <el-row>
                      ...
                      <el-col v-show="show7" :span="8">
                        <el-form-item :label="$t('label.PFANS1028VIEW_POINTS107')" style="margin-left: 200px">
                          <el-input v-model="form.eccnjudgeno" :disabled="!disable"
                                    style="width: 20vw ; margin-left: 1px"></el-input>
                        </el-form-item>
                      </el-col>
                    </el-row>
                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item :label="$t('label.PFANS1028VIEW_JUDGECOMPLEMENT')">
                      <el-input v-model="form.judgecomplement" :disabled="!disable" style="width:70vw"></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-collapse>
              ...
              <div>
                <el-row>
                  ...
                  <el-col :span="8">
                    <!--带出PJ名-->
                    <el-form-item :label="$t('label.PFANS1028VIEW_NAME')">
                      <el-input v-model="form.janame" :disabled="!disable" style="width:20vw"></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
                    <el-form-item :label="$t('label.PFANS1028VIEW_ORGANIZATION')">
                        ...
                        <el-table :data="tableCommun"
                          ...
                          <el-table-column :label="$t('label.PFANS1028VIEW_JUDGMENT1')" align="center" width="100">
                            <template slot-scope="scope">
                              ...
                              <!--                                         @change="getjudgment1">-->
                              <!--                              </dicselect>-->
                              <el-select v-model="scope.row.judgment1" :disabled="!disable" clearable>
                          ...
                          <el-table-column :label="$t('label.PFANS1028VIEW_JUDGMENT2')" align="center" width="100">
                            <template slot-scope="scope">
                              ...
                              <!--                                         @change="getjudgment2">-->
                              <!--                              </dicselect>-->
                              <el-select v-model="scope.row.judgment2" :disabled="!disable" clearable>
                                <el-option label="o" value="1"></el-option>
                                <el-option label="x" value="2"></el-option>
                              </el-select>
                            </template>
              ...
              <el-tabs v-model="activeName3" type="border-card">
                <el-tab-pane :label="$t('label.PFANS2023FORMVIEW_INTELLIGENCE')" name="first">
                  ...
                  <el-row>
                    ...
                    <el-col :span="12">
                      <el-form-item :label="$t('label.PFANS1028VIEW_JUDGENO')">
                        <el-input v-model="form. lyjudgeno" :disabled="true" style="width:20vw"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item :label="$t('label.PFANS1028VIEW_JAPANNO')">
                    ...
                    <el-col :span="12">
                      <el-form-item :label="$t('label.PFANS1028VIEW_EXPORT')">
                        <el-input v-model="form.export" :disabled="!disable" style="width:20vw"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
                      <el-form-item :label="$t('label.PFANS1028VIEW_ORGANIZATION')">
