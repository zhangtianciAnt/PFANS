<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :noback="noback" :title="title"
    >
      <div slot="customize">
        <el-container style="margin-top: 2rem">
          <el-aside style="width: 80%;">
            <el-row>
              <el-col :span="6">
                <full-calendar ref="fullCalendar1" :dayRender="dayRender" :defaultDate="defaultDate4" :first-day="firstDay"
                               :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
                               @dateClick="handleDateClick"/>
              </el-col>
              <el-col :span="6">
                <full-calendar ref="fullCalendar2" :dayRender="dayRender" :defaultDate="defaultDate5" :first-day="firstDay"
                               :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar3" :dayRender="dayRender" :defaultDate="defaultDate6" :first-day="firstDay"
                               :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar4" :dayRender="dayRender" :defaultDate="defaultDate7" :first-day="firstDay"
                               :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
            ...
            <el-row>
              <el-col :span="6">
                <full-calendar ref="fullCalendar5" :dayRender="dayRender" :defaultDate="defaultDate8" :first-day="firstDay"
                               :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar6" :dayRender="dayRender" :defaultDate="defaultDate9" :first-day="firstDay"
                               :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar7" :dayRender="dayRender" :defaultDate="defaultDate10"
                               :first-day="firstDay" :header='header'
                               :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar8" :dayRender="dayRender" :defaultDate="defaultDate11"
                               :first-day="firstDay" :header='header'
                               :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
            ...
            <el-row>
              <el-col :span="6">
                <full-calendar ref="fullCalendar9" :dayRender="dayRender" :defaultDate="defaultDate12"
                               :first-day="firstDay" :header='header'
                               :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar10" :dayRender="dayRender" :defaultDate="defaultDate1"
                               :first-day="firstDay" :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
                               @dateClick="handleDateClick"/>
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar11" :dayRender="dayRender" :defaultDate="defaultDate2"
                               :first-day="firstDay" :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
              ...
              <el-col :span="6">
                <full-calendar ref="fullCalendar12" :dayRender="dayRender" :defaultDate="defaultDate3"
                               :first-day="firstDay" :header='header' :locale='locale'
                               :plugins="calendarPlugins" :showNonCurrentDates="showNonCurrentDates" defaultView="dayGridMonth"
                               style="padding: 5px"
                               weekMode="fixed"
          ...
          <el-main>
            ...
            <el-row>
              <el-col :span="2">
                <el-tag effect="dark" style="width: 7rem;background-color:#df4848;border-color:#df4848" type="danger">
            ...
            <el-row>
              <el-col :span="2">
                <el-tag effect="dark" style="width: 7rem;background-color:#999;border-color:#999" type="info">
            ...
            <el-row>
              <el-col :span="2">
                <el-tag effect="dark" style="width: 7rem;;background-color:#f9e30e;border-color:#f9e30e" type="warning">
        ...
        <el-dialog :visible.sync="tanchang" width="40rem">
          <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 14.5rem">
            <tr>
              <el-radio v-model="radio1" border label="1"
                        ...
                        @change="setClick('1')">{{ $t('label.PFANS8007VIEW_FD') }}
              </el-radio>
            </tr>
            <tr>
              <el-radio v-model="radio1" border label="2"
                        style="width: 8rem;background-color:#999;color: white"
                        @change="setClick('2')">{{ $t('label.PFANS8007VIEW_GX') }}
              </el-radio>
            </tr>
            <tr>
              <el-radio v-model="radio1" border label="3"
                        style="width: 8rem;background-color:#005baa;color: white"
                        @change="setClick('3')">{{ $t('label.PFANS8007VIEW_ZT') }}
              </el-radio>
            </tr>
            <tr>
              <el-radio v-model="radio1" border label="4"
                        style="width: 8rem;background-color:#f9e30e;color: white"
                        @change="setClick('4')">{{ $t('label.PFANS8007VIEW_ZTC') }}
              </el-radio>
            </tr>
            <tr>
              <el-radio v-model="radio1" border label="5"
                        style="width: 8rem;background-color:magenta;color: white"
                        @change="setClick('5')">{{ $t('label.PFANS8007VIEW_HS') }}
              </el-radio>
            </tr>
            <!--            <tr>-->
          ...
          <div style="margin-top: 1rem;margin-left: 13rem">
            <el-button type="primary" @click="submitForm('ruleFormNew')">
              {{ $t('button.confirm') }}
            </el-button>
