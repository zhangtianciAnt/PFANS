<template>
  <div style="min-height: 100%">
    <el-card class="box-card" style="height: calc(100vh - 60px - 2rem)">
      <div>
        <div class="m-content" @click="submitForm('PJ')">
          <el-col :span="18">
      ...
      <div>
        <div class="m-content" @click="submitForm('HT')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
      ...
      <div>
        <div class="m-content" @click="submitForm('PR')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
      ...
      <div>
        <div class="m-content" @click="submitForm('PP')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
      ...
      <div>
        <div class="m-content" @click="submitForm('PC')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
      ...
      <div>
        <div class="m-content" @click="submitForm('BP')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
      ...
      <div>
        <div class="m-content" @click="submitForm('PA')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
      ...
      <div>
        <div class="m-content" @click="submitForm('PG')">
          <el-col :span="18">
            <div style="width: 150px; margin-left: 8px; text-overflow: ellipsis; overflow: hidden;
