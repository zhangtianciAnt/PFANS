    ...
    <div slot="customize" style="margin-top:2rem">
      <el-form ref="form" :model="form" :rules="rules" label-position="top" label-width="8vw" style="padding: 2vw">
        <el-form-item :label="$t('label.PFANS8008VIEW_MESSAGE_HEADER')" prop="title">
          <el-input v-model="form.title" :disabled="!disable" class="width" maxlength="50"
        ...
        <el-form-item :label="$t('label.PFANS8008FORMVIEW_RICHTEXT')">
          ...
          <quill-editor ref="myQuillEditor" v-model="form.richtext" :options="editorOption" style="height: 300px;">
          </quill-editor>
        </el-form-item>
      </el-form>
    </div>
