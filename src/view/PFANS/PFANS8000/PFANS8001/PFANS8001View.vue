<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :noback="noback"
                         :title="title"
                         @buttonClick="buttonClick">
      <div slot="customize" style="margin-top: 4rem;">
        <el-form ref="ruleFormNew" :label-position="labelPosition" :model="ruleFormNew"
                 :rules="rulesNew" label-width="10rem" style="width:80%;margin:5% auto">
          <el-form-item :label="$t('label.PFANS8001VIEW_PASSWORD')" prop="password" style="margin-left: 30%">
            <el-input v-model="ruleFormNew.password" autoComplete="off" maxlength="16" show-password
                      style="width: 40%"></el-input>
          </el-form-item>
          <el-form-item :label="$t('label.PFANS8001VIEW_NEWPASSWORD')" prop="newpsw" style="margin-left: 30%">
            <el-input v-model="ruleFormNew.newpsw" autoComplete="off" maxlength="16" show-password
                      style="width: 40%"></el-input>
          </el-form-item>
          <el-form-item :label="$t('label.PFANS8001VIEW_NPASSWORD')" prop="confirmPsw" style="margin-left: 30%">
            <el-input v-model="ruleFormNew.confirmPsw" autoComplete="off" maxlength="16" show-password
                      style="width: 40%"></el-input>
          </el-form-item>
