<template>
  <div class="pfans3005view">
    <EasyNormalTable ref="roletable" v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data"
                     ...
                     :rowid="row" :selectable="selectInit" :showSelection="isShow" :title="title"
                     @buttonClick="buttonClick" @reget="selectInfo" @rowClick="rowClick">
    </EasyNormalTable>
...
import {getDepartmentById, getDictionaryInfo, getOrgInfo, getStatus, getUserInfo} from '@/utils/customize';
