      ...
      <div slot="customize">
        <el-form ref="refform1" :model="form1" :rules="rules1" label-position="top" label-width="8vw">
          <el-dialog :title="$t('label.PFANS3005VIEW_TRASHREASON')" :visible.sync="dialogFormVisible">
            <el-form-item :error="errortrashreason" :label="$t('label.PFANS3005VIEW_TRASHREASON')" prop="trashreason">
              <el-input v-model="form1.trashreason" :autosize="{ minRows: 3, maxRows: 4}" style="width:46vw"
          ...
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS2002FORMVIEW_ORGIN')" name="first">
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item v-if="refuseShow" :label="$t('label.PFANS1016FORMVIEW_COMPLETEDATE')">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_LINENUMBER')" prop="linenumber">
                    <el-input v-model="form.linenumber" :disabled="!disable" maxlength="20"
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_SETPLACE')" prop="setplace">
                    <el-input v-model="form.setplace" :disabled="!disable" maxlength='20'
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :error="errorcontroller" :label="$t('label.PFANS3005VIEW_CONTROLLER')"
                                prop="controller">
                    <user v-model="form.controller" :disabled="!disable" :error="errorcontroller"
                          :selectType="selectType"
                          :userlist="controllerlist" style="width:20vw"
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :error="errorusername" :label="$t('label.PFANS3005VIEW_USER')" prop="username">
                    <user v-model="form.username" :disabled="!disable" :error="errorusername" :selectType="selectType"
                          :userlist="usernamelist" style="width:20vw"
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005FORMVIEW_SUPPLIERNAME')" prop="suppliername">
                    <el-input v-model="form.suppliername" :disabled="!disabled" maxlength="50"
                              style="width: 20vw;"></el-input>
                  </el-form-item>
                </el-col>
                <!--//add_fjl_0908 添加供应商名称-->
              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item v-show="show6" :label="$t('label.PFANS1004VIEW_REASONSFORQUOTATION')"
                                label-width="6rem">
                    <el-input v-model="form.reasonsforquotation" :disabled="!disabled" style="width: 58vw;"
                              type="textarea"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                ...
                <!--                </el-col>-->
                <el-col :span="8">
                  <el-form-item v-show="show3" :label="$t('label.PFANS3003FORMVIEW_CLASSIFICATION')"
                ...
                <el-col :span="8">
                  <el-form-item v-show="show3"
                                :label="$t('label.PFANS3005FORMVIEW_BUSINESSPLANBALANCE')">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_PURCHASEPURPOSE')" prop="purchasepurpose">
                    <el-input v-model="form.purchasepurpose" :disabled="!disable" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item v-show="show5" :label="$t('label.PFANS3005FORMVIEW_FIXEDASSETSNO')"
                                prop="fixedassetsno">
                    <el-input v-model="form.fixedassetsno" :disabled="fixedisable" maxlength='20'
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item v-show="show4" :label="$t('label.PFANS3005FORMVIEW_OUTASSETSNO')" prop="outassetsno">
                    <el-input v-model="form.fixedassetsno" :disabled="fixedisable" maxlength='20'
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_PROCUREMENTDETAILS_NAME')" prop="procurementdetails">
                    <el-input v-model="form.procurementdetails" :disabled="!disable" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.remarks')">
                    <el-input v-model="form.remarks" :disabled="!disable" style="width:58vw" type="textarea"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <!--              <el-row>-->
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_BRANDNAME')">
                    <el-input v-model="form.brandname" :disabled="!disable" maxlength='20'
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_MODEL')" prop="model">
                    <el-input v-model="form.model" :disabled="!disable" maxlength='20' style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <!--111-->
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_EQUIPMENTURL')">
                    <el-input v-model="form.equipmenturl" :disabled="!disable" style="width: 58vw"
                              type='textarea'></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS3005VIEW_TOTALAMOUNT')+$t('label.PFANS3005VIEW_FARE')"
                                prop="totalamount">
                    <el-input-number v-model="form.totalamount" :disabled="!disable" :min="0" :precision="2"
                                     controls-position="right"
                                     style="width:20vw">
                    </el-input-number>
                  </el-form-item>
            ...
            <el-tab-pane :label="$t('label.PFANS3005FORMVIEW_ORGIN')" name="four">
              <el-row>
                <el-col :span="24">
                  <el-form-item :label="$t('label.PFANS3005VIEW_YUSUANBUZUFORQUOTATION')" label-width="6rem">
                    <el-input v-model="form.yusuanbuzu" :disabled="acceptShow1" style="width: 58vw;"
                              type="textarea"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :errorrecipients="errorrecipients" :label="$t('label.PFANS3005VIEW_RECIPIENTS')"
                                prop="recipients">
                    <user v-model="form.recipients" :disabled="acceptShow1" :errorrecipients="errorrecipients"
                          :selectType="selectType"
                          :userlist="recipientslist" style="width:20vw"
                          @getUserids="getRecipientslist"></user>
                  </el-form-item>
                </el-col>
              </el-row>
