    ...
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :title="title"
      ...
      <div slot="customize">
        <el-form ref="ruleForm" :model="form" :rules="rules" label-position="top" label-width="8vw"
                 style="padding: 2vw">
          <el-tabs v-model="form.ticketstype" type="border-card" @tab-click="handleClick">
            <el-tab-pane :disabled="this.$route.params._id !== '' && this.form.ticketstype === 'second'" :label="$t('label.PFANS3001FORMVIEW_DOMESTIC')" name="first"
                         value="1"></el-tab-pane>
            <el-tab-pane :disabled="this.$route.params._id !== '' && this.form.ticketstype === 'first'" :label="$t('label.PFANS3001FORMVIEW_FOREIGN')" name="second"
                         value="2"></el-tab-pane>
            ...
            <el-row>
              <el-col v-show="refuseShow1" :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_TICKETORDERNUMBER')" prop="ticketordernumber">
                  <el-input v-model="form.ticketordernumber" :disabled="acceptShow" maxlength="100"
                            style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <el-col v-show="refuseShow1" :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_TICKETVENDORS')" prop="ticketvendors">
                  <el-input v-model="form.ticketvendors" :disabled="acceptShow" maxlength="100"
                            style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_ROMANID')" prop="romanid">
                  <el-input v-model="form.romanid" :disabled="!disable" maxlength="20" style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS1012FORMVIEW_BUDGET')" prop="budgetnumber">
                  <el-select v-model="form.budgetnumber" :disabled="!disable" :placeholder="$t('normal.error_09')" clearable
                             style="width: 20vw">
                    <el-option
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS3001VIEW_EXTENSIONNUMBER')" prop="extensionnumber">
                  <el-input v-model="form.extensionnumber" :disabled="!disable" maxlength="20"
                            style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <!--              add_fjl_05/25  &#45;&#45; 修改国内时的身份证/护照-->
              <el-col v-if="form.ticketstype === 'first'" :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_IDCARDORPA')" prop="idcardorpa">
                  <el-input v-model="form.idcardorpa" :disabled="!disable" maxlength="18" style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <el-col v-if="form.ticketstype === 'second'" :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_IDCARD')" prop="idcard">
                  <el-input v-model="form.idcard" :disabled="!disable" maxlength="18" style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <!--              add_fjl_05/25  &#45;&#45; 修改国内时的身份证/护照-->
              <el-col v-show="showDomestic" :span="8">
              ...
              <el-col v-show="showForeign" :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_PASSPORT')" prop="passport">
                  <el-input v-model="form.passport" :disabled="!disable" maxlength="9" style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <el-col v-show="showForeign" :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_EFFECTIVEDATE')" prop="effectivedate">
                  <el-date-picker v-model="form.effectivedate" :disabled="!disable" style="width:20vw"
                                  type="date"></el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS1013VIEW_RELATION')" prop="business_id">
                  <el-select v-model="form.business_id" :disabled="!disable" clearable style="width:20vw"
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS3001VIEW_TRIPPOINT')" prop="trippoint">
                  <el-input v-model="form.trippoint" :disabled="true" maxlength="50"
                            style="width:20vw"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_TRIPSTART')" prop="tripstart">
                  <el-date-picker v-model="form.tripstart" :disabled="true" style="width:20vw"
                                  type="date"></el-date-picker>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item :label="$t('label.PFANS3001FORMVIEW_TRIPEND')" prop="tripend">
                  <el-date-picker v-model="form.tripend" :disabled="true" style="width:20vw"
                                  type="date"></el-date-picker>
                </el-form-item>
              </el-col>
            ...
            <el-table :data="tableA" :header-cell-style="getRowClass" border stripe>

              <el-table-column :label="$t('label.PFANS3001VIEW_GO')" align="center">
                <el-table-column :label="$t('label.PFANS3001VIEW_GOING')" align="center" prop="going" width="240">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.going" :disabled="!disable" style="width: 90%"></el-input>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_GOAIRLINENUMBER')" align="center"
                                 prop="goairlinenumber" width="240">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.goairlinenumber" :disabled="!disable"
                              style="width: 90%"></el-input>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_GODEPARTUREDATE')" align="center"
                                 prop="godeparturedate" width="240">
                  <template slot-scope="scope">
                    <el-date-picker v-model="scope.row.godeparturedate" :disabled="!disable" style="width: 90%"
                                    type="datetime"></el-date-picker>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_GOARRIVALDATE')" align="center" prop="goarrivaldate"
                                 width="240">
                  <template slot-scope="scope">
                    <el-date-picker v-model="scope.row.goarrivaldate" :disabled="!disable" style="width: 90%"
                                    type="datetime"></el-date-picker>
                  </template>
                </el-table-column>
              </el-table-column>
              ...
              <el-table-column :label="$t('label.PFANS3001VIEW_RETURN')" align="center">
                <el-table-column :label="$t('label.PFANS3001VIEW_BACK')" align="center" prop="back" width="240">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.back" :disabled="!disable" maxlength="20"
                              style="width: 90%"></el-input>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_GOAIRLINENUMBER')" align="center"
                                 prop="reairlinenumber"
                                 width="240">
                  <template slot-scope="scope">
                    <el-input v-model="scope.row.reairlinenumber" :disabled="!disable" maxlength="20"
                              style="width: 90%"></el-input>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_GODEPARTUREDATE')" align="center" prop="ticketingdate"
                                 width="240">
                  <template slot-scope="scope">
                    <el-date-picker v-model="scope.row.ticketingdate" :disabled="!disable" style="width: 90%"
                                    type="datetime"></el-date-picker>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_GOARRIVALDATE')" align="center" prop="redeparturedate"
                                 width="240">
                  <template slot-scope="scope">
                    <el-date-picker v-model="scope.row.redeparturedate" :disabled="!disable" style="width: 90%"
                                    type="datetime"></el-date-picker>
                  </template>
                </el-table-column>

                <el-table-column :label="$t('label.PFANS3001VIEW_TICKETINGDATE')" align="center" prop="rearrivaldate"
                                 width="240">
                  <template slot-scope="scope">
                    <el-date-picker v-model="scope.row.rearrivaldate" :disabled="!disable" style="width: 90%"
                                    type="datetime"></el-date-picker>
                  </template>
                </el-table-column>
              </el-table-column>
