          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1012FORMVIEW_BUDGET')">
                ...
                <el-select v-model="form.company" :disabled="!disable" :placeholder="$t('normal.error_09')" clearable
                           style="width: 20vw">
                  <el-option
            ...
            <el-col :span="24">
              <el-table :data="tableD" :summary-method="getSummaries" border header-cell-class-name="sub_bg_color_blue" show-summary
                ...
                <el-table-column :label="$t('label.PFANS3004VIEW_NAME')" align="center" prop="footname" width="250">
                  <template slot-scope="scope">
                    <el-select v-model="scope.row.footname" :disabled="!disable" :no="scope.row" :placeholder="$t('normal.error_09')"
                ...
                <el-table-column :label="$t('label.numbers')" align="center" prop="numbers"
                                 width="250">
                  <template slot-scope="scope">
                    <el-input-number v-model="scope.row.numbers" :disabled="!disable" :max="9999999999" :min="1" :no="scope.row"
                                     :precision="0" :step="1" controls-position="right" style="width: 80%">
                    </el-input-number>
                  </template>
                </el-table-column>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item :label="$t('label.remarks')" prop="remarks">
                <el-input v-model="form.remarks" :disabled="!disable" style="width:70vw" type="textarea"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
