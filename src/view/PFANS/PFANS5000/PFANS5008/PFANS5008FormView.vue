  ...
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :title="title"
      ...
      <div slot="customize" style="margin-top: 0.5rem;">
        <el-form ref="form" label-position="top" label-width="8vw" style="padding: 2vw">
          <el-form ref="companyform" :model="companyform"
            ...
            <el-container>
              <el-aside style="width: 58%;height: 32rem">
                <el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item :label="$t('label.PFANS5008FORMVIEW_SC')" prop="time_start">
                      <el-input-number v-model="companyform.time_start" :disabled="!disable" :max="24"
                                       :min="0" :precision="2" :step="0.5" controls-position="right" style="width: 16vw"
                      ></el-input-number>
                    </el-form-item>
                  ...
                  <div v-show="isShow">
                    <el-col :span="12">
                      <el-form-item :label="$t('label.PFANS5004VIEW_PROJECTNAMW')" prop="project_id">
                        <el-select v-model="companyform.project_id" :disabled="!disable" clearable style="width: 16vw"
                                   @change="getProject">
                          <el-option
                    ...
                    <el-col :span="12">
                      <el-form-item :label="$t('label.PFANS5008VIEW_PROGRAMNAME')" prop="project_name"
                                    style="width:17vw">
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item :label="$t('label.PFANS5008VIEW_JDJOBS')" prop="work_phase" style="width:17vw">
                      <dicselect
                        :code="code2"
                  ...
                  <el-col :span="12">
                    <el-form-item :label="$t('label.PFANS5008VIEW_XWXF')" prop="behavior_breakdown"
                                  style="width:  17vw">
                      <dicselect
                        :code="code3"
                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item :label="$t('label.PFANS5008VIEW_GZBZ')" prop="work_memo" style="width:  16vw">
                      <el-input
                        v-model="companyform.work_memo"
                        :disabled="!disable"
                  ...
                  <el-col :span="12">
                    <el-form-item label="WBS_ID" prop="wbs_id" style="width:  17vw">
                      <el-input
                        v-model="companyform.wbs_id"
                        :disabled="!disable" :rows="2"
                        style="width: 16vw">
                      </el-input>
                    </el-form-item>
                  </el-col>
