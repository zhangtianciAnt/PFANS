      ...
      <div slot="customize">
        <el-form :model="form" :rules="rules" label-position="top" label-width="8vw" ref="refform"
          ...
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS5009VIEW_BASICINFORMATION')" name="first">
              <el-row>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_POSITIONTITLE')" prop="postname">
                    <el-input :disabled="!disabled" maxlength='20' style="width:20vw"
                              v-model="form.postname"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_PEOPLEREQUIRED')" prop="peoplerequired">
                    <el-input :disabled="!disabled" maxlength='5' style="width:20vw"
                              v-model="form.peoplerequired"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_WORKPLACE')" prop="workplace">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_VIEWPROJECT')" prop="viewproject">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_RECRUITMENTROUTE')" prop="recruitmentroute">
                    <dicselect
                      :code="code"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_OTHERWAYS')" v-show="show1">
                    <el-input :disabled="!disabled" maxlength='20' style="width:20vw" v-model="form.other"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_JOBDEMAND')" prop="jobdemand">
                    <dicselect
                      :code="code1"
                      :data="form.jobdemand"
                      :disabled="!disabled"
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_NEEDTOTRAVEL')" prop="needtotravel">
                    <dicselect
                      :code="code2"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_DEMANDLEVEL')" prop="demandlevel">
                    <dicselect
                      :code="code3"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_EXPECTEDARRIVALTIME')" prop="expectedarrivaltime">
                    <el-date-picker :disabled="!disabled" style="width:20vw" type="date"
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_SUGGESTEDSALARY')">
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5009VIEW_SKILLLEVEL')">
                    <dicselect
                      :code="code6"
            ...
            <el-tab-pane :label="$t('label.PFANS5009VIEW_JOBREQUIREMENTS')" name="second">
              <el-collapse>
                  <el-collapse-item>
                    <template slot="title">
                      <span  class="collapse_Title">{{$t('label.PFANS5009VIEW_QUALIFICATIONS')}}</span>
                    </template>
                  <el-row>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS5009VIEW_GENDERREQUIREMENTS')" prop="genderrequirements">
                        <dicselect
                          :code="code4"
                    ...
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS5009VIEW_AGEREQUIREMENT')" prop="agerequirement">
                        <el-input :disabled="!disabled" maxlength='20' style="width:20vw"
                                  v-model="form.agerequirement"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS5009VIEW_REQUIREMENTS')" prop="requirements">
                        <dicselect
                          :code="code5"
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS5009VIEW_OTHERQUALIFICATIONS')" v-show="show2">
                        <el-input :disabled="!disabled" maxlength='20' style="width:20vw"
                                  v-model="form.postother"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS5009VIEW_PROFESSIONAL')" prop="professional">
                        <el-input :disabled="!disabled" style="width:20vw" v-model="form.professional"></el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.PFANS5009VIEW_EXPERIENCE')" prop="experience">
                  ...
                  <el-row>
                    <el-col :span="24">
                      <el-form-item :label="$t('label.PFANS5009VIEW_OTHERREQUIREMENTS')"
                ...
                <el-collapse-item>
                  <template slot="title">
                    <span  class="collapse_Title">{{$t('label.PFANS5009VIEW_RESPONSIBILITIES')}}</span>
                  </template>
                  <el-row>
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.$route.params._id) {
        this.$store
          .dispatch('PFANS5009Store/getRecruitOne', {"recruitid": this.$route.params._id})
          .then(response => {
            this.form = response;
