<template>
  <div>
    <EasyNormalTable v-show="showTable1" v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data"
                     :rowid="row_id" :title="title" @buttonClick="buttonClick" @reget="getdata1"
                     @rowClick="rowClick">
    ...
    <EasyNormalTable v-show="!showTable1" v-loading="loading" :buttonList="buttonList1" :columns="columns1" :data="data2"
                     :rowid="row_id" :title="title2" @buttonClick="buttonClick" @reget="getdata2"
                     @rowClick="rowClick">
      <el-select slot="customize" v-model="region" @change="changed">
        <el-option :label="$t(title)" value="1"></el-option>
        <el-option :label="$t(title2)" value="2"></el-option>
