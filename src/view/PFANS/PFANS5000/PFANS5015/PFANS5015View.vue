<template>
  <EasyNormalTable ref="roletable" v-loading="loading" :buttonList="buttonList"
                   :columns="columns"
                   :data="data" :showReaload="showReaload"
                   :showSelection="isShow" :title="title"
                   @buttonClick="buttonClick">
    <div slot="search">
      <el-form ref="reff" label-position="top" label-width="8vw" style="padding-top: 2px">
        <el-form-item>
