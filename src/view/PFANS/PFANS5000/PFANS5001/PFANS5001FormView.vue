<template>
  <div>
    <EasyNormalContainer
      ...
      :title="title"
      :workflowCode="workcode" @StartWorkflow="buttonClick"
        ...
        >
          <el-tabs v-model="activeName" type="border-card">
                  ...
                  <el-row>
                    <el-col :span="8">
                      <el-form-item :label="$t('label.team')">
                        <org :disabled="!disable" :orglist="form.team_id" orgtype="3" style="width:20vw"
                             @getOrgids="getTeamId"></org>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item :error="errorgroup" :label="$t('label.group')" prop="group_id">
                        <org :disabled="!disable" :error="errorgroup" :orglist="form.group_id" orgtype="2"
              ...
              <el-row v-show="form.toolstype === '1'">
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5001FORMVIEW_ENTRUST')" prop="toolsorgs">
                    <org :disabled="!disable" :orglist="form.toolsorgs" orgtype="2" style="width:20vw"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS5001FORMVIEW_OPTIONSDATA')">
                    <el-select v-model="form.projectids" :disabled="!disable" clearable style="width: 16vw"
                    >
                      <el-option
              ...
              <el-row v-show="form.toolstype === '0' || !form.toolstype">
                <el-col :span="8">
                  <el-form-item :error="errorLeader" :label="$t('label.PFANS5001FORMVIEW_ENTRUST')"
                                prop="errorLeader">
                    <div class="dpSupIndex" prop="errorLeader" style="width: 20vw">
                      <el-container>
                        <input v-model="form.entrust" :disabled="true" :error="errorLeader"
                          ...
                          <div style="text-align: center">
                            <el-row style="text-align: center;height: 90%;overflow: hidden">
                              <el-table
                                ...
                                <el-table-column :label="$t('label.PFANS5001FORMVIEW_ENTRUST')" property="entrust"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.ASSETS1002VIEW_USERID')" prop="behalf">
                    <el-input v-model="form.behalf" :disabled="true" maxlength='20'
                  ...
                  <el-col :span="24">
                    <el-tabs v-model="activeName2" type="border-card">
                      ...
                      <el-tab-pane :label="$t('label.PFANS5001FORMVIEW_INCOMMUNITY')" name="first">
                        <el-table :cell-class-name="setPl" :data="tableB" border header-cell-class-name="sub_bg_color_blue"
                                  stripe style="width: 80vw">
                          <!--                       编号-->
                          <!--<el-table-column-->
                                ...
                                <div class="dpSupIndex" prop="expname" style="width:10vw">
                                  <el-container>
                                    ...
                                    <el-button :disabled="!disable" icon="el-icon-search"
                                               size="small"
                                               @click="dialogone(scope.row)"></el-button>
            ...
            <el-tab-pane :label="$t('label.PFANS5001FORMVIEW_CONTRACT')" name="fifth">
              <el-form-item>
                <el-table v-show="form.toolstype === '0' || !form.toolstype" :data="tableD" border header-cell-class-name="sub_bg_color_blue"
                        ...
                        <div class="dpSupIndex" style="width:16vw">
                          <el-container>
                            <input v-model="scope.row.contract" :disabled="true"
                                   class="content bg" style="min-width: 50%;width: 50%"></input>
                            <el-button :disabled="!disable" icon="el-icon-search" size="small"
                                       @click="changecontract(scope.row)"></el-button>
                            <el-dialog :visible.sync="dialogTableVisible3" append-to-body
                                       center
                                       lock-scroll size="50%"
                                       top="8vh"
                                       width="72%">
                              <div style="text-align: center">
                                <el-row style="text-align: center;height: 90%;overflow: hidden">
                                  <el-table
                                    ...
                                    <el-table-column :label="$t('label.PFANS1032FORMVIEW_CONTRACTNUMBER')"
                                                     property="contract"
                                                     width="160"></el-table-column>
                                    <el-table-column :label="$t('label.group')" property="deployment"
                                                     width="180"></el-table-column>
                                    <el-table-column :label="$t('label.PFANS1024VIEW_CONTRACTTYPE')"
                                                     property="contracttype"
                                                     width="150"></el-table-column>
                                    <!--<el-table-column property="applicationdate"-->
                                    <!--:label="$t('label.PFANS1024VIEW_APPLICATIONDATE')"-->
                                    <!--width="100"></el-table-column>-->
                                    <el-table-column :label="$t('label.PFANS1026VIEW_CONTRACTPERIOD')"
                  ...
                  <el-table-column :label="$t('label.PFANS1024VIEW_CLAIMDATETIME')" align="center" prop="claimdatetime"
                                   width="280">
                    <template slot-scope="scope">
                      <el-date-picker v-model="scope.row.workinghours"
                                      :disabled="true"
