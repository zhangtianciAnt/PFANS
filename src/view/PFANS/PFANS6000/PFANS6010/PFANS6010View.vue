<template>
  <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data"
                   :rowid="row" :title="title" @buttonClick="buttonClick" @rowClick="rowClick">
    <el-date-picker
      slot="customize"
      v-model="months"
...
import {getCurrentRole8, getCurrentRoleNew, getOrgInfo, getStatus} from '@/utils/customize';
