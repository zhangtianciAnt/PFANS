<template>
  <div>
    <EasyNormalTable ref="roletable" v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data"
                     ...
                     @buttonClick="buttonClick" @reget="getsupplierinfor" @rowClick="rowClick">
    </EasyNormalTable>
...
export default {
  ...
  data() {
    return {
      ...
      postAction: process.env.BASE_API + '/supplierinfor/supimport',
      addActionUrl: '',
      resultShow: false,
      result: false,
      file: null,
    ...
    buttonClick(val) {
      if (val === 'import') {
        ...
        import('@/vendor/Export2Excel').then(excel => {
          const tHeader = [
            this.$t('label.PFANS6002VIEW_SUPPLIERNAMEC'),
            this.$t('label.PFANS6002VIEW_SUPPLIERNAMEJ'),
