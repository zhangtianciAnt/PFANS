<template>
  <EasyNormalContainer ref="container" v-loading="loading"
    ...
    <div slot="customize" style="width: 100%">
      <el-form ref="form" :model="form" employedref="refform" label-position="top" label-width="8vw"
               style="padding: 0.5vw">
        ...
        <el-row style="padding-bottom: 0.5%">
          <el-table :data="tableData" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" border default-expand-all
