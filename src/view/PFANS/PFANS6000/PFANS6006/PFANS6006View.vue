<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList"
                         :noback="true" :title="title" @buttonClick="buttonClick">
      <div slot="customize">
        <el-form ref="reff" label-position="top" label-width="8vw" style="padding-top: 10px">
          <el-form-item>
            <el-row style="margin-top: 20px">
              <div align="right">
                ...
                <el-col :span="6">
                  <el-input v-model="filterName" :placeholder="$t('label.PFANS6006VIEW_BPINFO')"
                            style="width: 20vw">
                    <el-button slot="append" icon="el-icon-search" plain type="primary"
                               @click="inputChange"></el-button>
                  </el-input>
                </el-col>
              </div>
            </el-row>
            ...
            <el-row style="margin-top: 0px">
              ...
              <plx-table-grid :datas="tableData" :header-cell-style="getRowClass" :pagination-show="paginationShow"
                              :row-height="rowheight" :rowClassName="rowClassName" big-data-checkbox
                              border cell-class-name="row_height_left" header-cell-class-name="sub_bg_color_blue" header-row-class-name="height"
                              height="400" highlight-current-row
                              style="width: 100%;height: calc(100vh - 200px - 2rem)"
                              use-virtual @selection-change="handleSelectionChange"
                ...
                <plx-table-column
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.april"
                        :disabled="disabledfunc(4,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.may"
                        :disabled="disabledfunc(5,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.june"
                        :disabled="disabledfunc(6,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.july"
                        :disabled="disabledfunc(7,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.august"
                        :disabled="disabledfunc(8,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.september"
                        :disabled="disabledfunc(9,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.october"
                        :disabled="disabledfunc(10,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.november"
                        :disabled="disabledfunc(11,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.december"
                        :disabled="disabledfunc(12,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.january"
                        :disabled="disabledfunc(1,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.february"
                        :disabled="disabledfunc(2,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
                  ...
                  <plx-table-column
                    ...
                    <template slot-scope="scope">
                      <el-input-number
                        v-model.trim="scope.row.march"
                        :disabled="disabledfunc(3,scope.row.flag)"
                        :max="9999999999"
                        :min="0"
                        :precision="2"
                        :step="0.01"
      ...
      this.$store
        ...
        .then(response => {
          ...
          for (let j = 0; j < responsex.length; j++) {
            ...
            if (exp) {
              if (exp.exitime != null) {
                var date = new Date(exp.exitime);
                var YY = date.getFullYear() + '-';
                var MM = (date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1) + '-';
                var DD = (date.getDate() < 10 ? '0' + (date.getDate()) : date.getDate());
                responsex[j].exittime = YY + MM + DD;
              }
            }
            tabledate.push({
