<template>
  <div style="min-height: 100%">
    <EasyNormalContainer :buttonList="buttonList" :canStart="canStart" :title="title" @buttonClick="buttonClick"
                         @end="end" @disabled="setdisabled" :workflowCode="workflowCode"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS2001VIEW_SUGGESTEDSALARY')">
                    <el-input-number :disabled="!disabled" :max="1000000000" :min="0"
                                     :precision="2" controls-position="right" style="width:9.5vw"
                                     v-model="form.suggestedsalary"></el-input-number>
                    <span>~</span>
                    <el-input-number :disabled="!disabled" :max="1000000000" :min="0"
                                     :precision="2" controls-position="right" style="width:9.5vw"
                                     v-model="form.turningday"></el-input-number>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
