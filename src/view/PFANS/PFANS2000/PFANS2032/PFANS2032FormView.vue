<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList"
                         :canStart="canStart"
                         :title="title"
                         :workflowCode="workflowCode" @buttonClick="buttonClick" @end="end" @start="start" @workflowState="workflowState">
      <div slot="customize">
        <el-form ref="reff" :model="form" :rules="rules" label-position="top" label-width="8vw" style="padding: 2vw">
          <el-tabs v-model="activeName" type="border-card">
            <el-tab-pane :label="$t('label.PFANS2026VIEW_OUT')" name="second">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS2026VIEW_RESIGNATIONDATE')" prop="resignation_date">
                    <el-date-picker v-model="form.resignation_date" :disabled="!disable" style="width:20vw">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
              </el-row>
                ...
                <el-col :span="8">
                  <el-form-item :error="errorreporter" :label="$t('label.PFANS2026VIEW_REPORTER')">
                    <user :disabled="!disable" :error="errorreporter" :selectType="selectType"
                          :userlist="reporterlist" style="width:20vw" @getUserids="getReporterids"></user>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS2026VIEW_REPORTDATE')">
                    <el-date-picker v-model="form.report_date" :disabled="!disable" style="width:20vw">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :error="errordata" :label="$t('label.PFANS2032FROMVIEW_USERDATA')" prop="userdata">
                    <user v-model="form.userdata" :disabled="!disable" :error="errordata" :selectType="selectType"
                          :userlist="userdatalist" style="width:20vw" @getUserids="getUserdata"></user>
                  </el-form-item>
                </el-col>
                <el-col :span="16">
                  <el-form-item :label="$t('label.PFANS2032FROMVIEW_REMARKDATA')">
                    <el-input v-model="form.remarkdata" :disabled="!disable" style="width: 46vw;"
                              type="textarea">
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :error="errorwork" :label="$t('label.PFANS2032FROMVIEW_USERWORKFOLW')" prop="userwork">
                    <user v-model="form.userworkfolw" :disabled="!disable" :error="errorwork" :selectType="selectType"
                          :userlist="userworkfolwlist" style="width:20vw" @getUserids="getUserwork"></user>
                  </el-form-item>
                </el-col>
                <el-col :span="16">
                  <el-form-item :label="$t('label.PFANS2032FROMVIEW_REMARKWORKFOLW')">
                    <el-input v-model="form.remarkworkfolw" :disabled="!disable" style="width: 46vw;"
                              type="textarea">
                    </el-input>
                  </el-form-item>
                </el-col>
              ...
              <el-row>
                <el-col v-if="!checkdisable" :span="8">
                  <el-form-item :label="$t('label.PFANS2030FROMVIEW_BUTTON2')">
                    <el-button :disabled="false" icon="el-icon-view" @click="submitForm('ruleFormNew')">
              ...
              <el-row>
                <el-form-item :label="$t('label.PFANS2026VIEW_EXTERNALEVALUATION')">
                  <el-input v-model="form.external_evaluation" :disabled="!disable" style="width: 70vw;"
                            type="textarea">
                  </el-input>
                </el-form-item>
              </el-row>
              <el-row>
                <el-form-item :label="$t('label.PFANS2026VIEW_REASON2')">
                  <el-input v-model="form.reason2" :disabled="!disable"
                            :placeholder="$t('label.PFANS2026FORMVIEW_PLACEHOLDER1')"
              ...
              <el-row>
                <el-form-item :label="$t('label.PFANS2026VIEW_IMPACTRESIGNATIONEXTERNAL')">
                  <el-input v-model="form.impact_resignation_external" :disabled="!disable" style="width: 70vw;"
                            type="textarea">
                  </el-input>
                </el-form-item>
              </el-row>
              <el-row>
                <el-form-item :label="$t('label.PFANS2026VIEW_IMPACTRESIGNATIONINTERNAL')">
                  <el-input v-model="form.impact_resignation_internal" :disabled="!disable" style="width: 70vw;"
                            type="textarea">
                  </el-input>
                </el-form-item>
              </el-row>
              <el-row>
                <el-form-item :label="$t('label.PFANS2026VIEW_INFLUENCEINFORMATIONSECURITY')">
                  <el-input v-model="form.influence_information_security" :disabled="!disable" :placeholder="$t('label.PFANS2026FORMVIEW_PLACEHOLDER2')"
                            :rows="3"
                            style="width: 70vw;"
                            type="textarea">
                  </el-input>
              ...
              <el-row>
                <el-form-item :label="$t('label.PFANS2026VIEW_RETIREMENTSTRATEGY')">
                  <el-input v-model="form.retirement_strategy" :disabled="!disable"
                            :placeholder="$t('label.PFANS2026FORMVIEW_PLACEHOLDER3')"
                            style="width: 70vw;"
                            type="textarea">
                  </el-input>
                </el-form-item>
              ...
              <el-row>
                <el-form-item :label="$t('label.PFANS2026FORMVIEW_DATA1')" prop="jpwork_delivery">
                  <el-input v-model="form.jpwork_delivery" :disabled="!disable1" :rows="2" style="width: 70vw;"
                            type="textarea">
                  </el-input>
                </el-form-item>
              </el-row>
                      ...
                      <el-table :data="tableD" border header-cell-class-name="sub_bg_color_blue" stripe
                        ...
                        <el-table-column :label="$t('label.PFANS2026FORMVIEW_CONTENT')" align="center" fixed
                          ...
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.content" :disabled="!disable1">
                            </el-input>
                          </template>
                        </el-table-column>
                        ...
                        <el-table-column :label="$t('label.PFANS2026FORMVIEW_REMARKS')" align="center" prop="remarks">
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.remarks" :disabled="!disable1">
                            </el-input>
                          </template>
                        </el-table-column>
                ...
                <el-col :span="24">
                  <el-table
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        <el-checkbox v-model="scope.row.checked" :disabled="true" :on="scope.row"
                    ...
                    <el-table-column
                      ...
                      width="150">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.condate" :disabled="true" :on="scope.row"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      width="130">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.person" :disabled="true" :on="scope.row"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      width="130">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.personname" :disabled="true" :on="scope.row"></el-input>
                      </template>
                    </el-table-column>
                  </el-table>
                </el-col>
