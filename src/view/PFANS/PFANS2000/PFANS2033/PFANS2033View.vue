    ...
    <EasyNormalContainer ref="container" v-loading="loading"
      ...
      <div slot="customize">
        <el-form label-position="top" label-width="8vw" style="padding-top: 25px">
          <el-form-item>
            <el-row>
              <plx-table-grid :datas="tableData" :header-cell-style="getRowClass" :pagination-show="paginationShow" :rowClassName="rowClassName"
                              border cell-class-name="row_height_left" height="600"
                              highlight-current-row style="width: 100%;height:510px">
                <!-- 日期对比-->
                <plx-table-column
                  :label="'-'"
                  align="center"
...
import {getCurrentRolegongzijisuan, getUserInfo} from '@/utils/customize';
