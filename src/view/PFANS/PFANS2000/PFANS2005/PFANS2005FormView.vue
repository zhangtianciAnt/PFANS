            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_QQ')" name="ninth">
              ...
              >
                ...
                <el-table-column :label="$t('label.PFANS2005FORMVIEW_JYQQ')" align="center">
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisdiligencetry"
                                @change="thisMonthLacktimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <!--                  endregion-->
                  <!--                  region 短病欠-试用（H）-->
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisshortdeficiencytry"
                                @change="thisMonthLacktimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <!--                  endregion-->
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thischronicdeficiencytry"
                                @change="thisMonthLacktimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <!--                  endregion-->
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisdiligenceformal"
                                @change="thisMonthLacktimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <!--                  endregion-->
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisshortdeficiencyformal"
                                @change="thisMonthLacktimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <!--                  endregion-->
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thischronicdeficiencyformal"
                                @change="thisMonthLacktimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <!--                  endregion-->
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_CY')" name="tenth">
              ...
              >
                ...
                <el-table-column :label="$t('label.PFANS2005FORMVIEW_JYCY')" align="center">
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisweekdays"
                                @change="thisMonthOvertimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <el-table-column
                    :label="$t('label.PFANS2005FORMVIEW_XRJB')"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisrestDay" @change="thisMonthOvertimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <el-table-column
                    :label="$t('label.PFANS2005FORMVIEW_FDJB')"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thislegal" @change="thisMonthOvertimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <el-table-column
                    :label="$t('label.PFANS2005FORMVIEW_DX')"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisreplace" @change="thisMonthOvertimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <el-table-column
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.thisreplace3"
                                @change="thisMonthOvertimeChange(scope.row)"></el-input>
                    </template>
                  </el-table-column>
                  <el-table-column
