          ...
          <el-tabs @tab-click="handleClick" v-model="activeName">
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_JS')" name="second">
              ...
              <div class="pagination-container" style="padding-top: 20px">
                <el-pagination
                  :current-page.sync="listQueryList.page"
                  :page-size="listQueryList.limit"
              ...
              <div>
                ...
                <el-table :data="tableQT1Woman" header-cell-class-name="sub_bg_color_grey height">
                  ...
                  <el-table-column
                    ...
                    width="160%"
                  ></el-table-column>
                  <el-table-column :label="$t('label.PFANS2006VIEW_SEX')" align="center" prop="sex"></el-table-column>
                  <el-table-column
                    :label="$t('label.PFANS2022VIEW_JOININGDAY')"
                    align="center"
                    prop="workdate"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-select v-model="scope.row.basedata">
                        <el-option
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_QT2')" name="fourth">
              <div>
                ...
                <el-row>
                  ...
                  >
                    ...
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_GJ')"
                      align="center"
                      prop="rootknot"
                    >
                      <template slot-scope="scope">
              ...
              <div>
                <el-dialog :visible.sync="daoruothertwo" width="50%">
                  <div>
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_QT4')" name="fifth">
              <div>
                ...
                <el-row>
                  ...
                  >
                    ...
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_HJ')"
                      align="center"
                      prop="total"
                    ></el-table-column>
              ...
              <div>
                <el-dialog :visible.sync="daoruotherfour" width="50%">
                  <div>
                    <div style="margin-top: 1rem;margin-left: 28%">
                      <el-upload
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_QT5')" name="sixth">
                ...
                <el-row>
                  ...
                  >
                    ...
                    <el-table-column
                      ...
                      prop="department_id"
                    ></el-table-column>
                    <el-table-column :label="$t('label.user_name')" align="center" prop="user_id"></el-table-column>
                    <el-table-column
                    ...
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_YWBX')"
                      align="center"
                      prop="accident"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_TJ')"
                      align="center"
                      prop="physical"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_FZHJ')"
                      align="center"
                      prop="welfaretotal"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_GHFL')"
                      align="center"
                      prop="labourunion"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_WNHJP')"
                      align="center"
                      prop="annualmeeting"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_ZHLYF')"
                      align="center"
                      prop="travel"
                    ></el-table-column>
                    <el-table-column
              ...
              <div>
                <el-dialog :visible.sync="daoruotherfive" width="50%">
                  <div>
                    <div style="margin-top: 1rem;margin-left: 28%">
                      <el-upload
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_QQ')" name="ninth">
              ...
              <el-table :data="tableQQ" :summary-method="getSummaries" show-summary>
                ...
                <el-table-column :label="$t('label.PFANS2005FORMVIEW_JYQQ')" align="center">
                  <el-table-column
                    :label="$t('label.PFANS2005FORMVIEW_QQH')"
                    align="center"
                    prop="january"
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_YDSY')" name="eleventh">
              <div>
                ...
                <el-row>
                  ...
                  >
                    ...
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_KZ1')"
                      align="center"
                      prop="other1"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_KZ2')"
                      align="center"
                      prop="other2"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_KZ3')"
                      align="center"
                      prop="other3"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_KZ4')"
                      align="center"
                      prop="other4"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_KZ5')"
                      align="center"
                      prop="other5"
                    ></el-table-column>
                  </el-table>
              ...
              <div>
                <el-dialog :visible.sync="daoruappreciation" width="50%">
                  <div>
                    <div style="margin-top: 1rem;margin-left: 28%">
                      <el-upload
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_FJKC')" name="fourteenth">
              <div>
                ...
                <el-row>
                  ...
                  >
                    ...
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_LJZFDYXX')"
                      align="center"
                      prop="housing"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_LJZFZJ')"
                      align="center"
                      prop="rent"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_LJSYLR')"
                      align="center"
                      prop="support"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_LJJXJY')"
                      align="center"
                      prop="education"
                    ></el-table-column>
                    <el-table-column
                      :label="$t('label.PFANS2005FORMVIEW_TJF')"
                      align="center"
                      prop="total"
                    ></el-table-column>
                  </el-table>
              ...
              <div>
                <el-dialog :visible.sync="daorufjkc" width="50%">
                  <div>
                    <div style="margin-top: 1rem;margin-left: 28%">
                      <el-upload
            ...
            <el-tab-pane :label="$t('label.PFANS2005FORMVIEW_GRDB')" name="seventeenth">
              ...
              <el-row>
                ...
                >
                  ...
                  ></el-table-column>
                  <el-table-column
                    :label="$t('label.PFANS2005FORMVIEW_DIFFERENCE')"
                    align="center"
                    prop="difference"
                  ></el-table-column>
                  <el-table-column
                    :label="$t('label.PFANS2005FORMVIEW_CAUSE')"
                    align="center"
                    prop="reason"
                  >
                    <template slot-scope="scope">
...
export default {
  ...
  methods: {
      ...
      this.$store
        ...
        .then(response => {
          ...
          for (let j = 0; j < response.otherOne.length; j++) {
            ...
            if (response.otherOne[j].type === "1") {
              ...
              lettableQT1Woman.push({
                ...
                other1: response.otherOne[j].other1,
          ...
          for (let j = 0; j < response.accumulatedTaxVo.length; j++) {
            ...
            if (
              response.accumulatedTaxVo[j].shouldwages === null ||
              response.accumulatedTaxVo[j].shouldwages === ""
            ) {
              response.accumulatedTaxVo[j].shouldwages = "0";
            }
            if (
              response.accumulatedTaxVo[j].shouldwages !== null ||
              response.accumulatedTaxVo[j].shouldwages !== ""
            ) {
              response.accumulatedTaxVo[j].balance =
                response.accumulatedTaxVo[j].shouldwages -
    ...
    handleSizeChange(val) {
      this.listQueryList.limit = val;
      this.getList();
    },
    handleCurrentChange(val) {
      this.listQueryList.page = val;
      this.getList();
    },
    ...
    getList() {
      this.loading = true;
      let start = (this.listQueryList.page - 1) * this.listQueryList.limit;
      let end = this.listQueryList.page * this.listQueryList.limit;
      if (this.tab === "0") {
      }
    ...
    getRowClass({ row, column, rowIndex, columnIndex }) {
      ...
      if (column.level === 1 && columnIndex === 3) {
        return { color: "white", background: "#4c4040", "border-right": "1px solid #4c4040","border-bottom": "1px solid #4c4040","border-top": "1px solid #4c4040"};
      }
      if (column.level === 1 && columnIndex === 4) {
        return { color: "white", background: "#4282c1","border-top": "1px solid #005baa","border-bottom": "1px solid #005baa","border-right": "1px solid #4282c1" };
      }
      if (column.level === 2 && columnIndex >=35&&columnIndex < 38) {
        return { color: "white", background: "#4282c1","border-right": "1px solid #4282c1", "border-bottom": "1px solid #005baa"};
      }
      if (column.level === 1 && columnIndex === 5) {
        return { color: "white", background: "#4c4040", "border-right": "1px solid #4c4040","border-bottom": "1px solid #4c4040","border-top": "1px solid #4c4040"};
      }
       if (column.level === 1 && columnIndex === 6) {
        return { color: "white", background: "#4282c1","border-bottom": "1px solid #005baa","border-right": "1px solid #4282c1" };
      }
      ...
      if (column.level === 1 && columnIndex === 22) {
        return { color: "white", background: "#f5b038","border-bottom": "1px solid #ecc40c","border-right": "1px solid #f5b038","border-right": "1px solid #f5b038" }; 
      }
      if (column.level === 2 && columnIndex >=44 &&columnIndex < 52) {
        return { color: "white", background: "#f5b038","border-right": "1px solid #f5b038","border-bottom": "1px solid #ecc40c"};
      }
    ...
    buttonClick(val) {
      if (val === "import") {
        if (this.tab === "3") {
          ...
          this.$store
            .dispatch("PFANS2005Store/deleteothertwo", { type: "1" })
            .then(response => {
