<template>
  <div>
    <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data" :rowid="row"
                     :title="title" @buttonClick="buttonClick" @reget="init" @rowClick="rowClick">
          ...
          <el-row>
            <el-col :span="8" style="margin-left: 0.5vw">
              <el-form-item :label="$t('label.center')">
                <el-input v-model="centername" :disabled="true" style="width:15vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.group')">
                <el-input v-model="groupname" :disabled="true" style="width:15vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="7">
              <el-form-item :label="$t('label.team')">
                <el-input v-model="teamname" :disabled="true" style="width:15vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
import {getDictionaryInfo, getOrgInfo, getOrgInfoByUserId, getStatus, getUserInfo} from '@/utils/customize';
