          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.center')">
                ...
                <el-input :disabled="false" maxlength='36' style="width: 20vw" v-model="form.center_id"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.group')">
                <el-input :disabled="true" style="width:20vw" v-model="groupid"></el-input>
                <el-input :disabled="false" maxlength='36' style="width: 20vw" v-model="form.group_id"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.team')">
                <el-input :disabled="true" style="width:20vw" v-model="teamid"></el-input>
                <el-input :disabled="false" maxlength='36' style="width: 20vw" v-model="form.team_id"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
