<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :canStart="canStart"
                         :defaultStart="defaultStart" :title="title" :workflowCode="workcode"
                         @StartWorkflow="buttonClick" @buttonClick="buttonClick" @disabled="setdisabled" @end="end"
                         @start="start"
      ...
      <div slot="customize">
        <el-form ref="refform" :model="form" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :error="error_userids" :label="$t('label.applicant')" prop="user_id">
                <user :disabled="true" :error="error_userids" :selectType="selectType" :userlist="userlist"
                      style="width: 19.7vw" @getUserids="getUserids"></user>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.application_date')" prop="application_date">
                <el-date-picker v-model="form.application_date" :disabled="!disabled" style="width: 20vw"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item v-show="show5" :label="$t('label.PFANS2022VIEW_SECONDARY')" prop="twoclass">
                <dicselect
                  :code="code1"
                  :data="form.twoclass"
                  :disabled="!disabled"
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item v-show="show1" :error="error_nominees" :label="$t('label.PFANS2022VIEW_NOMINEES')"
                            prop="nominees">
                <user :disabled="!disabled" :error="error_nominees" :selectType="selectType" :userlist="nomineeslist"
                      style="width: 19.7vw" @getUserids="getNomineeids"></user>
              </el-form-item>
            </el-col>
            <!--ADD-ZTC-类别为其他奖励金时增加被推荐人的group-->
            <el-col :span="8">
              <el-form-item v-if="show1" :label="$t('label.group')">
                <el-input v-model="appgroupid" :disabled="true" style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2022VIEW_AMOUNT')">
                <el-input v-model="form.amoutmoney" :disabled="true" maxlength="10" style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item v-show="show4" :label="$t('label.PFANSUSERFORMVIEW_EXPERIENCE')">
                <el-input v-model="form.experience" :disabled="!disabled1" maxlength='20'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item v-show="show1" :label="$t('label.PFANS2022VIEW_JOININGDAY')" prop="joiningday">
                <el-date-picker v-model="form.joiningday" :disabled="!disabled" style="width: 20vw"
                                type="date"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item v-show="show1" :label="$t('label.PFANS2022VIEW_ENTERINGFORM')" prop="enteringform">
                <dicselect
                  :code="code3"
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item v-show="show1" :label="$t('label.PFANS2022VIEW_RECOMMENDATIONDAY')"
                            prop="recommendationday">
                <el-date-picker v-model="form.recommendationday" :disabled="!disabled" style="width: 20vw"
                                type="date"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item v-show="show1" :label="$t('label.PFANS2022VIEW_REGINSTRATIONDAY')" prop="reginstrationday">
                <el-date-picker v-model="form.reginstrationday" :disabled="!disabled" style="width: 20vw"
                                type="date"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item v-show="show1" :label="$t('label.PFANS2022VIEW_NOMINEERELATIONSHIP')" label-width="5rem"
                            prop="nomineerelationship">
                <el-input v-model="form.nomineerelationship" :disabled="!disabled" maxlength='20'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item v-show="show2" :label="$t('label.PFANS2022VIEW_WEDDINGDAY')" prop="weddingday">
                <el-date-picker v-model="form.weddingday" :disabled="!disabled" style="width: 20vw"
                                type="date"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item v-show="show2" :label="$t('label.PFANS2022VIEW_SPOUSENAME')" prop="spousename">
                <el-input v-model="form.spousename" :disabled="!disabled" maxlength='20'
                          style="width: 20vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-form-item v-show="show3" :label="$t('label.remarks')">
              <el-input v-model="form.remarks" :disabled="!disabled" style="width: 72vw" type="textarea"></el-input>
            </el-form-item>
          </el-row>
          <el-row>
            <el-col :span="8">
