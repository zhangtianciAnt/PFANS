<template>
  <EasyNormalTable ref="dataTable" v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data"
                   :rowid="row" :selectable="selectInit" :showSelection="true" :title="title"
                   @buttonClick="buttonClick" @reget="getCasgiftApply" @rowClick="rowClick">
  </EasyNormalTable>
</template>
...
import {getCurrentRole16, getDictionaryInfo, getOrgInfoByUserId, getStatus, getUserInfo} from '@/utils/customize';
