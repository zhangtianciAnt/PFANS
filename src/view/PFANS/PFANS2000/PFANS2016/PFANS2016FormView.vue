<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :canStart="canStart"
                         :defaultStart="defaultStart" :noback="true" :title="title"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.application_date')" prop="applicationdate">
                <el-date-picker v-model="form.applicationdate" :disabled="true" style="width:20vw"
                                type="date"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2017VIEW_COUNTTIME')" prop="worktime">
                <el-input v-model="form.worktime" :disabled="true" style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <!--不为  年休 代休-特别休日-->
            <el-col v-show="(form.errortype != 'PR013005' && form.errortype != 'PR013007') && (form.status === '4' || form.status === '5' || form.status === '6' || form.status === '7')"
                    :span="8">
            ...
            <el-col v-show="(form.errortype == 'PR013005'|| form.errortype == 'PR013007') && form.status != '4' && form.status != '5' && form.status != '6' && form.status != '7'&& form.status != '8'"
                    :span="8">
              <el-form-item :label="$t('label.PFANS2016FORMVIEW_XJTYPE')" label-width="9rem" prop="vacationtype">
                <el-select v-model="form.vacationtype" :disabled="!disable"
                           style="width: 20vw" @change="handleClick">
                  <el-option
            ...
            <el-col v-show="(form.errortype == 'PR013005' || form.errortype == 'PR013007') && (form.status === '4' || form.status === '5' || form.status === '6' || form.status === '7')"
              ...
              <el-form-item :label="$t('label.PFANS2016FORMVIEW_RELENGTHTIME')" label-width="9rem"
                            prop="revacationtype">
                <el-select v-model="form.revacationtype" :disabled="disrevacationtype" style="width: 20vw"
                           @change="rehandleClick">
                  <el-option
            ...
            <el-col v-if="form.errortype == 'PR013006'|| form.errortype == 'PR013007'" :span="4">
              <el-form-item :label="$t('label.PFANS2016FORMVIEW_RESTDIFF1')">
                <el-input v-model="form.restdiff" :disabled="true" style="width: 8vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col v-if="form.errortype == 'PR013006'|| form.errortype == 'PR013007'" :span="4">
              <el-form-item :label="$t('label.PFANS2016FORMVIEW_RESTDIFF2')">
                <el-input v-model="form.restdiff2" :disabled="true" style="width: 8vw"></el-input>
              </el-form-item>
            </el-col>
            <!--           add_fjl_05/26 &#45;&#45;添加代休剩余-->
          </el-row>
          <div v-if="checkerrortishi" class="sub_color_red">
            {{ $t('label.PFANS2016FORMVIEW_TISHICHECKERROR') }}
          </div>
          <div v-if="form.errortype == 'PR013007'" class="sub_color_red">
            {{ $t('label.PFANS2016FORMVIEW_CHECKDAIXIUBANRI') }}
          </div>
          <div v-if="form.errortype == 'PR013005' " class="sub_color_red">
            {{ $t('label.PFANS2016FORMVIEW_CHECKYEAR') }}
          </div>
          <el-row>
            <el-col v-if="form.status != '4' && form.status != '5' && form.status != '6' && form.status != '7'"
                    :span="8">
              <el-form-item :label="$t('label.startdate')" prop="occurrencedate">
                <el-date-picker v-model="form.occurrencedate" :disabled="!disable"
                                style="width:20vw" type="date" @change="change"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col v-if="form.status != '4' && form.status != '5' && form.status != '6' && form.status != '7'"
                    :span="8">
              <el-form-item :label="$t('label.enddate')" prop="finisheddate">
                <el-date-picker v-model="form.finisheddate" :disabled="!disable"
                                style="width:20vw" type="date" @change="change"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row v-show="(form.errortype != 'PR013005' && form.errortype != 'PR013007') && form.status != '4' && form.status != '5' && form.status != '6' && form.status != '7'&& form.status != '8'"
                  :span="8">
            <el-col>
          ...
          <el-row v-show="form.errortype == 'PR013016' ? true : false">
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2016FORMVIEW_HOSPITAL')" prop="hospital">
                <el-input v-model="form.hospital" maxlength="50" style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2016FORMVIEW_EDATE')" prop="edate">
                <el-date-picker v-model="form.edate" :disabled="!disable"
                                style="width:20vw" type="date"></el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col>
              <el-form-item :label="$t('label.cause')" prop="cause">
                <el-input v-model="form.cause" :disabled="!disable" :rows="6" style="width: 72vw"
...
import {downLoadUrl, getCurrentRoleNew, getDictionaryInfo, uploadUrl} from '../../../../utils/customize';
