<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :canStart="canStart"
                         ...
                         @StartWorkflow="checkbuttonClick" @buttonClick="buttonClick" @end="end" @start="start" @workflowState="workflowState">
      <div slot="customize">
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_ENTRYTIME')" prop="entry_time">
                <el-date-picker v-model="form.entry_time" :disabled="true" style="width:20vw">
                </el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.application_date')" prop="application_date">
                <el-date-picker v-model="form.application_date" :disabled="true" style="width:20vw">
                </el-date-picker>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_ADDRESS')">
                <el-input v-model="form.address" :disabled="this.checktype===1?true:!disable" maxlength="50"
                          style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_DEPARTUREDATE')" prop="hope_exit_date">
                <el-date-picker v-model="form.hope_exit_date" :disabled="this.checktype===1?true:!disable"
                                style="width:20vw"
                >
                </el-date-picker>
              </el-form-item>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_FIXEDTELEPHONE')" prop="fixed_phone">
                <el-input v-model="form.fixed_phone" :disabled="this.checktype===1?true:!disable" maxlength="20"
                          style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.user_mobile')">
                <el-input v-model="form.cellphone" :disabled="this.checktype===1?true:!disable" maxlength="20"
                          style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
            <el-col v-if="button" :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_BUTTON2')">
                <el-button icon="el-icon-view" @click="submitForm('ruleFormNew')">
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.email')" prop="email">
                <el-input v-model="form.email" :disabled="this.checktype===1?true:!disable" maxlength="100"
                          style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-form-item :label="$t('label.PFANS2026VIEW_CAUSE')" prop="reason">
              <el-input v-model="form.reason"
                        :disabled="this.checktype===1?true:!disable"
                        :placeholder="$t('label.PFANS2026VIEW_REMARK2')" style="width: 70vw"
                        type="textarea">
              </el-input>
            </el-form-item>
          </el-row>
          <el-row v-if="this.checktype===1">
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_DEPARTUREDATE1')" prop="newhope_exit_date">
                <el-date-picker v-model="form.newhope_exit_date" :disabled="!disable" style="width:20vw"
                >
                </el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS2026VIEW_DEPARTUREDATE2')">
                <el-input v-model="form.newreason"
                          :disabled="!disable" style="width: 46vw"
                          type="textarea">
                </el-input>
              </el-form-item>
            </el-col>
        ...
        <el-drawer :show-close="false" :visible.sync="checkworkflow" :withHeader="false" append-to-body size="40%">
          <el-table
            :data="tableworkflow"
    ...
    <PFANS2032Pop ref="PFANS2032Pop" :params="urlparams" :url="url"></PFANS2032Pop>
  </div>
</template>
<script>
...
import {getCurrentRole, getCurrentRole12, getDictionaryInfo} from '../../../../utils/customize';
