<template>
  <div>
    ...
    >
      <div slot="customize">
        <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="dataestimate"
                         :summary-method="summaryMethod"
                         :title="titlewagesestimate" @buttonClick="buttonClick">
          <el-date-picker
            slot="customize"
            v-model="months"
      ...
      <div slot="customize">
        <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="dataactual"
                         :summary-method="summaryMethod"
                         :title="titlewagesactual" @buttonClick="buttonClick1">
          <el-date-picker
            slot="customize"
            v-model="months"
            :placeholder="$t('normal.error_09')"
      ...
      <div slot="customize">
        <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="datadiff"
                         :summary-method="summaryMethod"
                         :title="titlewagesdiff" @buttonClick="buttonClick2">
          <el-date-picker
            slot="customize"
            v-model="months"
            :placeholder="$t('normal.error_09')"
    ...
    exportdata(vardata) {
      ...
      for (let i = 0; i < vardata.length; i++) {
        ...
        csvData.push({
          ...
          // update gbb 20210319 导出值为Nan处理 start
          [heads[1]]: obj.user_id === '-' ? '' : obj.user_id,
          [heads[2]]: obj.totalwages === '-' ? '' : parseFloat(obj.totalwages).toFixed(2),
          [heads[3]]: obj.taxestotal === '-' ? '' : parseFloat(obj.taxestotal).toFixed(2),
          [heads[4]]: obj.heating === '-' ? '' : parseFloat(obj.heating).toFixed(2),
          [heads[5]]: obj.onlychildmoney === '-' ? '' : parseFloat(obj.onlychildmoney).toFixed(2),
          [heads[6]]: obj.pension === '-' ? '' : parseFloat(obj.pension).toFixed(2),
          [heads[7]]: obj.comendowmentinsurance === '-' ? '' : parseFloat(obj.comendowmentinsurance).toFixed(2),
          [heads[8]]: obj.commedicalinsurance === '-' ? '' : parseFloat(obj.commedicalinsurance).toFixed(2),
          [heads[9]]: obj.comunemploymentinsurance === '-' ? '' : parseFloat(obj.comunemploymentinsurance).toFixed(2),
          [heads[10]]: obj.cominjuryinsurance === '-' ? '' : parseFloat(obj.cominjuryinsurance).toFixed(2),
          [heads[11]]: obj.combirthinsurance === '-' ? '' : parseFloat(obj.combirthinsurance).toFixed(2),
          [heads[12]]: obj.comheating === '-' ? '' : parseFloat(obj.comheating).toFixed(2),
          [heads[13]]: obj.comaccumulationfund === '-' ? '' : parseFloat(obj.comaccumulationfund).toFixed(2),
          [heads[14]]: obj.bonusmoney === '-' ? '' : parseFloat(obj.bonusmoney).toFixed(2),
          [heads[15]]: obj.appreciation === '-' ? '' : parseFloat(obj.appreciation).toFixed(2),
          [heads[16]]: obj.labourunionfunds === '-' ? '' : parseFloat(obj.labourunionfunds).toFixed(2),
          [heads[17]]: obj.other4 === '-' ? '' : parseFloat(obj.other4).toFixed(2),
          [heads[18]]: obj.other5 === '-' ? '' : parseFloat(obj.other5).toFixed(2),
          [heads[19]]: obj.total === '-' ? '' : parseFloat(obj.total).toFixed(2),
          [heads[20]]: obj.overtimesubsidy === '-' ? '' : parseFloat(obj.overtimesubsidy).toFixed(2),
          [heads[21]]: obj.thismonthadjustment === '-' ? '' : parseFloat(obj.thismonthadjustment).toFixed(2),
          [heads[22]]: obj.socialinsurance === '-' ? '' : parseFloat(obj.socialinsurance).toFixed(2),
          [heads[23]]: obj.accumulationfund === '-' ? '' : parseFloat(obj.accumulationfund).toFixed(2),
          [heads[24]]: obj.realwages === '-' ? '' : parseFloat(obj.realwages).toFixed(2),
          [heads[25]]: obj.shouldcumulative === '-' ? '' : parseFloat(obj.shouldcumulative).toFixed(2),
          [heads[26]]: obj.other6 === '-' ? '' : parseFloat(obj.other6).toFixed(2),
          [heads[27]]: obj.labourunionbase === '-' ? '' : parseFloat(obj.labourunionbase).toFixed(2),
          // update gbb 20210319 导出值为Nan处理 end
        });
      }
