<template>
  <div style="min-height: 100%">
    <EasyNormalContainer :buttonList="buttonList" :title="title"
                         @buttonClick="buttonClick" ref="container" v-loading="loading" :noback="noback">
      <div slot="customize">
          ...
          <el-row>
            <el-table :data="table" border
              ...
              <el-table-column :label="$t('label.PFANS2003VIEW_SCHOOL')" align="center" width="200">
                <template slot-scope="scope">
                  <el-input style="width: 100%" v-model="scope.row.school">
                  </el-input>
                </template>
              </el-table-column>
              <el-table-column :label="$t('label.PFANS2002VIEW_BIRTHDAY')" align="center" width="200">
                <template slot-scope="scope">
                  <el-date-picker style="width: 100%"
                                  v-model="scope.row.birthday"></el-date-picker>
                </template>
              </el-table-column>
              <el-table-column :label="$t('label.PFANS2003VIEW_ACCEPTDATE')" align="center" width="200">
                <template slot-scope="scope">
                  <el-date-picker style="width: 100%"
                                  v-model="scope.row.accept_date"></el-date-picker>
                </template>
              </el-table-column>
