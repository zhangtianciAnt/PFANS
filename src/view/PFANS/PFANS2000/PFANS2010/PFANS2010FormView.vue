    ...
    >
      <div slot="customize">
        <EasyNormalTable
          ...
          @handleEdit="handleEdit" @handleView="handleView"
          @rowClick="rowClick">
        </EasyNormalTable>
      </div>
    </EasyNormalContainer>
    <PFANS2013Pop ref="PFANS2013Pop" :params="urlparams" :url="url"></PFANS2013Pop>
  </div>
</template>
...
import {getCurrentRole, getDictionaryInfo, getUserInfo} from '../../../../utils/customize';
