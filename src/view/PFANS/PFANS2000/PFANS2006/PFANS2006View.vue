          ...
          if (this.Taxestotal === 1) {
            ...
            for (let i = 0; i < this.selectedlist.length; i++) {
              ...
              csvData.push({
                ...
                [heads[28]]: obj.other3,
                [heads[29]]: obj.total2,
                [heads[30]]: parseFloat(obj.taxestotal).toFixed(2),
                ...
                [heads[40]]: parseFloat(obj.disciplinarycontrol).toFixed(2),
                ...
                [heads[50]]: parseFloat(obj.shouldpaytaxes).toFixed(2),
                ...
                [heads[60]]: parseFloat(obj.total).toFixed(2),
