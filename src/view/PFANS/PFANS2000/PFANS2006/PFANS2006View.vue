<template>
  <div>
    ...
    <EasyNormalTable v-show="showTable1" ref="roletable" v-loading="loading" :buttonList="buttonList" :columns="columns1"
                     :data="data"
                     :showSelectByCondition="displayOrNot" :showSelection="isShow" :title="title" @buttonClick="buttonClick">
      ...
      <el-input slot="customize" v-model="filterName"
                :placeholder="$t('label.PFANS2006VIEW_EMPLOYEESNAME')" style="width: 20vw">
    ...
    <EasyNormalTable v-show="!showTable1" ref="rolet" v-loading="loading" :buttonList="buttonList"
                     :columns="columns2" :data="datatada"
                     :showSelectByCondition="displayOrNot" :showSelection="isShow" :title="title" @buttonClick="buttonClick">
      <el-select slot="customize" v-model="region" @change="changed">
        <el-option :label="$t('label.PFANS2006VIEW_WAGES')" value="1"></el-option>
        <el-option :label="$t('label.PFANS2006VIEW_BONUS')" value="2"></el-option>
...
import {getCurrentRole6, getDepartmentById, getUserInfo} from '@/utils/customize';
