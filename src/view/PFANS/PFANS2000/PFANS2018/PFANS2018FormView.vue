          ...
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018VIEW_COMPASSIONATELEAVE')" prop="compassionateleave">
                <el-input-number v-model="form.compassionateleave" :disabled="!disable" :max="9999" :min="0"
                                 :precision="2" :step="0.25" controls-position="right"
            ...
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018VIEW_LATEEARLYLEAVE')" prop="lateearlyleave">
                <el-input-number v-model="form.lateearlyleave" :disabled="!disable" :max="9999" :min="0" :precision="2"
                                 :step="0.25" controls-position="right" style="width:20vw"></el-input-number>
                <span>{{ $t('label.hours') }}</span>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018VIEW_ABSENTEEISM')" prop="absenteeism">
                <el-input-number v-model="form.absenteeism" :disabled="!disable" :max="9999" :min="0" :precision="2"
                                 :step="4" controls-position="right" style="width:20vw"></el-input-number>
                <span>{{ $t('label.hours') }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018VIEW_OVERTIME')" prop="overtime">
                <el-input-number v-model="form.overtime" :disabled="!disable" :max="9999" :min="0" :precision="2"
                                 :step="0.25" controls-position="right" style="width:20vw"></el-input-number>
                <span>{{ $t('label.hours') }}</span>
              </el-form-item>
            </el-col>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018FORMVIEW_WEEKENDOVERTIME')" prop="weekendovertime">
                <el-input-number v-model="form.weekendovertime" :disabled="!disable" :max="9999" :min="0" :precision="2"
                                 :step="8"
            ...
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018VIEW_WEEKDAYSOVERTIME')" prop="weekdaysovertime">
                <el-input-number v-model="form.weekdaysovertime" :disabled="!disable" :max="9999" :min="0"
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018FORMVIEW_ABNORMALDEADLINE')" prop="abnormaldeadline">
                <el-input-number v-model="form.abnormaldeadline" :disabled="!disable" :max="31" :min="1" :step="1"
                                 controls-position="right" style="width:9.5vw"></el-input-number>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018FORMVIEW_TRANSFINITEREMINDER')" prop="transfinitereminder">
                <el-input-number v-model="form.transfinitereminder" :disabled="!disable" :max="9999" :min="0" :precision="2"
            ...
            <el-col :span="12">
              <el-form-item :label="$t('label.PFANS2018VIEW_WORKINGHOURS')" prop="workinghours">
                <el-input-number v-model="form.workinghours" :disabled="!disable" :max="9999" :min="0"
                                 :precision="2" :step="0.1" controls-position="right"
                                 style="width:20vw"></el-input-number>
                <span>{{ $t('label.hours') }}</span>
              </el-form-item>
