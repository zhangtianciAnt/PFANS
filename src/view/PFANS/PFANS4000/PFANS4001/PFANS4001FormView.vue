<template>
  <div style="min-height: 100%">
    <EasyNormalContainer ref="container" v-loading="loading" :buttonList="buttonList" :defaultStart="defaultStart"
                         :enableSave="enableSave" :title="title" :workflowCode="workflowCode" @StartWorkflow="buttonClick"
                         @buttonClick="buttonClick"
                         @disabled="setdisabled" @end="end" @start="start"
        ...
        <el-form ref="ruleForm" :model="form" :rules="rules" label-position="top" label-width="8vw"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS4001FORMVIRW_KH')" prop="client">
                ...
                <!--                  @change="kh">-->
                <!--                </dicselect>-->
                <el-input v-model="form.client" :disabled="!disable" maxlength='20' style="width:20vw"></el-input>
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS4001FORMVIRW_YYFS')" prop="printscore">
                <el-input-number v-model="form.printscore" :disabled="!disable" :max="9999999999" :min="0" :precision="0"
                                 :step="1"
            ...
            <el-col :span="8">
              <el-form-item :label="$t('label.PFANS1034VIEW_FILENAME')" prop="filename">
                <el-input v-model="form.filename" :disabled="!disable" maxlength='20' style="width:20vw"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            <el-table :data="tableD" border header-cell-class-name="sub_bg_color_blue"
              ...
              <!--                </template>-->
              <!--              </el-table-column>-->
              <el-table-column v-if="awardable" :label="$t('label.PFANS1032FORMVIEW_PJNAME')" align="center"
                               prop="pjnamejapanese" width="200">
                <template slot-scope="scope">
                  <span>{{ scope.row.pjnamejapanese }}</span>
                </template>
              </el-table-column>
              <el-table-column v-if="awardable" :label="$t('label.PFANS1032FORMVIEW_CLAIMNUMBER')" align="center"
                               prop="claimnumber" width="200">
                <template slot-scope="scope">
                  <span>{{ scope.row.claimnumber }}</span>
                </template>
              </el-table-column>
              <el-table-column v-if="this.form.filetype === 'PC002004'" :label="$t('label.PFANS1024VIEW_CLAIMDATE')" align="center"
                               prop="claimdate" width="200">
                <template slot-scope="scope">
                  <span>{{ scope.row.claimdate }}</span>
                </template>
              </el-table-column>
              <el-table-column v-if="this.form.filetype === 'PC002005'" :label="$t('label.PFANS1024VIEW_DELIVERYDATE')" align="center"
                               prop="deliverydate" width="200">
                <template slot-scope="scope">
    ...
    <PFANS1032Pop ref="PFANS1032Pop" :params="urlparams" :url="url"></PFANS1032Pop>
    <PFANS1031Pop ref="PFANS1031Pop" :params="urlparams" :url="url"></PFANS1031Pop>
    <PFANS1025Pop ref="PFANS1025Pop" :params="urlparams" :url="url"></PFANS1025Pop>
    <PFANS1047Pop ref="PFANS1047Pop" :params="urlparams" :url="url"></PFANS1047Pop>
  </div>
</template>
<script>
