        ...
        <el-form :model="refform" label-position="top" label-width="8vw" employedref="refform" ref="refform"
          ...
          <el-row style="padding-top: 3%">
            ...
            <el-col :span="6">
              <el-form-item :label="$t('label.PFANS2036VIEW_DEPARTMENT')" prop="groupid">
                <el-select v-model="refform.groupid" style="width: 20vw" :disabled="false"
                           @change="groupChange">
                  <el-option
          ...
          <el-row style="padding-bottom: 0.5%">
            <el-table :data="tableData" border default-expand-all header-cell-class-name="sub_bg_color_blue" style="margin-top: 1%;font-size: 13px"
                      row-key="peoplewareid"  height="540"
  ...
  methods: {
    ...
    getDepartInfo() {
      ...
      this.$store
        ...
        .then(res => {
          if(res.length > 0){
            let month1 = 0,month2 = 0,month3 = 0,month4 = 0,month5 = 0,month6 = 0,month7 = 0,month8 = 0,month9 = 0,month10 = 0,month11 = 0,month12 = 0;
