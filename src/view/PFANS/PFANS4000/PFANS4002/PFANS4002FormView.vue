              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.sex')" prop="sex">
                    <dicselect code="PR019" :data="form.sex" style="width:20vw"
                               :disabled="true"></dicselect>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_AGE')">
                    <el-input :disabled="true" class="width" v-model="age" disabled style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_NATION')" prop="nation">
                    <el-input :disabled="true" class="width" v-model="form.nation" maxlength="20"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_CHILDDALIAN')">
                    ...
                    <el-switch :disabled="true" v-model="form.dlnation" active-value="1" inactive-value="0"></el-switch>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_CHILDREN')">
                    <span style="margin-right: 1vw ">{{$t('label.no')}}</span>
                    <el-switch :disabled="true" v-model="form.children" active-value="1" inactive-value="0"></el-switch>
                    <span style="margin-left: 1vw ">{{$t('label.yes')}}</span>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_EMAIL')" prop="email">
                    <el-input :disabled="true" class="width" v-model="form.email" style="width:20vw" maxlength="100"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item
                    ...
                    prop="mobilenumber"
                  >
                    <el-input :disabled="true" class="width" v-model="form.mobilenumber" style="width:20vw"
                              maxlength="20"/>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
