          ...
          <div>
            <el-tabs v-model="activeNam">
              <el-tab-pane label="基本信息" name="first">
                <el-form v-show="currentNode.type === '0'|| currentNode.type === '1'||currentNode.type === '2'" ref="companyForm" :disabled="formDisabled" :model="currentNode"
                         autoComplete="off" label-position="left"
                         label-width="8rem"
                         status-icon
                         style="border: none;  border-radius: 0.5rem;padding:3rem;">
                ...
                <el-form v-show="currentNode.type !== '0'&& currentNode.type !== '1'&& currentNode.type !== '2'" ref="departmentForm" :disabled="formDisabled" :model="currentNode"
                         autoComplete="off" label-position="left" label-width="8rem"
                         status-icon
                         style="  border-radius: 0.5rem;padding:3rem;">
