            ...
            <el-tabs v-model="activeNam">
              <el-tab-pane label="基本信息" name="first">
                <el-form v-show="currentNode.type === '1'||currentNode.type === '2'" ref="companyForm" :disabled="formDisabled" :model="currentNode"
                  ...
                  <el-form-item label="组织层级" prop="type" @mouseover.native="changeflag('typeflag',true)"
                                @mouseout.native="changeflag('typeflag',false)">
                    <el-input v-show="typeflag" v-model="currentNode.type"></el-input>
                    <span v-show="!typeflag">{{ currentNode.type }}</span>
                  </el-form-item>
                  <el-form-item label="虚拟组织" prop="virtual">
                    <el-switch v-model="currentNode.virtual" :width="50" active-color="#13ce66"
                               active-value="0" inactive-color="#ff4949" inactive-value="1">
                    </el-switch>
                  </el-form-item>
                </el-form>
