  ...
  <div class="dpOrgIndex">
    <el-container>
      <div :style="error !== ''? 'border-color:red' : 'border-color:#EBEEF5'" class="content bg">
        <el-tag v-for="item in multipleSelection" :key="item.companyprojects_id" :closable="!disabled" size="small"
                type="info" @close="handleClose(item)">
          <el-tooltip :content=item.project_name class="item" effect="dark" placement="top-start">
