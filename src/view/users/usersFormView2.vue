        ...
        <el-form ref="form" :model="form" :rules="rules" label-position="top" label-width="8vw">
          <el-tabs v-model="activeName" type="border-card" @tab-click="handleClick">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item
                    ...
                    prop="customername"
                  >
                    <el-input v-model="form.customername" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_ADFIELD')" prop="adfield">
                    <el-input v-model="form.adfield" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_IDNUMBER')" prop="idnumber">
                    <el-input v-model="form.idnumber" class="width" maxlength="18" style="width:20vw"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_AGE')">
                    <el-input v-model="age" class="width" disabled style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERVIEW_NATIONALITY')" prop="nationality">
                    <el-input v-model="form.nationality" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_NATION')" prop="nation">
                    <el-input v-model="form.nation" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_REGISTER')" prop="register">
                    <el-input v-model="form.register" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>

                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_PASSPORT')">
                    <el-input v-model="form.passport" class="width" maxlength="10" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_SECURITY')">
                    <el-input v-model="form.security" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_HOUSEFUND')">
                    <el-input v-model="form.housefund" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_EMAIL')" prop="email">
                    <el-input v-model="form.email" class="width" maxlegnth="100" style="width:20vw"/>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="8">
                  <el-form-item
                    ...
                    prop="mobilenumber"
                  >
                    <el-input v-model="form.mobilenumber" class="width" style="width:20vw"/>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item
                    ...
                    prop="graduation"
                  >
                    <el-input v-model="form.graduation" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_SPECIALTY')" prop="specialty">
                    <el-input v-model="form.specialty" class="width" maxlength="10" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item
                  ...
                  <el-row>
                    <el-col :span="24">
                      ...
                      >
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.school" class="width" maxlength="20"
                                      style="width:100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column :label="$t('label.remarks')" align="center" prop="notes">
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.notes" class="width" maxlength="50"
                                      style="width:100%"></el-input>
                          </template>
                        </el-table-column>
                ...
                <el-col :span="24">
                  <el-table :data="skillTable" border header-cell-class-name="sub_bg_color_blue"
                    ...
                    <el-table-column :label="$t('label.PFANS3004VIEW_NAME')" align="center" prop="name">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.name" class="width" maxlength="20"
                                  style="width: 100%"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                    ...
                    >
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.ability" class="width" maxlength="20"
                                  style="width: 100%"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column :label="$t('label.remarks')" align="center" prop="notes">
                  ...
                  <el-row>
                    <el-col :span="24">
                      <el-table :data="languageTable" border header-cell-class-name="sub_bg_color_blue"
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.programme" class="width" maxlength="20"
                                      style="width: 100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.level" class="width" maxlength="20"
                                      style="width: 100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column :label="$t('label.remarks')" align="center" prop="notes">
            ...
            >
              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_JOBNUMBER')" prop="jobnumber">
                    <el-input v-model="form.jobnumber" class="width" maxlength="10" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.budgetunit')" prop="budgetunit">
                    <el-input v-model="form.budgetunit" :disabled="false" class="width" maxlength="10"
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANS1012VIEW_PERSONALCODE')">
                    <el-input v-model="form.personalcode" class="width" maxlength="10" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_RANK')" prop="rank">
                    <dicselect v-if="display" :code="code" :data="form.rank" class="width" style="width:20vw"
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_OCCUPATIONTYPE')" prop="occupationtype">
                    <dicselect v-if="occupationtypedisplay" :code="occupationtypecode" :data="form.occupationtype" :disabled="occupationtypedis"
                               class="width" style="width:20vw" @change="getOccupationtype"
                    ></dicselect>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.PFANSUSERFORMVIEW_SEATNUMBER')" prop="seatnumber">
                    <el-input v-model="form.seatnumber" class="width" maxlength="20" style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <!--                            &lt;!&ndash;                              &lt;!&ndash;                                <span style="color:#d16765">{{ scope.row.after }}</span>&ndash;&gt;&ndash;&gt;-->
              <!--                            &lt;!&ndash;                              &lt;!&ndash;                              </template>&ndash;&gt;&ndash;&gt;-->
              <!--                            &lt;!&ndash;                              <el-table-column&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                property="after"&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                align="center"&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                :label="$t('label.PFANSUSERFORMVIEW_BASIC')"&ndash;&gt;-->
              ...
              <!--                            &lt;!&ndash;                                property="before"&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                align="center"&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                :label="$t('label.PFANSUSERFORMVIEW_DUTY')"&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                width="100"&ndash;&gt;-->
              <!--                            &lt;!&ndash;                              >&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                <template slot-scope="scope">&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                  <span style="color:#d16765">{{ scope.row.before }}</span>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                </template>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                              </el-table-column>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                            </el-table-column>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                            <el-table-column&ndash;&gt;-->
              ...
              <!--                            &lt;!&ndash;                            >&ndash;&gt;-->
              <!--                            &lt;!&ndash;                              <template slot-scope="scope">&ndash;&gt;-->
              <!--                            &lt;!&ndash;                                <el-input style="width:5vw" v-model="scope.row.remark" size="mini"></el-input>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                              </template>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                            </el-table-column>&ndash;&gt;-->
              <!--                            &lt;!&ndash;                            del_fjl_05/20   &#45;&#45;注释掉调整前的工资&ndash;&gt;-->
              <!--                          </el-table>-->
            ...
            <el-tab-pane v-if="this.personcheck" :label="this.$t('label.PFANSUSERFORMVIEW_SALARYNUMBER')" name="nine"
                         style="padding-left:0.5%">
              <el-dialog
...
import {getCurrentRole6, getCurrentRole7, getDictionaryInfo} from '../../utils/customize';
