                  ...
                  <el-row>
                    <el-col :span="24">
                      ...
                      >
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input class="width" v-model="scope.row.school" maxlength="20"
                                      style="width:100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column prop="notes" :label="$t('label.remarks')" align="center">
                          <template slot-scope="scope">
                            <el-input class="width" v-model="scope.row.notes" maxlength="50"
                                      style="width:100%"></el-input>
                          </template>
                        </el-table-column>
                    ...
                    <el-col :span="24">
                      <el-table :data="skillTable" style="width:72vw;margin-top:1%" border
                        ...
                        <el-table-column prop="name" :label="$t('label.PFANS3004VIEW_NAME')" align="center">
                          <template slot-scope="scope">
                            <el-input class="width" v-model="scope.row.name" maxlength="20"
                                      style="width: 100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input class="width" v-model="scope.row.ability" maxlength="20"
                                      style="width: 100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column prop="notes" :label="$t('label.remarks')" align="center">
                  ...
                  <el-row>
                    <el-col :span="24">
                      <el-table :data="languageTable" style="width:72vw;margin-top:1%" border
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input class="width" v-model="scope.row.programme" maxlength="20"
                                      style="width: 100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        >
                          <template slot-scope="scope">
                            <el-input class="width" v-model="scope.row.level" maxlength="20"
                                      style="width: 100%"></el-input>
                          </template>
                        </el-table-column>
                        <el-table-column prop="notes" :label="$t('label.remarks')" align="center">
              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="$t('label.budgetunit')" prop="budgetunit">
                    <el-input class="width" :disabled="true" v-model="form.budgetunit" maxlength="10"
                              style="width:20vw"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
            ...
            getById(_id) {
                ...
                this.$store
                    ...
                    .then(response => {
                        ...
                        // this.form.type = response.customerInfo.userinfo.type;
                        // this.form.centername = response.customerInfo.userinfo.centername
                        // this.form.groupname = response.customerInfo.userinfo.groupname
                        // this.form.teamname = response.customerInfo.userinfo.teamname
                        // this.form.customername = response.customerInfo.userinfo.customername
                        // this.form.sex = response.customerInfo.userinfo.sex
                        // this.form.adfield = response.customerInfo.userinfo.adfield
                        // this.form.birthday = response.customerInfo.userinfo.birthday
                        // this.form.nationality = response.customerInfo.userinfo.nationality
                        // this.form.nation = response.customerInfo.userinfo.nation
                        // this.form.register = response.customerInfo.userinfo.register
                        // this.form.idnumber = response.customerInfo.userinfo.idnumber
                        // this.form.passport = response.customerInfo.userinfo.passport
                        // this.form.security = response.customerInfo.userinfo.security
                        // this.form.housefund = response.customerInfo.userinfo.housefund
                        // this.form.marital = response.customerInfo.userinfo.marital
                        // this.form.children = response.customerInfo.userinfo.children
                        // this.form.experience = response.customerInfo.userinfo.experience
                        // this.form.address = response.customerInfo.userinfo.address
                        // this.form.email = response.customerInfo.userinfo.email
                        // this.form.mobilenumber = response.customerInfo.userinfo.mobilenumber
                        // this.form.phone = response.customerInfo.userinfo.phone
                        // this.form.extension = response.customerInfo.userinfo.extension
                        // this.form.graduation = response.customerInfo.userinfo.graduation
                        // this.form.degree = response.customerInfo.userinfo.degree
                        // this.form.educational = response.customerInfo.userinfo.educational
                        // this.form.specialty = response.customerInfo.userinfo.specialty
                        // this.form.graduationday = response.customerInfo.userinfo.graduationday
                        // this.form.workday = response.customerInfo.userinfo.workday
                        // this.form.departmentid = response.customerInfo.userinfo.departmentid
                        // this.form.centerid = response.customerInfo.userinfo.centerid
                        // this.form.groupid = response.customerInfo.userinfo.groupid
                        // this.form.teamid = response.customerInfo.userinfo.teamid
                        // this.form.budgetunit = response.customerInfo.userinfo.budgetunit
                        // this.form.userid = response.customerInfo.userinfo.userid
                        // this.form.jobnumber = response.customerInfo.userinfo.jobnumber
                        // this.form.personalcode = response.customerInfo.userinfo.personalcode
                        // this.form.difference = response.customerInfo.userinfo.difference
                        // this.form.post = response.customerInfo.userinfo.post
                        // this.form.rank = response.customerInfo.userinfo.rank
                        // this.form.occupationtype = response.customerInfo.userinfo.occupationtype
                        // this.form.laborcontracttype = response.customerInfo.userinfo.laborcontracttype
                        // this.form.fixedate = response.customerInfo.userinfo.fixedate
                        // this.form.laborcontractday = response.customerInfo.userinfo.laborcontractday
                        // this.form.enterday = response.customerInfo.userinfo.enterday
                        // this.form.upgraded = response.customerInfo.userinfo.upgraded
                        // this.form.annualyear = response.customerInfo.userinfo.annualyear
                        // this.form.annuallastyear = response.customerInfo.userinfo.annuallastyear
                        // this.form.welfareyear = response.customerInfo.userinfo.welfareyear
                        // this.form.welfarelastyear = response.customerInfo.userinfo.welfarelastyear
                        // this.form.restyear = response.customerInfo.userinfo.restyear
                        // this.form.restlastyear = response.customerInfo.userinfo.restlastyear
                        // this.form.seatnumber = response.customerInfo.userinfo.seatnumber
                        // this.form.salary = response.customerInfo.userinfo.salary
                        // this.form.duty = response.customerInfo.userinfo.duty
                        // this.form.basic = response.customerInfo.userinfo.basic
                        // this.form.caution = response.customerInfo.userinfo.caution
                        // this.form.resignation_date = response.customerInfo.userinfo.resignation_date
                        // this.form.reason2 = response.customerInfo.userinfo.reason2
                        // this.form.staffexitprocedure = response.customerInfo.userinfo.staffexitprocedure
                        // this.form.oldageinsurance = response.customerInfo.userinfo.oldageinsurance
                        // this.form.houseinsurance = response.customerInfo.userinfo.houseinsurance
                        // this.form.medicalinsurance = response.customerInfo.userinfo.medicalinsurance
                        // this.form.informationid = response.customerInfo.userinfo.informationid
                        // this.form.title = response.customerInfo.userinfo.title
                        // this.status = response.customerInfo.status;
                        // this.userInfo.userAccount = response.userAccount;
                        // this.userInfo.customerInfo = response.customerInfo;
                        // this.educationTable = this.userInfo.customerInfo.userinfo.educationTable;
