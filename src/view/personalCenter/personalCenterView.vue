<template>
  <div v-loading="loading" class="personalCenter_baseInfo" style="min-height: 100%">
    <EasyNormalContainer ref="container" :buttonList="buttonList" :title="title" @buttonClick="buttonClick">
      <div slot="customize">
        <el-form ref="baseInfoForm" :model="baseInfoForm"
                 label-width="8rem" style="width:80%;margin:5% auto">
          <el-form-item label="姓名:" prop="customername">
            <el-input
              v-model="baseInfoForm.customername"
          ...
          <el-form-item label="密码:">
            <el-button icon="el-icon-edit" plain type="primary" @click="showPsw=true">修改密码</el-button>
          </el-form-item>
          ...
          <el-form-item label="部门:" prop="departmentid">
            <org :disabled="disabledConfirm" :orglist="this.orglist" :orgtype="orgtype"></org>
          </el-form-item>
    ...
    <el-dialog v-loading="loading" :visible.sync="showPsw" title="修改密码" width="40%" @close="closeDialog">
      <el-form ref="ruleFormNew" :model="ruleFormNew" :rules="rulesNew" class="dialogform" label-position="right"
               label-width="8rem" status-icon>
        <el-form-item label="原密码:" prop="password">
          <el-input v-model="ruleFormNew.password" autoComplete="off" name="password"/>
        </el-form-item>
        <el-form-item label="新密码:" prop="newpsw">
          <el-input v-model="ruleFormNew.newpsw" autoComplete="off" name="newpsw"/>
        </el-form-item>
        <el-form-item label="确认密码:" prop="confirmPsw">
          <el-input v-model="ruleFormNew.confirmPsw" autoComplete="off" name="confirmPsw"/>
        </el-form-item>
        <el-form-item>
