<template>
  <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data" :formatter="formatter"
                   :title="title" @buttonClick="buttonClick" @reget="getWorkflowList" @rowClick="rowClick">
  </EasyNormalTable>
</template>
