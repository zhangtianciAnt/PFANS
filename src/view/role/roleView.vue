<template>
  <div>
    <EasyNormalTable v-loading="loading" :buttonList="buttonList" :columns="columns" :data="data" :title="title"
                     @buttonClick="buttonClick" @reget="getRoleList" @rowClick="rowClick">
    </EasyNormalTable>
    <el-dialog :visible.sync="dialogTableVisible" title="角色成员">
      <EasyNormalTable v-loading="userloading" :buttonList="[]" :columns="popcolumns"
                       :data="tableDataRoleUser" :formatter="formatter" title="成员">
      </EasyNormalTable>
    </el-dialog>
  </div>
</template>
